...
#include "testout-Data_Type_Conversion_res.c"
#include "testout-Data_Type_Conversion.h"
...
/* From: t0
   To: Data_Type_Conversion_DataTypeConversion */
typedef struct {
  int flag__0000_0002;
  real_T Data_Type_Conversion_In1_1;
} TYPE_0000_0002;
TYPE_0000_0002 CH_0000_0002;

/* From: Data_Type_Conversion_In1
   To: t0 */
typedef struct {
...
/* From: Data_Type_Conversion_DataTypeConversion
   To: extout */
typedef struct {
  int flag__0002_0100;
  int32_T Data_Type_Conversion_DataTypeConversion_1;
} TYPE_0002_0100;
  ...
  /* initialize task context */
{
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Data_Type_Conversion_In1 */
      if (CH_IO0001_0000.flag__IO0001_0000 == 1) {
	Data_Type_Conversion_In1_1 = CH_IO0001_0000.Data_Type_Conversion_In1_1;
	CH__SYNCM();
    ...
    /* wait output channel */
    while (1) {
      /* output: Data_Type_Conversion_DataTypeConversion */
      if (CH_0000_0002.flag__0000_0002 == 0) {
	CH_0000_0002.Data_Type_Conversion_In1_1 = Data_Type_Conversion_In1_1;
	CH__SYNCM();
...
void mcos_lcore_task_0100(uint32_t stacd, uintptr_t extinfo)
{
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Data_Type_Conversion_DataTypeConversion */
      if (CH_0002_0100.flag__0002_0100 == 1) {
	Data_Type_Conversion_DataTypeConversion_1 = CH_0002_0100.Data_Type_Conversion_DataTypeConversion_1;
	CH__SYNCM();
...
/* Block: Data_Type_Conversion_In1 */
void mcos_lcore_task_IO0001(uint32_t stacd, uintptr_t extinfo)
{
  ...
  while (1) {
	...
	CH_IO0001_0000.Data_Type_Conversion_In1_1 = Data_Type_Conversion_In1_1;
	CH__SYNCM();
...
/* Block: Data_Type_Conversion_DataTypeConversion */
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	Data_Type_Conversion_In1_1 = CH_0000_0002.Data_Type_Conversion_In1_1;
	CH__SYNCM();
        ...
        {
{
  ...
  /* End of DataTypeConversion: '<Root>/DataTypeConversion' */
	...
	CH_0002_0100.Data_Type_Conversion_DataTypeConversion_1 = Data_Type_Conversion_DataTypeConversion_1;
	CH__SYNCM();
