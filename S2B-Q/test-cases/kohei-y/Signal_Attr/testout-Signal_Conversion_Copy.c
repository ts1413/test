...
#include "testout-Signal_Conversion_Copy_res.c"
#include "testout-Signal_Conversion_Copy.h"
...
/* From: t0
   To: Signal_Conversion_Copy_SignalConversion */
typedef struct {
  int flag__0000_0002;
  real_T Signal_Conversion_Copy_In1_1;
} TYPE_0000_0002;
TYPE_0000_0002 CH_0000_0002;

/* From: Signal_Conversion_Copy_In1
   To: t0 */
typedef struct {
...
/* From: Signal_Conversion_Copy_SignalConversion
   To: extout */
typedef struct {
  int flag__0002_0100;
  real_T Signal_Conversion_Copy_SignalConversion_1;
} TYPE_0002_0100;
  ...
  /* initialize task context */
{
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Signal_Conversion_Copy_In1 */
      if (CH_IO0001_0000.flag__IO0001_0000 == 1) {
	Signal_Conversion_Copy_In1_1 = CH_IO0001_0000.Signal_Conversion_Copy_In1_1;
	CH__SYNCM();
    ...
    /* wait output channel */
    while (1) {
      /* output: Signal_Conversion_Copy_SignalConversion */
      if (CH_0000_0002.flag__0000_0002 == 0) {
	CH_0000_0002.Signal_Conversion_Copy_In1_1 = Signal_Conversion_Copy_In1_1;
	CH__SYNCM();
...
{  /* omit input channel bit vector */
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Signal_Conversion_Copy_SignalConversion */
      if (CH_0002_0100.flag__0002_0100 == 1) {
	Signal_Conversion_Copy_SignalConversion_1 = CH_0002_0100.Signal_Conversion_Copy_SignalConversion_1;
	CH__SYNCM();
...
/* Block: Signal_Conversion_Copy_In1 */
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0001_0000.Signal_Conversion_Copy_In1_1 = Signal_Conversion_Copy_In1_1;
	CH__SYNCM();
...
/* Block: Signal_Conversion_Copy_SignalConversion */
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	Signal_Conversion_Copy_In1_1 = CH_0000_0002.Signal_Conversion_Copy_In1_1;
	CH__SYNCM();
        ...
        {
{
  ...
  Signal_Conversion_Copy_SignalConversion_1 = Signal_Conversion_Copy_In1_1;
	...
	CH_0002_0100.Signal_Conversion_Copy_SignalConversion_1 = Signal_Conversion_Copy_SignalConversion_1;
	CH__SYNCM();
