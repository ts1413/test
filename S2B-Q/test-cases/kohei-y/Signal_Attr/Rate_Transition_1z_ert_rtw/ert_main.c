...
#include "Rate_Transition_1z.h"        /* Model's header file */
#include "rtwtypes.h"
...
void rt_OneStep(void)
{
  ...
  if (OverrunFlags[0]) {
    rtmSetErrorStatus(Rate_Transition_1z_M, "Overrun");
    return;
  }
...
int_T main(int_T argc, const char *argv[])
{
  ...
  fflush((NULL));
  while (rtmGetErrorStatus(Rate_Transition_1z_M) == (NULL)) {
