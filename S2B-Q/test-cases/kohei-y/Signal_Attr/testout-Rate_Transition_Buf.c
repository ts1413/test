...
#include "testout-Rate_Transition_Buf_res.c"
#include "testout-Rate_Transition_Buf.h"
...
/* From: t0
   To: Rate_Transition_Buf_RateTransition */
typedef struct {
  int flag__0000_0002;
...
/* From: Rate_Transition_Buf_RateTransition
   To: extout */
typedef struct {
  int flag__0002_0100;
  ...
  /* initialize task context */
{
  ...
  while (1) {
    ...
    /* wait output channel */
    while (1) {
      /* output: Rate_Transition_Buf_RateTransition */
...
{  /* omit input channel bit vector */
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Rate_Transition_Buf_RateTransition */
...
/* Block: Rate_Transition_Buf_RateTransition */
...
{  /* omit input channel bit vector */
  ...
  struct {
    ...
    int8_T RateTransition_semaphoreTaken;
  } Rate_Transition_Buf_DW;
  real_T Rate_Transition_DbBuf_In1_1;
  real_T Rate_Transition_DbBuf_RateTransition_1;

  /* initialize state structure */
  memset(&Rate_Transition_Buf_DW, 0, sizeof Rate_Transition_Buf_DW);
