...
#include <string.h>
#include "rtwtypes.h"
#include "Signal_Conversion_VBus_types.h"
#include "Signal_Conversion_VBus_private.h"

#include "testout-Signal_Conversion_VBus_res.c"
#include "testout-Signal_Conversion_VBus.h"
...
/* From: t0
   To: Signal_Conversion_VBus_BusCreator */
typedef struct {
  int flag__0000_0002;
  real_T Signal_Conversion_VBus_In1_1;
} TYPE_0000_0002;
TYPE_0000_0002 CH_0000_0002;

/* From: Signal_Conversion_VBus_In1
   To: t0 */
typedef struct {
...
/* From: Signal_Conversion_VBus_BusCreator
   To: Signal_Conversion_VBus_SignalConversion */
typedef struct {
  int flag__0002_0003;
} TYPE_0002_0003;
TYPE_0002_0003 CH_0002_0003;

/* From: Signal_Conversion_VBus_SignalConversion
   To: extout */
typedef struct {
  int flag__0003_0100;
} TYPE_0003_0100;
  ...
  /* initialize task context */
{
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Signal_Conversion_VBus_In1 */
      if (CH_IO0001_0000.flag__IO0001_0000 == 1) {
	Signal_Conversion_VBus_In1_1 = CH_IO0001_0000.Signal_Conversion_VBus_In1_1;
	CH__SYNCM();
    ...
    /* wait output channel */
    while (1) {
      /* output: Signal_Conversion_VBus_BusCreator */
      if (CH_0000_0002.flag__0000_0002 == 0) {
	CH_0000_0002.Signal_Conversion_VBus_In1_1 = Signal_Conversion_VBus_In1_1;
	CH__SYNCM();
  ...
  /* initialize task context */
{
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Signal_Conversion_VBus_SignalConversion */
...
/* Block: Signal_Conversion_VBus_In1 */
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0001_0000.Signal_Conversion_VBus_In1_1 = Signal_Conversion_VBus_In1_1;
	CH__SYNCM();
...
/* Block: Signal_Conversion_VBus_BusCreator */
...
{  /* omit input channel bit vector */
  ...
  /* Block I/O Signals */
  struct {
    BusObject Signal_Conversion_VBus_BusCreat;
  } Signal_Conversion_VBus_B;
  real_T Signal_Conversion_VBus_In1_1;
  ...
  while (1) {
	...
	Signal_Conversion_VBus_In1_1 = CH_0000_0002.Signal_Conversion_VBus_In1_1;
	CH__SYNCM();
        ...
        {
{
  ...
  Signal_Conversion_VBus_B.Signal_Conversion_VBus_BusCreat.a =
    ...
    /* wait output channel */
    while (1) {
      /* output: Signal_Conversion_VBus_SignalConversion */
      if (CH_0002_0003.flag__0002_0003 == 0) {
	CH__SYNCM();
	CH_0002_0003.flag__0002_0003 = 1;
	CH__EVENT(TASK_0002,IN_0003);
...
/* Block: Signal_Conversion_VBus_SignalConversion */
...
{  /* omit input channel bit vector */
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Signal_Conversion_VBus_BusCreator */
      if (CH_0002_0003.flag__0002_0003 == 1) {
	CH__SYNCM();
	CH_0002_0003.flag__0002_0003 = 0;
	CH__EVENT(TASK_0003, OUT_0002);
	CH__END_LOG(IN_0003);
	break;
      }
