...
#include "testout-Rate_Transition_DbBuf_res.c"
#include "testout-Rate_Transition_DbBuf.h"
...
/* From: t0
   To: Rate_Transition_DbBuf_RateTransition */
typedef struct {
  int flag__0000_0002;
  real_T Rate_Transition_DbBuf_In1_1;
} TYPE_0000_0002;
TYPE_0000_0002 CH_0000_0002;

/* From: Rate_Transition_DbBuf_In1
   To: t0 */
typedef struct {
...
/* From: Rate_Transition_DbBuf_RateTransition
   To: extout */
typedef struct {
  int flag__0002_0100;
  real_T Rate_Transition_DbBuf_RateTransition_1;
} TYPE_0002_0100;
  ...
  /* initialize task context */
{
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Rate_Transition_DbBuf_In1 */
      if (CH_IO0001_0000.flag__IO0001_0000 == 1) {
	Rate_Transition_DbBuf_In1_1 = CH_IO0001_0000.Rate_Transition_DbBuf_In1_1;
	CH__SYNCM();
    ...
    /* wait output channel */
    while (1) {
      /* output: Rate_Transition_DbBuf_RateTransition */
      if (CH_0000_0002.flag__0000_0002 == 0) {
	CH_0000_0002.Rate_Transition_DbBuf_In1_1 = Rate_Transition_DbBuf_In1_1;
	CH__SYNCM();
...
{  /* omit input channel bit vector */
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Rate_Transition_DbBuf_RateTransition */
      if (CH_0002_0100.flag__0002_0100 == 1) {
	Rate_Transition_DbBuf_RateTransition_1 = CH_0002_0100.Rate_Transition_DbBuf_RateTransition_1;
	CH__SYNCM();
...
/* Block: Rate_Transition_DbBuf_In1 */
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0001_0000.Rate_Transition_DbBuf_In1_1 = Rate_Transition_DbBuf_In1_1;
	CH__SYNCM();
...
/* Block: Rate_Transition_DbBuf_RateTransition */
...
{  /* omit input channel bit vector */
  ...
  /* states */
  struct {
    real_T RateTransition_Buffer[2];
    int8_T RateTransition_ActiveBufIdx;
  } Rate_Transition_DbBuf_DW;

  /* params */
  struct {
    real_T RateTransition_X0;
  } Rate_Transition_DbBuf_P = {
  };
  real_T Rate_Transition_DbBuf_In1_1;
  real_T Rate_Transition_DbBuf_RateTransition_1;

  /* initialize state structure */
  memset(&Rate_Transition_DbBuf_DW, 0, sizeof Rate_Transition_DbBuf_DW);
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	Rate_Transition_DbBuf_In1_1 = CH_0000_0002.Rate_Transition_DbBuf_In1_1;
	CH__SYNCM();
	...
	CH_0002_0100.Rate_Transition_DbBuf_RateTransition_1 = Rate_Transition_DbBuf_RateTransition_1;
	CH__SYNCM();
