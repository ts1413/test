...
#include "testout-Width_res.c"
#include "testout-Width.h"
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	Width_In1_1 = CH_IO0001_0000.Width_In1_1;
	CH__SYNCM();
	...
	CH_0000_0002.Width_In1_1 = Width_In1_1;
	CH__SYNCM();
...
{  /* omit input channel bit vector */
  ...
  while (1) {
	...
	Width_Width_1 = CH_0002_0100.Width_Width_1;
	CH__SYNCM();
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0001_0000.Width_In1_1 = Width_In1_1;
	CH__SYNCM();
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	Width_In1_1 = CH_0000_0002.Width_In1_1;
	CH__SYNCM();
        ...
        {
{
  ...
  Width_Width_1 = 1.0;
	...
	CH_0002_0100.Width_Width_1 = Width_Width_1;
	CH__SYNCM();
