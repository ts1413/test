...
#include "testout-Rate_Transition_Copy_res.c"
#include "testout-Rate_Transition_Copy.h"
...
/* From: t0
   To: Rate_Transition_Copy_RateTransition */
typedef struct {
  int flag__0000_0002;
...
/* From: Rate_Transition_Copy_RateTransition
   To: extout */
typedef struct {
  int flag__0002_0100;
  ...
  /* initialize task context */
{
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Rate_Transition_Copy_In1 */
    ...
    /* wait output channel */
    while (1) {
      /* output: Rate_Transition_Copy_RateTransition */
...
{  /* omit input channel bit vector */
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Rate_Transition_Copy_RateTransition */
...
/* Block: Rate_Transition_Copy_In1 */
...
/* Block: Rate_Transition_Copy_RateTransition */
