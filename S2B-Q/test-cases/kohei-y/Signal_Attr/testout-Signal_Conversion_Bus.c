...
#include "testout-Signal_Conversion_Bus_res.c"
#include "testout-Signal_Conversion_Bus.h"
...
/* From: t0
   To: Signal_Conversion_Bus_BusCreator */
typedef struct {
  int flag__0000_0002;
  real_T Signal_Conversion_Bus_In1_1;
} TYPE_0000_0002;
TYPE_0000_0002 CH_0000_0002;

/* From: Signal_Conversion_Bus_In1
   To: t0 */
typedef struct {
...
/* From: Signal_Conversion_Bus_BusCreator
   To: Signal_Conversion_Bus_SignalConversion */
typedef struct {
  int flag__0002_0004;
} TYPE_0002_0004;
TYPE_0002_0004 CH_0002_0004;

/* From: Signal_Conversion_Bus_BusSelector
   To: extout */
typedef struct {
  int flag__0003_0100;
  real_T Signal_Conversion_Bus_In1_1;
...
/* From: Signal_Conversion_Bus_SignalConversion
   To: Signal_Conversion_Bus_BusSelector */
typedef struct {
  int flag__0004_0003;
} TYPE_0004_0003;
  ...
  /* initialize task context */
{
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Signal_Conversion_Bus_In1 */
      if (CH_IO0001_0000.flag__IO0001_0000 == 1) {
	Signal_Conversion_Bus_In1_1 = CH_IO0001_0000.Signal_Conversion_Bus_In1_1;
	CH__SYNCM();
    ...
    /* wait output channel */
    while (1) {
      /* output: Signal_Conversion_Bus_BusCreator */
      if (CH_0000_0002.flag__0000_0002 == 0) {
	CH_0000_0002.Signal_Conversion_Bus_In1_1 = Signal_Conversion_Bus_In1_1;
	CH__SYNCM();
  ...
  /* initialize task context */
{
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Signal_Conversion_Bus_BusSelector */
      if (CH_0003_0100.flag__0003_0100 == 1) {
	Signal_Conversion_Bus_In1_1 = CH_0003_0100.Signal_Conversion_Bus_In1_1;
	CH__SYNCM();
...
/* Block: Signal_Conversion_Bus_In1 */
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0001_0000.Signal_Conversion_Bus_In1_1 = Signal_Conversion_Bus_In1_1;
	CH__SYNCM();
...
/* Block: Signal_Conversion_Bus_BusCreator */
...
{  /* omit input channel bit vector */
  ...
  while (1) {
	...
	Signal_Conversion_Bus_In1_1 = CH_0000_0002.Signal_Conversion_Bus_In1_1;
	CH__SYNCM();
    ...
    /* wait output channel */
    while (1) {
      /* output: Signal_Conversion_Bus_SignalConversion */
      if (CH_0002_0004.flag__0002_0004 == 0) {
	CH__SYNCM();
	CH_0002_0004.flag__0002_0004 = 1;
	CH__EVENT(TASK_0002,IN_0004);
...
/* Block: Signal_Conversion_Bus_BusSelector */
...
{  /* omit input channel bit vector */
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Signal_Conversion_Bus_SignalConversion */
	...
	CH_0003_0100.Signal_Conversion_Bus_In1_1 = Signal_Conversion_Bus_In1_1;
	CH__SYNCM();
...
/* Block: Signal_Conversion_Bus_SignalConversion */
...
{  /* omit input channel bit vector */
  ...
  /* Block I/O Signals */
  struct {
    BusObject SignalConversion_BusCreator_1;
  } Signal_Conversion_Bus_B;
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Signal_Conversion_Bus_BusCreator */
      if (CH_0002_0004.flag__0002_0004 == 1) {
	CH__SYNCM();
	CH_0002_0004.flag__0002_0004 = 0;
	CH__EVENT(TASK_0004, OUT_0002);
	CH__END_LOG(IN_0004);
	break;
      }
        ...
        {
{
  ...
  Signal_Conversion_Bus_B.SignalConversion_BusCreator_1.a =
    ...
    /* wait output channel */
    while (1) {
      /* output: Signal_Conversion_Bus_BusSelector */
      if (CH_0004_0003.flag__0004_0003 == 0) {
	CH__SYNCM();
