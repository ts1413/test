###########################################################################
## Makefile generated for Simulink model 'IC'. 
## 
## Makefile     : IC.mk
## Generated on : Mon Sep 28 19:33:05 2015
## MATLAB Coder version: 2.6 (R2014a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/IC
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = IC_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/IC
...
INCLUDES_BUILDINFO = -I$(START_DIR)/IC_ert_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=IC -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DUNIX
...
SRCS = $(START_DIR)/IC_ert_rtw/IC.c $(START_DIR)/IC_ert_rtw/IC_data.c

MAIN_SRC = $(START_DIR)/IC_ert_rtw/ert_main.c
...
%.o : $(START_DIR)/IC_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/IC_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
