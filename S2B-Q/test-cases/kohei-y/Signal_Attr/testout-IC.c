...
#include "testout-IC_res.c"
#include "testout-IC.h"
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	IC_In1_1 = CH_IO0001_0000.IC_In1_1;
	CH__SYNCM();
	...
	CH_0000_0002.IC_In1_1 = IC_In1_1;
	CH__SYNCM();
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0001_0000.IC_In1_1 = IC_In1_1;
	CH__SYNCM();
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	IC_In1_1 = CH_0000_0002.IC_In1_1;
	CH__SYNCM();
