###########################################################################
## Makefile generated for Simulink model 'Demux'. 
## 
## Makefile     : Demux.mk
## Generated on : Mon Sep 28 19:34:12 2015
## MATLAB Coder version: 2.6 (R2014a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Demux
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = Demux_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Demux
...
INCLUDES_BUILDINFO = -I$(START_DIR)/Demux_ert_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=Demux -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DUNIX
...
SRCS = $(START_DIR)/Demux_ert_rtw/Demux.c

MAIN_SRC = $(START_DIR)/Demux_ert_rtw/ert_main.c
...
%.o : $(START_DIR)/Demux_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Demux_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
