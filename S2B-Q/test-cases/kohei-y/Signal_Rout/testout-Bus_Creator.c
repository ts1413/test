...
#include "testout-Bus_Creator_res.c"
#include "testout-Bus_Creator.h"
...
/* From: t0
   To: Bus_Creator_BusCreator */
typedef struct {
  int flag__0000_0003;
  real_T Bus_Creator_In1_x;
  real_T Bus_Creator_In2_y;
} TYPE_0000_0003;
TYPE_0000_0003 CH_0000_0003;

/* From: Bus_Creator_In1
   To: t0 */
typedef struct {
...
}
{
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Bus_Creator_In1 */
      if (CH__BITCHECK(IN_0000,0) == 0 && CH_IO0001_0000.flag__IO0001_0000 == 1) {
	Bus_Creator_In1_x = CH_IO0001_0000.Bus_Creator_In1_x;
	CH__SYNCM();
	...
	CH__BITSET(IN_0000,0);
      ...
      /* input: Bus_Creator_In2 */
      if (CH__BITCHECK(IN_0000,1) == 0 && CH_IO0002_0000.flag__IO0002_0000 == 1) {
	Bus_Creator_In2_y = CH_IO0002_0000.Bus_Creator_In2_y;
	CH__SYNCM();
    ...
    /* wait output channel */
    while (1) {
      /* output: Bus_Creator_BusCreator */
      if (CH_0000_0003.flag__0000_0003 == 0) {
	CH_0000_0003.Bus_Creator_In1_x = Bus_Creator_In1_x;
	CH_0000_0003.Bus_Creator_In2_y = Bus_Creator_In2_y;
	CH__SYNCM();
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0001_0000.Bus_Creator_In1_x = Bus_Creator_In1_x;
	CH__SYNCM();
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0002_0000.Bus_Creator_In2_y = Bus_Creator_In2_y;
	CH__SYNCM();
...
{  /* omit input channel bit vector */
  ...
  while (1) {
	...
	Bus_Creator_In1_x = CH_0000_0003.Bus_Creator_In1_x;
	Bus_Creator_In2_y = CH_0000_0003.Bus_Creator_In2_y;
	CH__SYNCM();
