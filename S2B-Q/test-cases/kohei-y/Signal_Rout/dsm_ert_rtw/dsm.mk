###########################################################################
## Makefile generated for Simulink model 'dsm'. 
## 
## Makefile     : dsm.mk
## Generated on : Sun Oct 04 02:23:31 2015
## MATLAB Coder version: 2.6 (R2014a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/dsm
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = dsm_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/dsm
...
INCLUDES_BUILDINFO = -I$(START_DIR)/dsm_ert_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=dsm -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DUNIX
...
SRCS = $(START_DIR)/dsm_ert_rtw/dsm.c $(START_DIR)/dsm_ert_rtw/dsm_data.c

MAIN_SRC = $(START_DIR)/dsm_ert_rtw/ert_main.c
...
%.o : $(START_DIR)/dsm_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/dsm_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
