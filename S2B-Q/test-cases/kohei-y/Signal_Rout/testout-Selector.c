...
#include "testout-Selector_res.c"
#include "testout-Selector.h"
...
/* From: t0
   To: Selector_Selector */
typedef struct {
  int flag__0000_0002;
  real_T Selector_In1_1[3];
} TYPE_0000_0002;
...
{  /* omit input channel bit vector */
  ...
  while (1) {
	...
	memcpy(Selector_In1_1,
	  CH_IO0001_0000.Selector_In1_1,
	  sizeof Selector_In1_1);
	CH__SYNCM();
    ...
    /* wait output channel */
    while (1) {
      /* output: Selector_Selector */
      if (CH_0000_0002.flag__0000_0002 == 0) {
	memcpy(CH_0000_0002.Selector_In1_1,
	  Selector_In1_1,
	  sizeof Selector_In1_1);
	CH__SYNCM();
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	memcpy(CH_IO0001_0000.Selector_In1_1,
	  Selector_In1_1,
	  sizeof Selector_In1_1);
	CH__SYNCM();
