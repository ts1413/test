...
#include "testout-Bus_Selector_res.c"
#include "testout-Bus_Selector.h"
...
/* From: t0
   To: Bus_Selector_BusCreator */
typedef struct {
  int flag__0000_0003;
  real_T Bus_Selector_In1_x;
  real_T Bus_Selector_In2_y;
} TYPE_0000_0003;
TYPE_0000_0003 CH_0000_0003;

/* From: Bus_Selector_In1
   To: t0 */
typedef struct {
...
/* From: Bus_Selector_BusCreator
   To: Bus_Selector_BusSelector */
typedef struct {
  int flag__0003_0004;
} TYPE_0003_0004;
TYPE_0003_0004 CH_0003_0004;
...
}
{
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Bus_Selector_In1 */
      if (CH__BITCHECK(IN_0000,0) == 0 && CH_IO0001_0000.flag__IO0001_0000 == 1) {
	Bus_Selector_In1_x = CH_IO0001_0000.Bus_Selector_In1_x;
	CH__SYNCM();
	...
	CH__BITSET(IN_0000,0);
      ...
      /* input: Bus_Selector_In2 */
      if (CH__BITCHECK(IN_0000,1) == 0 && CH_IO0002_0000.flag__IO0002_0000 == 1) {
	Bus_Selector_In2_y = CH_IO0002_0000.Bus_Selector_In2_y;
	CH__SYNCM();
    ...
    /* wait output channel */
    while (1) {
      /* output: Bus_Selector_BusCreator */
      if (CH_0000_0003.flag__0000_0003 == 0) {
	CH_0000_0003.Bus_Selector_In1_x = Bus_Selector_In1_x;
	CH_0000_0003.Bus_Selector_In2_y = Bus_Selector_In2_y;
	CH__SYNCM();
...
{  /* input channel bit vector */
  ...
  while (1) {
	...
	CH__BITSET(IN_0100,0);
      ...
      /* input: Bus_Selector_BusSelector */
      if (CH__BITCHECK(IN_0100,1) == 0 && CH_0004_0100.flag__0004_0100 == 1) {
	Bus_Selector_In1_x = CH_0004_0100.Bus_Selector_In1_x;
	CH__SYNCM();
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0001_0000.Bus_Selector_In1_x = Bus_Selector_In1_x;
	CH__SYNCM();
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0002_0000.Bus_Selector_In2_y = Bus_Selector_In2_y;
	CH__SYNCM();
...
{  /* omit input channel bit vector */
  ...
  while (1) {
	...
	Bus_Selector_In1_x = CH_0000_0003.Bus_Selector_In1_x;
	Bus_Selector_In2_y = CH_0000_0003.Bus_Selector_In2_y;
	CH__SYNCM();
    ...
    CH__VEC_INIT(OUT_0003);

    /* wait output channel */
    while (1) {
      /* output: Bus_Selector_BusSelector */
      if (CH__BITCHECK(OUT_0003,0) == 0 && CH_0003_0004.flag__0003_0004 == 0) {
	CH__SYNCM();
	CH_0003_0004.flag__0003_0004 = 1;
	CH__EVENT(TASK_0003,IN_0004);
	CH__BITSET(OUT_0003,0);
      }

      /* output: extout */
      if (CH__BITCHECK(OUT_0003,1) == 0 && CH_0003_0100.flag__0003_0100 == 0) {
	CH__SYNCM();
	CH_0003_0100.flag__0003_0100 = 1;
	CH__EVENT(TASK_0003,IN_0100);
	CH__BITSET(OUT_0003,1);
      }

      if (CH__COMPLETED(OUT_0003,2)) {
	CH__END_LOG(OUT_0003);
	break;
      }

      CH__TASK_SCHED(OUT_0003,CH__VEC_NAME(OUT_0003),2);
...
/* Block: Bus_Selector_BusSelector */
...
{  /* omit input channel bit vector */
  ...
  while (1) {
    ...
    while (1) {
      /* input: Bus_Selector_BusCreator */
      if (CH_0003_0004.flag__0003_0004 == 1) {
	CH__SYNCM();
	CH_0003_0004.flag__0003_0004 = 0;
	CH__EVENT(TASK_0004, OUT_0003);
	CH__END_LOG(IN_0004);
	break;
      }
	...
	CH_0004_0100.Bus_Selector_In1_x = Bus_Selector_In1_x;
	CH__SYNCM();
