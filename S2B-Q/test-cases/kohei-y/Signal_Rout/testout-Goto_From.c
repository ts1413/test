  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	Goto_From_In1_1 = CH_IO0001_0000.Goto_From_In1_1;
	CH__SYNCM();
	...
	CH_0000_0100.Goto_From_In1_1 = Goto_From_In1_1;
	CH__SYNCM();
...
{  /* omit input channel bit vector */
  ...
  while (1) {
	...
	Goto_From_In1_1 = CH_0000_0100.Goto_From_In1_1;
	CH__SYNCM();
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0001_0000.Goto_From_In1_1 = Goto_From_In1_1;
	CH__SYNCM();
