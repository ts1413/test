...
#include "testout-dsm_res.c"
#include "testout-dsm.h"
...
/* From: dsm_DataStoreRead
   To: extout */
typedef struct {
  int flag__0003_0100;
  real_T dsm_DataStoreRead_1;
} TYPE_0003_0100;
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	dsm_In1_1 = CH_IO0001_0000.dsm_In1_1;
	CH__SYNCM();
    ...
    /* wait output channel */
    while (1) {
      /* output: dsm_DataStoreWrite */
      if (CH__BITCHECK(OUT_0000,0) == 0 && CH_0000_0004.flag__0000_0004 == 0) {
	CH_0000_0004.dsm_In1_1 = dsm_In1_1;
	CH__SYNCM();
	...
	CH__BITSET(OUT_0000,0);
      ...
      /* output: dsm_DataStoreRead */
      if (CH__BITCHECK(OUT_0000,1) == 0 && CH_0000_0003.flag__0000_0003 == 0) {
	CH__SYNCM();
...
{  /* omit input channel bit vector */
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: dsm_DataStoreRead */
      if (CH_0003_0100.flag__0003_0100 == 1) {
	dsm_DataStoreRead_1 = CH_0003_0100.dsm_DataStoreRead_1;
	CH__SYNCM();
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0001_0000.dsm_In1_1 = dsm_In1_1;
	CH__SYNCM();
        ...
        {
{
  ...
  dsm_DataStoreRead_1 = dsm_DW.Data;
	...
	CH_0003_0100.dsm_DataStoreRead_1 = dsm_DataStoreRead_1;
	CH__SYNCM();
...
{  /* omit input channel bit vector */
  ...
  while (1) {
	...
	dsm_In1_1 = CH_0000_0004.dsm_In1_1;
	CH__SYNCM();
