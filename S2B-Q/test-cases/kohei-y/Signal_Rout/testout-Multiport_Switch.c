...
#include "testout-Multiport_Switch_res.c"
#include "testout-Multiport_Switch.h"
...
/* From: t0
   To: Multiport_Switch_MultiportSwitch */
typedef struct {
  int flag__0000_0005;
  real_T Multiport_Switch_In1_1;
  real_T Multiport_Switch_In2_1;
  real_T Multiport_Switch_In3_1;
  real_T Multiport_Switch_In4_1;
} TYPE_0000_0005;
TYPE_0000_0005 CH_0000_0005;

/* From: Multiport_Switch_In1
   To: t0 */
typedef struct {
...
/* From: Multiport_Switch_In4
   To: t0 */
typedef struct {
  int flag__IO0004_0000;
  real_T Multiport_Switch_In4_1;
} TYPE_IO0004_0000;
TYPE_IO0004_0000 CH_IO0004_0000;

/* From: Multiport_Switch_MultiportSwitch
   To: extout */
typedef struct {
  int flag__0005_0100;
  real_T Multiport_Switch_MultiportSwitch_1;
} TYPE_0005_0100;
TYPE_0005_0100 CH_0005_0100;
...
}
{
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Multiport_Switch_In1 */
      if (CH__BITCHECK(IN_0000,0) == 0 && CH_IO0001_0000.flag__IO0001_0000 == 1) {
	Multiport_Switch_In1_1 = CH_IO0001_0000.Multiport_Switch_In1_1;
	CH__SYNCM();
	...
	CH__BITSET(IN_0000,0);
      ...
      /* input: Multiport_Switch_In2 */
      if (CH__BITCHECK(IN_0000,1) == 0 && CH_IO0002_0000.flag__IO0002_0000 == 1) {
	Multiport_Switch_In2_1 = CH_IO0002_0000.Multiport_Switch_In2_1;
	CH__SYNCM();
	...
	CH__BITSET(IN_0000,1);
      ...
      /* input: Multiport_Switch_In3 */
      if (CH__BITCHECK(IN_0000,2) == 0 && CH_IO0003_0000.flag__IO0003_0000 == 1) {
	Multiport_Switch_In3_1 = CH_IO0003_0000.Multiport_Switch_In3_1;
	CH__SYNCM();
	...
	CH__BITSET(IN_0000,2);
      ...
      /* input: Multiport_Switch_In4 */
      if (CH__BITCHECK(IN_0000,3) == 0 && CH_IO0004_0000.flag__IO0004_0000 == 1) {
	Multiport_Switch_In4_1 = CH_IO0004_0000.Multiport_Switch_In4_1;
	CH__SYNCM();
	CH_IO0004_0000.flag__IO0004_0000 = 0;
	CH__EVENT(TASK_0000, OUT_IO0004);
	CH__BITSET(IN_0000,3);
      }

      if (CH__COMPLETED(IN_0000,4)) {
	CH__END_LOG(IN_0000);
	break;
      }

      CH__TASK_SCHED(IN_0000,CH__VEC_NAME(IN_0000),4);
    ...
    /* wait output channel */
    while (1) {
      /* output: Multiport_Switch_MultiportSwitch */
      if (CH_0000_0005.flag__0000_0005 == 0) {
	CH_0000_0005.Multiport_Switch_In1_1 = Multiport_Switch_In1_1;
	CH_0000_0005.Multiport_Switch_In2_1 = Multiport_Switch_In2_1;
	CH_0000_0005.Multiport_Switch_In3_1 = Multiport_Switch_In3_1;
	CH_0000_0005.Multiport_Switch_In4_1 = Multiport_Switch_In4_1;
	CH__SYNCM();
	CH_0000_0005.flag__0000_0005 = 1;
	CH__EVENT(TASK_0000,IN_0005);
...
{  /* omit input channel bit vector */
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Multiport_Switch_MultiportSwitch */
      if (CH_0005_0100.flag__0005_0100 == 1) {
	Multiport_Switch_MultiportSwitch_1 = CH_0005_0100.Multiport_Switch_MultiportSwitch_1;
	CH__SYNCM();
	CH_0005_0100.flag__0005_0100 = 0;
	CH__EVENT(TASK_0100, OUT_0005);
	CH__END_LOG(IN_0100);
	break;
      }
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0001_0000.Multiport_Switch_In1_1 = Multiport_Switch_In1_1;
	CH__SYNCM();
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0002_0000.Multiport_Switch_In2_1 = Multiport_Switch_In2_1;
	CH__SYNCM();
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0003_0000.Multiport_Switch_In3_1 = Multiport_Switch_In3_1;
	CH__SYNCM();
...
TASK_CODE_PREPARE(IO0004)

/* Block: Multiport_Switch_In4 */
void mcos_lcore_task_IO0004(uint32_t stacd, uintptr_t extinfo)
{  /* omit output channel bit vector */
  /* CH__VEC(OUT_IO0004,1); */
  real_T Multiport_Switch_In4_1;

#ifdef TASK_INITIALIZE_IO0004_COMPLETED
  TASK_INITIALIZE_IO0004_COMPLETED();
#endif
...
#ifdef TASK_EXECUTE_IO0004_COMPLETED
    TASK_EXECUTE_IO0004_COMPLETED();
#endif

    /* wait output channel */
    while (1) {
      /* output: t0 */
      if (CH_IO0004_0000.flag__IO0004_0000 == 0) {
	CH_IO0004_0000.Multiport_Switch_In4_1 = Multiport_Switch_In4_1;
	CH__SYNCM();
	CH_IO0004_0000.flag__IO0004_0000 = 1;
	CH__EVENT(TASK_IO0004,IN_0000);
	CH__END_LOG(OUT_IO0004);
	break;
      }

      CH__TASK_SCHED(OUT_IO0004,NULL,1);

      CH__MEM_BARRIER();
    }

#ifdef TASK_OUT_IO0004_COMPLETED
    TASK_OUT_IO0004_COMPLETED();
#endif
  }
}

TASK_CODE_PREPARE(0005)

/* Block: Multiport_Switch_MultiportSwitch */
void mcos_lcore_task_0005(uint32_t stacd, uintptr_t extinfo)
{  /* omit input channel bit vector */
  /* CH__VEC(IN_0005,1); */
  ...
  /* initialize task context */
{
  ...
  while (1) {
    ...
    while (1) {
      /* input: t0 */
      if (CH_0000_0005.flag__0000_0005 == 1) {
	Multiport_Switch_In1_1 = CH_0000_0005.Multiport_Switch_In1_1;
	Multiport_Switch_In2_1 = CH_0000_0005.Multiport_Switch_In2_1;
	Multiport_Switch_In3_1 = CH_0000_0005.Multiport_Switch_In3_1;
	Multiport_Switch_In4_1 = CH_0000_0005.Multiport_Switch_In4_1;
	CH__SYNCM();
	CH_0000_0005.flag__0000_0005 = 0;
	CH__EVENT(TASK_0005, OUT_0000);
	CH__END_LOG(IN_0005);
	break;
      }

      CH__TASK_SCHED(IN_0005,NULL,1);

      CH__MEM_BARRIER();
    }

#ifdef TASK_IN_0005_COMPLETED
    TASK_IN_0005_COMPLETED();
#endif
        ...
        {
{
  ...
  /* End of MultiPortSwitch: '<Root>/MultiportSwitch' */
    ...
    while (1) {
      /* output: extout */
      if (CH_0005_0100.flag__0005_0100 == 0) {
	CH_0005_0100.Multiport_Switch_MultiportSwitch_1 = Multiport_Switch_MultiportSwitch_1;
	CH__SYNCM();
	CH_0005_0100.flag__0005_0100 = 1;
	CH__EVENT(TASK_0005,IN_0100);
	CH__END_LOG(OUT_0005);
	break;
      }

      CH__TASK_SCHED(OUT_0005,NULL,1);

      CH__MEM_BARRIER();
    }

#ifdef TASK_OUT_0005_COMPLETED
    TASK_OUT_0005_COMPLETED();
#endif
  }
}
...
#ifdef MCOS_LCORE_TASK_IO0004_STATCK_SIZE
  mcos_threadattr_setstacksize (&attr, MCOS_LCORE_TASK_IO0004_STATCK_SIZE);
#else
  mcos_threadattr_setstacksize (&attr, LCORE_STACK_SIZE);
#endif
  tid = mcos_thread_create (&attr, mcos_lcore_task_IO0004, 0);
  if (tid == MC_EPAR || tid == MC_ENOMEM)
    return;
  tids[num++] = tid;

#ifdef MCOS_LCORE_TASK_0005_STATCK_SIZE
  mcos_threadattr_setstacksize (&attr, MCOS_LCORE_TASK_0005_STATCK_SIZE);
#else
  mcos_threadattr_setstacksize (&attr, LCORE_STACK_SIZE);
#endif
  tid = mcos_thread_create (&attr, mcos_lcore_task_0005, 0);
  if (tid == MC_EPAR || tid == MC_ENOMEM)
    return;
  tids[num++] = tid;
