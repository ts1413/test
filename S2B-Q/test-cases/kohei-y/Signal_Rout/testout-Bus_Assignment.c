...
#include "testout-Bus_Assignment_res.c"
#include "testout-Bus_Assignment.h"
...
/* From: t0
   To: Bus_Assignment_BusCreator */
typedef struct {
  int flag__0000_0004;
  real_T Bus_Assignment_In1_x;
  real_T Bus_Assignment_In2_y;
} TYPE_0000_0004;
TYPE_0000_0004 CH_0000_0004;

/* From: Bus_Assignment_In1
   To: t0 */
typedef struct {
...
/* From: Bus_Assignment_BusAssignment
   To: extout */
typedef struct {
  int flag__0003_0100;
} TYPE_0003_0100;
...
/* From: Bus_Assignment_BusCreator
   To: Bus_Assignment_BusAssignment */
typedef struct {
  int flag__0004_0003;
} TYPE_0004_0003;
TYPE_0004_0003 CH_0004_0003;
...
}
{
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Bus_Assignment_In1 */
      if (CH__BITCHECK(IN_0000,0) == 0 && CH_IO0001_0000.flag__IO0001_0000 == 1) {
	Bus_Assignment_In1_x = CH_IO0001_0000.Bus_Assignment_In1_x;
	CH__SYNCM();
	...
	CH__BITSET(IN_0000,0);
      ...
      /* input: Bus_Assignment_In2 */
      if (CH__BITCHECK(IN_0000,1) == 0 && CH_IO0002_0000.flag__IO0002_0000 == 1) {
	Bus_Assignment_In2_y = CH_IO0002_0000.Bus_Assignment_In2_y;
	CH__SYNCM();
    ...
    /* wait output channel */
    while (1) {
      /* output: Bus_Assignment_BusCreator */
      if (CH_0000_0004.flag__0000_0004 == 0) {
	CH_0000_0004.Bus_Assignment_In1_x = Bus_Assignment_In1_x;
	CH_0000_0004.Bus_Assignment_In2_y = Bus_Assignment_In2_y;
	CH__SYNCM();
...
{  /* input channel bit vector */
  ...
  while (1) {
    ...
    /* clear input channel bit vector */
    CH__VEC_INIT(IN_0100);

    /* wait input channel */
    while (1) {
      /* input: Bus_Assignment_BusAssignment */
      if (CH__BITCHECK(IN_0100,0) == 0 && CH_0003_0100.flag__0003_0100 == 1) {
	CH__SYNCM();
	CH_0003_0100.flag__0003_0100 = 0;
	CH__EVENT(TASK_0100, OUT_0003);
	CH__BITSET(IN_0100,0);
      }

      /* input: Bus_Assignment_BusCreator */
      if (CH__BITCHECK(IN_0100,1) == 0 && CH_0004_0100.flag__0004_0100 == 1) {
	CH__SYNCM();
	CH_0004_0100.flag__0004_0100 = 0;
	CH__EVENT(TASK_0100, OUT_0004);
	CH__BITSET(IN_0100,1);
      }

      if (CH__COMPLETED(IN_0100,2)) {
	CH__END_LOG(IN_0100);
	break;
      }

      CH__TASK_SCHED(IN_0100,CH__VEC_NAME(IN_0100),2);
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0001_0000.Bus_Assignment_In1_x = Bus_Assignment_In1_x;
	CH__SYNCM();
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0002_0000.Bus_Assignment_In2_y = Bus_Assignment_In2_y;
	CH__SYNCM();
...
/* Block: Bus_Assignment_BusAssignment */
...
{  /* omit input channel bit vector */
  ...
  real_T Bus_Assignment_Constant_1;
  ...
  /* initialize task context */
{
  ...
  while (1) {
    ...
    while (1) {
      /* input: Bus_Assignment_BusCreator */
      if (CH_0004_0003.flag__0004_0003 == 1) {
	CH__SYNCM();
	CH_0004_0003.flag__0004_0003 = 0;
	CH__EVENT(TASK_0003, OUT_0004);
	CH__END_LOG(IN_0003);
	break;
      }
...
/* Block: Bus_Assignment_BusCreator */
...
{  /* omit input channel bit vector */
  ...
  while (1) {
	...
	Bus_Assignment_In1_x = CH_0000_0004.Bus_Assignment_In1_x;
	Bus_Assignment_In2_y = CH_0000_0004.Bus_Assignment_In2_y;
	CH__SYNCM();
    ...
    CH__VEC_INIT(OUT_0004);

    /* wait output channel */
    while (1) {
      /* output: Bus_Assignment_BusAssignment */
      if (CH__BITCHECK(OUT_0004,0) == 0 && CH_0004_0003.flag__0004_0003 == 0) {
	CH__SYNCM();
	CH_0004_0003.flag__0004_0003 = 1;
	CH__EVENT(TASK_0004,IN_0003);
	CH__BITSET(OUT_0004,0);
      }

      /* output: extout */
      if (CH__BITCHECK(OUT_0004,1) == 0 && CH_0004_0100.flag__0004_0100 == 0) {
	CH__SYNCM();
	CH_0004_0100.flag__0004_0100 = 1;
	CH__EVENT(TASK_0004,IN_0100);
	CH__BITSET(OUT_0004,1);
      }

      if (CH__COMPLETED(OUT_0004,2)) {
	CH__END_LOG(OUT_0004);
	break;
      }

      CH__TASK_SCHED(OUT_0004,CH__VEC_NAME(OUT_0004),2);
