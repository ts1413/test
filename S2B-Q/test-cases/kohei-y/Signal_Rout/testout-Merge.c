...
#include "testout-Merge_res.c"
#include "testout-Merge.h"
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	Merge_In1_1 = CH_IO0001_0000.Merge_In1_1;
	CH__SYNCM();
	...
	CH_0000_0004.Merge_In1_1 = Merge_In1_1;
	CH__SYNCM();
...
{  /* omit input channel bit vector */
  ...
  while (1) {
	...
	Merge_Merge_1 = CH_0004_0100.Merge_Merge_1;
	CH__SYNCM();
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0001_0000.Merge_In1_1 = Merge_In1_1;
	CH__SYNCM();
...
{  /* omit input channel bit vector */
  ...
  real_T Merge_Constant1_1;
  real_T Merge_Constant_1;
  real_T Merge_In1_1;
  real_T Merge_Merge_1;
...
}
{
  ...
  while (1) {
	...
	Merge_In1_1 = CH_0000_0004.Merge_In1_1;
	CH__SYNCM();
...

{
  ...
  /* End of If: '<Root>/If' */
	...
	CH_0004_0100.Merge_Merge_1 = Merge_Merge_1;
	CH__SYNCM();
