...
#include "testout-Goto_Tag_Visibility_res.c"
#include "testout-Goto_Tag_Visibility.h"
...
typedef struct {
  int flag__0000_0100;
  real_T Goto_Tag_Visibility_In1_1;
} TYPE_0000_0100;
TYPE_0000_0100 CH_0000_0100;

/* From: Goto_Tag_Visibility_In1
   To: t0 */
typedef struct {
  ...
  /* initialize task context */
{
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Goto_Tag_Visibility_In1 */
      if (CH_IO0001_0000.flag__IO0001_0000 == 1) {
	Goto_Tag_Visibility_In1_1 = CH_IO0001_0000.Goto_Tag_Visibility_In1_1;
	CH__SYNCM();
	...
	CH_0000_0100.Goto_Tag_Visibility_In1_1 = Goto_Tag_Visibility_In1_1;
	CH__SYNCM();
...
{  /* omit input channel bit vector */
  ...
  while (1) {
	...
	Goto_Tag_Visibility_In1_1 = CH_0000_0100.Goto_Tag_Visibility_In1_1;
	CH__SYNCM();
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0001_0000.Goto_Tag_Visibility_In1_1 = Goto_Tag_Visibility_In1_1;
	CH__SYNCM();
