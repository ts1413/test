...
#include "testout-Shift_Arithmetic_Input_res.c"
#include "testout-Shift_Arithmetic_Input.h"
...
/* From: t0
   To: Shift_Arithmetic_Input_ShiftArithmetic */
typedef struct {
  int flag__0000_0003;
  real_T Shift_Arithmetic_Input_In1_1;
  real_T Shift_Arithmetic_Input_In2_1;
} TYPE_0000_0003;
TYPE_0000_0003 CH_0000_0003;

/* From: Shift_Arithmetic_Input_In1
   To: t0 */
typedef struct {
...
/* From: Shift_Arithmetic_Input_In2
   To: t0 */
typedef struct {
...
/* From: Shift_Arithmetic_Input_ShiftArithmetic
   To: extout */
typedef struct {
  int flag__0003_0100;
  real_T Shift_Arithmetic_Input_ShiftArithmetic_1;
} TYPE_0003_0100;
...
}
{
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Shift_Arithmetic_Input_In1 */
      if (CH__BITCHECK(IN_0000,0) == 0 && CH_IO0001_0000.flag__IO0001_0000 == 1) {
	Shift_Arithmetic_Input_In1_1 = CH_IO0001_0000.Shift_Arithmetic_Input_In1_1;
	CH__SYNCM();
	...
	CH__BITSET(IN_0000,0);
      ...
      /* input: Shift_Arithmetic_Input_In2 */
      if (CH__BITCHECK(IN_0000,1) == 0 && CH_IO0002_0000.flag__IO0002_0000 == 1) {
	Shift_Arithmetic_Input_In2_1 = CH_IO0002_0000.Shift_Arithmetic_Input_In2_1;
	CH__SYNCM();
    ...
    /* wait output channel */
    while (1) {
      /* output: Shift_Arithmetic_Input_ShiftArithmetic */
      if (CH_0000_0003.flag__0000_0003 == 0) {
	CH_0000_0003.Shift_Arithmetic_Input_In1_1 = Shift_Arithmetic_Input_In1_1;
	CH_0000_0003.Shift_Arithmetic_Input_In2_1 = Shift_Arithmetic_Input_In2_1;
	CH__SYNCM();
...
{  /* omit input channel bit vector */
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Shift_Arithmetic_Input_ShiftArithmetic */
      if (CH_0003_0100.flag__0003_0100 == 1) {
	Shift_Arithmetic_Input_ShiftArithmetic_1 = CH_0003_0100.Shift_Arithmetic_Input_ShiftArithmetic_1;
	CH__SYNCM();
...
/* Block: Shift_Arithmetic_Input_In1 */
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0001_0000.Shift_Arithmetic_Input_In1_1 = Shift_Arithmetic_Input_In1_1;
	CH__SYNCM();
...
/* Block: Shift_Arithmetic_Input_In2 */
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0002_0000.Shift_Arithmetic_Input_In2_1 = Shift_Arithmetic_Input_In2_1;
	CH__SYNCM();
...
/* Block: Shift_Arithmetic_Input_ShiftArithmetic */
...
{  /* omit input channel bit vector */
  ...
  /* params */
  struct {
    double BinPtShiftNumber;
    double BitShiftNumber;
  }  = {
  };
  real_T Shift_Arithmetic_Input_In1_1;
  real_T Shift_Arithmetic_Input_In2_1;
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	Shift_Arithmetic_Input_In1_1 = CH_0000_0003.Shift_Arithmetic_Input_In1_1;
	Shift_Arithmetic_Input_In2_1 = CH_0000_0003.Shift_Arithmetic_Input_In2_1;
	CH__SYNCM();
        ...
        {
{
  ...
  Shift_Arithmetic_Input_ShiftArithmetic_1 = ldexp(Shift_Arithmetic_Input_In1_1,
	...
	CH_0003_0100.Shift_Arithmetic_Input_ShiftArithmetic_1 = Shift_Arithmetic_Input_ShiftArithmetic_1;
	CH__SYNCM();
