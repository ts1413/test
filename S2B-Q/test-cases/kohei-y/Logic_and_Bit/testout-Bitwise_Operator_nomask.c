...
#include "testout-Bitwise_Operator_nomask_res.c"
#include "testout-Bitwise_Operator_nomask.h"
...
/* From: t0
   To: Bitwise_Operator_nomask_BitwiseOperator */
typedef struct {
  int flag__0000_0002;
  int8_T Bitwise_Operator_nomask_In1_1;
} TYPE_0000_0002;
TYPE_0000_0002 CH_0000_0002;

/* From: Bitwise_Operator_nomask_In1
   To: t0 */
typedef struct {
...
/* From: Bitwise_Operator_nomask_BitwiseOperator
   To: extout */
typedef struct {
  int flag__0002_0100;
  int8_T Bitwise_Operator_nomask_BitwiseOperator_1;
} TYPE_0002_0100;
  ...
  /* initialize task context */
{
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Bitwise_Operator_nomask_In1 */
      if (CH_IO0001_0000.flag__IO0001_0000 == 1) {
	Bitwise_Operator_nomask_In1_1 = CH_IO0001_0000.Bitwise_Operator_nomask_In1_1;
	CH__SYNCM();
    ...
    /* wait output channel */
    while (1) {
      /* output: Bitwise_Operator_nomask_BitwiseOperator */
      if (CH_0000_0002.flag__0000_0002 == 0) {
	CH_0000_0002.Bitwise_Operator_nomask_In1_1 = Bitwise_Operator_nomask_In1_1;
	CH__SYNCM();
...
{  /* omit input channel bit vector */
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Bitwise_Operator_nomask_BitwiseOperator */
      if (CH_0002_0100.flag__0002_0100 == 1) {
	Bitwise_Operator_nomask_BitwiseOperator_1 = CH_0002_0100.Bitwise_Operator_nomask_BitwiseOperator_1;
	CH__SYNCM();
...
/* Block: Bitwise_Operator_nomask_In1 */
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0001_0000.Bitwise_Operator_nomask_In1_1 = Bitwise_Operator_nomask_In1_1;
	CH__SYNCM();
...
/* Block: Bitwise_Operator_nomask_BitwiseOperator */
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	Bitwise_Operator_nomask_In1_1 = CH_0000_0002.Bitwise_Operator_nomask_In1_1;
	CH__SYNCM();
        ...
        {
{
  ...
  Bitwise_Operator_nomask_BitwiseOperator_1 = (int8_T)
	...
	CH_0002_0100.Bitwise_Operator_nomask_BitwiseOperator_1 = Bitwise_Operator_nomask_BitwiseOperator_1;
	CH__SYNCM();
