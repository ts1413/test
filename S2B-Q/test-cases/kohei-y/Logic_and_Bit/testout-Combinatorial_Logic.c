...
#include "testout-Combinatorial_Logic_res.c"
#include "testout-Combinatorial_Logic.h"
...
/* From: t0
   To: Combinatorial_Logic_CombinatorialLogic */
typedef struct {
  int flag__0000_0002;
  boolean_T Combinatorial_Logic_In1_1[3];
} TYPE_0000_0002;
TYPE_0000_0002 CH_0000_0002;

/* From: Combinatorial_Logic_In1
   To: t0 */
typedef struct {
...
/* From: Combinatorial_Logic_CombinatorialLogic
   To: extout */
typedef struct {
  int flag__0002_0100;
  boolean_T Combinatorial_Logic_CombinatorialLogic_1[2];
} TYPE_0002_0100;
...
void mcos_lcore_task_0000(uint32_t stacd, uintptr_t extinfo)
{
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Combinatorial_Logic_In1 */
      if (CH_IO0001_0000.flag__IO0001_0000 == 1) {
	memcpy(Combinatorial_Logic_In1_1,
	  CH_IO0001_0000.Combinatorial_Logic_In1_1,
	  sizeof Combinatorial_Logic_In1_1);
	CH__SYNCM();
    ...
    /* wait output channel */
    while (1) {
      /* output: Combinatorial_Logic_CombinatorialLogic */
      if (CH_0000_0002.flag__0000_0002 == 0) {
	memcpy(CH_0000_0002.Combinatorial_Logic_In1_1,
	  Combinatorial_Logic_In1_1,
	  sizeof Combinatorial_Logic_In1_1);
	CH__SYNCM();
...
void mcos_lcore_task_0100(uint32_t stacd, uintptr_t extinfo)
{
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Combinatorial_Logic_CombinatorialLogic */
      if (CH_0002_0100.flag__0002_0100 == 1) {
	memcpy(Combinatorial_Logic_CombinatorialLogic_1,
	  CH_0002_0100.Combinatorial_Logic_CombinatorialLogic_1,
	  sizeof Combinatorial_Logic_CombinatorialLogic_1);
	CH__SYNCM();
...
void mcos_lcore_task_IO0001(uint32_t stacd, uintptr_t extinfo)
{
  ...
  while (1) {
	...
	memcpy(CH_IO0001_0000.Combinatorial_Logic_In1_1,
	  Combinatorial_Logic_In1_1,
	  sizeof Combinatorial_Logic_In1_1);
	CH__SYNCM();
...
/* Block: Combinatorial_Logic_CombinatorialLogic */
void mcos_lcore_task_0002(uint32_t stacd, uintptr_t extinfo)
{
  ...
  /* params */
  struct {
    boolean_T CombinatorialLogic_table[16];
  } Combinatorial_Logic_P = {
  };
  boolean_T Combinatorial_Logic_In1_1[3];
  boolean_T Combinatorial_Logic_CombinatorialLogic_1[2];
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	memcpy(Combinatorial_Logic_In1_1,
	  CH_0000_0002.Combinatorial_Logic_In1_1,
	  sizeof Combinatorial_Logic_In1_1);
	CH__SYNCM();
        ...
        {
{
  ...
  Combinatorial_Logic_CombinatorialLogic_1[1U] =
	...
	memcpy(CH_0002_0100.Combinatorial_Logic_CombinatorialLogic_1,
	  Combinatorial_Logic_CombinatorialLogic_1,
	  sizeof Combinatorial_Logic_CombinatorialLogic_1);
	CH__SYNCM();
