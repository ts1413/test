...
#include "testout-Detect_Change_SampleBase_res.c"
#include "testout-Detect_Change_SampleBase.h"
...
/* From: t0
   To: Detect_Change_SampleBase_DetectChange */
typedef struct {
  int flag__0000_0002;
  real_T Detect_Change_SampleBase_In1_1;
} TYPE_0000_0002;
TYPE_0000_0002 CH_0000_0002;

/* From: Detect_Change_SampleBase_In1
   To: t0 */
typedef struct {
...
/* From: Detect_Change_SampleBase_DetectChange
   To: extout */
typedef struct {
  int flag__0002_0100;
} TYPE_0002_0100;
  ...
  /* initialize task context */
{
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Detect_Change_SampleBase_In1 */
      if (CH_IO0001_0000.flag__IO0001_0000 == 1) {
	Detect_Change_SampleBase_In1_1 = CH_IO0001_0000.Detect_Change_SampleBase_In1_1;
	CH__SYNCM();
    ...
    /* wait output channel */
    while (1) {
      /* output: Detect_Change_SampleBase_DetectChange */
      if (CH_0000_0002.flag__0000_0002 == 0) {
	CH_0000_0002.Detect_Change_SampleBase_In1_1 = Detect_Change_SampleBase_In1_1;
	CH__SYNCM();
  ...
  /* initialize task context */
{
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Detect_Change_SampleBase_DetectChange */
...
/* Block: Detect_Change_SampleBase_In1 */
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0001_0000.Detect_Change_SampleBase_In1_1 = Detect_Change_SampleBase_In1_1;
	CH__SYNCM();
...
/* Block: Detect_Change_SampleBase_DetectChange */
...
{  /* omit input channel bit vector */
  ...
  while (1) {
	...
	Detect_Change_SampleBase_In1_1 = CH_0000_0002.Detect_Change_SampleBase_In1_1;
	CH__SYNCM();
