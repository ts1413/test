...
#include <stddef.h>
#include "rtwtypes.h"
#include "Shift_Arithmetic_Dlg_types.h"
#include "Shift_Arithmetic_Dlg_private.h"

#include "testout-Shift_Arithmetic_Dlg_res.c"
#include "testout-Shift_Arithmetic_Dlg.h"
...
/* From: t0
   To: Shift_Arithmetic_Dlg_ShiftArithmetic */
typedef struct {
  int flag__0000_0002;
  real_T Shift_Arithmetic_Dlg_In1_1;
} TYPE_0000_0002;
TYPE_0000_0002 CH_0000_0002;

/* From: Shift_Arithmetic_Dlg_In1
   To: t0 */
typedef struct {
...
/* From: Shift_Arithmetic_Dlg_ShiftArithmetic
   To: extout */
typedef struct {
  int flag__0002_0100;
  real_T Shift_Arithmetic_Dlg_ShiftArithmetic_1;
} TYPE_0002_0100;
  ...
  /* initialize task context */
{
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Shift_Arithmetic_Dlg_In1 */
      if (CH_IO0001_0000.flag__IO0001_0000 == 1) {
	Shift_Arithmetic_Dlg_In1_1 = CH_IO0001_0000.Shift_Arithmetic_Dlg_In1_1;
	CH__SYNCM();
    ...
    /* wait output channel */
    while (1) {
      /* output: Shift_Arithmetic_Dlg_ShiftArithmetic */
      if (CH_0000_0002.flag__0000_0002 == 0) {
	CH_0000_0002.Shift_Arithmetic_Dlg_In1_1 = Shift_Arithmetic_Dlg_In1_1;
	CH__SYNCM();
...
{  /* omit input channel bit vector */
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Shift_Arithmetic_Dlg_ShiftArithmetic */
      if (CH_0002_0100.flag__0002_0100 == 1) {
	Shift_Arithmetic_Dlg_ShiftArithmetic_1 = CH_0002_0100.Shift_Arithmetic_Dlg_ShiftArithmetic_1;
	CH__SYNCM();
...
/* Block: Shift_Arithmetic_Dlg_In1 */
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0001_0000.Shift_Arithmetic_Dlg_In1_1 = Shift_Arithmetic_Dlg_In1_1;
	CH__SYNCM();
...
/* Block: Shift_Arithmetic_Dlg_ShiftArithmetic */
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	Shift_Arithmetic_Dlg_In1_1 = CH_0000_0002.Shift_Arithmetic_Dlg_In1_1;
	CH__SYNCM();
        ...
        {
{
  ...
  Shift_Arithmetic_Dlg_ShiftArithmetic_1 = ldexp(Shift_Arithmetic_Dlg_In1_1,
	...
	CH_0002_0100.Shift_Arithmetic_Dlg_ShiftArithmetic_1 = Shift_Arithmetic_Dlg_ShiftArithmetic_1;
	CH__SYNCM();
