...
#include "testout-Compare_to_Zero_res.c"
#include "testout-Compare_to_Zero.h"
...
/* From: t0
   To: Compare_to_Zero_CompareToZero */
typedef struct {
  int flag__0000_0002;
  real_T Compare_to_Zero_In1_1;
} TYPE_0000_0002;
TYPE_0000_0002 CH_0000_0002;

/* From: Compare_to_Zero_In1
   To: t0 */
typedef struct {
...
/* From: Compare_to_Zero_CompareToZero
   To: extout */
typedef struct {
  int flag__0002_0100;
} TYPE_0002_0100;
  ...
  /* initialize task context */
{
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Compare_to_Zero_In1 */
      if (CH_IO0001_0000.flag__IO0001_0000 == 1) {
	Compare_to_Zero_In1_1 = CH_IO0001_0000.Compare_to_Zero_In1_1;
	CH__SYNCM();
    ...
    /* wait output channel */
    while (1) {
      /* output: Compare_to_Zero_CompareToZero */
      if (CH_0000_0002.flag__0000_0002 == 0) {
	CH_0000_0002.Compare_to_Zero_In1_1 = Compare_to_Zero_In1_1;
	CH__SYNCM();
  ...
  /* initialize task context */
{
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Compare_to_Zero_CompareToZero */
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0001_0000.Compare_to_Zero_In1_1 = Compare_to_Zero_In1_1;
	CH__SYNCM();
...
/* Block: Compare_to_Zero_CompareToZero */
...
{  /* omit input channel bit vector */
  ...
  while (1) {
	...
	Compare_to_Zero_In1_1 = CH_0000_0002.Compare_to_Zero_In1_1;
	CH__SYNCM();
