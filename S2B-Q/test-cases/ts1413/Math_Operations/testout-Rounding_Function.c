...
#include "testout-Rounding_Function_res.c"
#include "testout-Rounding_Function.h"
...
/* From: t0
   To: Rounding_Function_RoundingFunction */
typedef struct {
  int flag__0000_0002;
  real_T Rounding_Function_In1_1;
} TYPE_0000_0002;
TYPE_0000_0002 CH_0000_0002;

/* From: Rounding_Function_In1
   To: t0 */
typedef struct {
...
/* From: Rounding_Function_RoundingFunction
   To: extout */
typedef struct {
  int flag__0002_0100;
  real_T Rounding_Function_RoundingFunction_1;
} TYPE_0002_0100;
  ...
  /* initialize task context */
{
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Rounding_Function_In1 */
      if (CH_IO0001_0000.flag__IO0001_0000 == 1) {
	Rounding_Function_In1_1 = CH_IO0001_0000.Rounding_Function_In1_1;
	CH__SYNCM();
    ...
    /* wait output channel */
    while (1) {
      /* output: Rounding_Function_RoundingFunction */
      if (CH_0000_0002.flag__0000_0002 == 0) {
	CH_0000_0002.Rounding_Function_In1_1 = Rounding_Function_In1_1;
	CH__SYNCM();
...
{  /* omit input channel bit vector */
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Rounding_Function_RoundingFunction */
      if (CH_0002_0100.flag__0002_0100 == 1) {
	Rounding_Function_RoundingFunction_1 = CH_0002_0100.Rounding_Function_RoundingFunction_1;
	CH__SYNCM();
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0001_0000.Rounding_Function_In1_1 = Rounding_Function_In1_1;
	CH__SYNCM();
...
/* Block: Rounding_Function_RoundingFunction */
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	Rounding_Function_In1_1 = CH_0000_0002.Rounding_Function_In1_1;
	CH__SYNCM();
        ...
        {
{
  ...
  Rounding_Function_RoundingFunction_1 = floor(Rounding_Function_In1_1);
	...
	CH_0002_0100.Rounding_Function_RoundingFunction_1 = Rounding_Function_RoundingFunction_1;
	CH__SYNCM();
