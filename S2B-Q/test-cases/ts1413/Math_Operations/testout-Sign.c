...
#include "testout-Sign_res.c"
#include "testout-Sign.h"
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	Sign_In1_1 = CH_IO0001_0000.Sign_In1_1;
	CH__SYNCM();
	...
	CH_0000_0002.Sign_In1_1 = Sign_In1_1;
	CH__SYNCM();
...
void mcos_lcore_task_0100(uint32_t stacd, uintptr_t extinfo)
{
  ...
  while (1) {
	...
	Sign_Sign_1 = CH_0002_0100.Sign_Sign_1;
	CH__SYNCM();
...
void mcos_lcore_task_IO0001(uint32_t stacd, uintptr_t extinfo)
{
  ...
  while (1) {
	...
	CH_IO0001_0000.Sign_In1_1 = Sign_In1_1;
	CH__SYNCM();
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	Sign_In1_1 = CH_0000_0002.Sign_In1_1;
	CH__SYNCM();
        ...
        {
{
  ...
  /* End of Signum: '<Root>/Sign' */
	...
	CH_0002_0100.Sign_Sign_1 = Sign_Sign_1;
	CH__SYNCM();
