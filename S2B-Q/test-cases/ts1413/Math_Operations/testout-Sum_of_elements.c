...
#include "testout-Sum_of_elements_res.c"
#include "testout-Sum_of_elements.h"
...
/* From: t0
   To: Sum_of_elements_SumofElements */
typedef struct {
  int flag__0000_0002;
  real_T Sum_of_elements_In1_1;
} TYPE_0000_0002;
TYPE_0000_0002 CH_0000_0002;

/* From: Sum_of_elements_In1
   To: t0 */
typedef struct {
...
/* From: Sum_of_elements_SumofElements
   To: extout */
typedef struct {
  int flag__0002_0100;
  real_T Sum_of_elements_SumofElements_1;
} TYPE_0002_0100;
  ...
  /* initialize task context */
{
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Sum_of_elements_In1 */
      if (CH_IO0001_0000.flag__IO0001_0000 == 1) {
	Sum_of_elements_In1_1 = CH_IO0001_0000.Sum_of_elements_In1_1;
	CH__SYNCM();
    ...
    /* wait output channel */
    while (1) {
      /* output: Sum_of_elements_SumofElements */
      if (CH_0000_0002.flag__0000_0002 == 0) {
	CH_0000_0002.Sum_of_elements_In1_1 = Sum_of_elements_In1_1;
	CH__SYNCM();
...
void mcos_lcore_task_0100(uint32_t stacd, uintptr_t extinfo)
{
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Sum_of_elements_SumofElements */
      if (CH_0002_0100.flag__0002_0100 == 1) {
	Sum_of_elements_SumofElements_1 = CH_0002_0100.Sum_of_elements_SumofElements_1;
	CH__SYNCM();
...
void mcos_lcore_task_IO0001(uint32_t stacd, uintptr_t extinfo)
{
  ...
  while (1) {
	...
	CH_IO0001_0000.Sum_of_elements_In1_1 = Sum_of_elements_In1_1;
	CH__SYNCM();
...
/* Block: Sum_of_elements_SumofElements */
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	Sum_of_elements_In1_1 = CH_0000_0002.Sum_of_elements_In1_1;
	CH__SYNCM();
        ...
        {
{
  ...
  Sum_of_elements_SumofElements_1 = tmp;
	...
	CH_0002_0100.Sum_of_elements_SumofElements_1 = Sum_of_elements_SumofElements_1;
	CH__SYNCM();
