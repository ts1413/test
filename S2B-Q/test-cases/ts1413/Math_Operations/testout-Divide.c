...
#include "testout-Divide_res.c"
#include "testout-Divide.h"
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	Divide_In1_1 = CH_IO0001_0000.Divide_In1_1;
	CH__SYNCM();
    ...
    /* wait output channel */
    while (1) {
      /* output: Divide_Divide */
      if (CH_0000_0003.flag__0000_0003 == 0) {
	CH_0000_0003.Divide_In1_1 = Divide_In1_1;
	CH__SYNCM();
...
{  /* omit input channel bit vector */
  ...
  while (1) {
	...
	Divide_Divide_1 = CH_0003_0100.Divide_Divide_1;
	CH__SYNCM();
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0001_0000.Divide_In1_1 = Divide_In1_1;
	CH__SYNCM();
...
}
{
  ...
  while (1) {
	...
	Divide_In1_1 = CH_0000_0003.Divide_In1_1;
	CH__SYNCM();
        ...
        {
{
  ...
  Divide_Divide_1 = Divide_In1_1 / Divide_Constant_1;
	...
	CH_0003_0100.Divide_Divide_1 = Divide_Divide_1;
	CH__SYNCM();
