...
#include <stddef.h>
#include "rtwtypes.h"
#include "Reshape_types.h"
#include "Reshape_private.h"

#include "testout-Reshape_res.c"
#include "testout-Reshape.h"
...
/* From: Reshape_Reshape
   To: extout */
typedef struct {
  int flag__0002_0100;
  real_T Reshape_Reshape_1;
} TYPE_0002_0100;
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	Reshape_In1_1 = CH_IO0001_0000.Reshape_In1_1;
	CH__SYNCM();
    ...
    /* wait output channel */
    while (1) {
      /* output: Reshape_Reshape */
      if (CH_0000_0002.flag__0000_0002 == 0) {
	CH_0000_0002.Reshape_In1_1 = Reshape_In1_1;
	CH__SYNCM();
...
{  /* omit input channel bit vector */
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Reshape_Reshape */
      if (CH_0002_0100.flag__0002_0100 == 1) {
	Reshape_Reshape_1 = CH_0002_0100.Reshape_Reshape_1;
	CH__SYNCM();
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0001_0000.Reshape_In1_1 = Reshape_In1_1;
	CH__SYNCM();
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	Reshape_In1_1 = CH_0000_0002.Reshape_In1_1;
	CH__SYNCM();
        ...
        {
{
  ...
  Reshape_Reshape_1 = Reshape_In1_1;
	...
	CH_0002_0100.Reshape_Reshape_1 = Reshape_Reshape_1;
	CH__SYNCM();
