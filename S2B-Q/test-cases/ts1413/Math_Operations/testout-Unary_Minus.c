...
#include <stddef.h>
#include "rtwtypes.h"
#include "Unary_Minus_types.h"
#include "Unary_Minus_private.h"

#include "testout-Unary_Minus_res.c"
#include "testout-Unary_Minus.h"
...
/* From: t0
   To: Unary_Minus_UnaryMinus */
typedef struct {
  int flag__0000_0002;
  real_T Unary_Minus_In1_1;
} TYPE_0000_0002;
TYPE_0000_0002 CH_0000_0002;

/* From: Unary_Minus_In1
   To: t0 */
typedef struct {
...
/* From: Unary_Minus_UnaryMinus
   To: extout */
typedef struct {
  int flag__0002_0100;
  real_T Unary_Minus_UnaryMinus_1;
} TYPE_0002_0100;
  ...
  /* initialize task context */
{
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Unary_Minus_In1 */
      if (CH_IO0001_0000.flag__IO0001_0000 == 1) {
	Unary_Minus_In1_1 = CH_IO0001_0000.Unary_Minus_In1_1;
	CH__SYNCM();
    ...
    /* wait output channel */
    while (1) {
      /* output: Unary_Minus_UnaryMinus */
      if (CH_0000_0002.flag__0000_0002 == 0) {
	CH_0000_0002.Unary_Minus_In1_1 = Unary_Minus_In1_1;
	CH__SYNCM();
...
{  /* omit input channel bit vector */
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Unary_Minus_UnaryMinus */
      if (CH_0002_0100.flag__0002_0100 == 1) {
	Unary_Minus_UnaryMinus_1 = CH_0002_0100.Unary_Minus_UnaryMinus_1;
	CH__SYNCM();
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0001_0000.Unary_Minus_In1_1 = Unary_Minus_In1_1;
	CH__SYNCM();
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	Unary_Minus_In1_1 = CH_0000_0002.Unary_Minus_In1_1;
	CH__SYNCM();
        ...
        {
{
  ...
  Unary_Minus_UnaryMinus_1 = -Unary_Minus_In1_1;
	...
	CH_0002_0100.Unary_Minus_UnaryMinus_1 = Unary_Minus_UnaryMinus_1;
	CH__SYNCM();
