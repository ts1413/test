...
#include "testout-Math_Function_res.c"
#include "testout-Math_Function.h"
...
/* From: t0
   To: Math_Function_MathFunction */
typedef struct {
  int flag__0000_0002;
  real_T Math_Function_In1_1;
} TYPE_0000_0002;
TYPE_0000_0002 CH_0000_0002;

/* From: Math_Function_In1
   To: t0 */
typedef struct {
...
/* From: Math_Function_MathFunction
   To: extout */
typedef struct {
  int flag__0002_0100;
  real_T Math_Function_MathFunction_1;
} TYPE_0002_0100;
  ...
  /* initialize task context */
{
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Math_Function_In1 */
      if (CH_IO0001_0000.flag__IO0001_0000 == 1) {
	Math_Function_In1_1 = CH_IO0001_0000.Math_Function_In1_1;
	CH__SYNCM();
    ...
    /* wait output channel */
    while (1) {
      /* output: Math_Function_MathFunction */
      if (CH_0000_0002.flag__0000_0002 == 0) {
	CH_0000_0002.Math_Function_In1_1 = Math_Function_In1_1;
	CH__SYNCM();
...
{  /* omit input channel bit vector */
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Math_Function_MathFunction */
      if (CH_0002_0100.flag__0002_0100 == 1) {
	Math_Function_MathFunction_1 = CH_0002_0100.Math_Function_MathFunction_1;
	CH__SYNCM();
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0001_0000.Math_Function_In1_1 = Math_Function_In1_1;
	CH__SYNCM();
...
/* Block: Math_Function_MathFunction */
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	Math_Function_In1_1 = CH_0000_0002.Math_Function_In1_1;
	CH__SYNCM();
        ...
        {
{
  ...
  Math_Function_MathFunction_1 = exp(Math_Function_In1_1);
	...
	CH_0002_0100.Math_Function_MathFunction_1 = Math_Function_MathFunction_1;
	CH__SYNCM();
