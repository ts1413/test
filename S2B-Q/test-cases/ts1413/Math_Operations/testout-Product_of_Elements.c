...
#include "testout-Product_of_Elements_res.c"
#include "testout-Product_of_Elements.h"
...
/* From: t0
   To: Product_of_Elements_ProductofElements */
typedef struct {
  int flag__0000_0002;
  real_T Product_of_Elements_In1_1;
} TYPE_0000_0002;
TYPE_0000_0002 CH_0000_0002;

/* From: Product_of_Elements_In1
   To: t0 */
typedef struct {
...
/* From: Product_of_Elements_ProductofElements
   To: extout */
typedef struct {
  int flag__0002_0100;
  real_T Product_of_Elements_ProductofElements_1;
} TYPE_0002_0100;
  ...
  /* initialize task context */
{
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Product_of_Elements_In1 */
      if (CH_IO0001_0000.flag__IO0001_0000 == 1) {
	Product_of_Elements_In1_1 = CH_IO0001_0000.Product_of_Elements_In1_1;
	CH__SYNCM();
    ...
    /* wait output channel */
    while (1) {
      /* output: Product_of_Elements_ProductofElements */
      if (CH_0000_0002.flag__0000_0002 == 0) {
	CH_0000_0002.Product_of_Elements_In1_1 = Product_of_Elements_In1_1;
	CH__SYNCM();
...
{  /* omit input channel bit vector */
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Product_of_Elements_ProductofElements */
      if (CH_0002_0100.flag__0002_0100 == 1) {
	Product_of_Elements_ProductofElements_1 = CH_0002_0100.Product_of_Elements_ProductofElements_1;
	CH__SYNCM();
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0001_0000.Product_of_Elements_In1_1 = Product_of_Elements_In1_1;
	CH__SYNCM();
...
/* Block: Product_of_Elements_ProductofElements */
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	Product_of_Elements_In1_1 = CH_0000_0002.Product_of_Elements_In1_1;
	CH__SYNCM();
        ...
        {
{
  ...
  Product_of_Elements_ProductofElements_1 = Product_of_Elements_In1_1;
	...
	CH_0002_0100.Product_of_Elements_ProductofElements_1 = Product_of_Elements_ProductofElements_1;
	CH__SYNCM();
