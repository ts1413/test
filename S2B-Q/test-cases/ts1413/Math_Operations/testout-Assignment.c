...
#include "testout-Assignment_res.c"
#include "testout-Assignment.h"
...
/* From: t0
   To: Assignment_Assignment */
typedef struct {
  int flag__0000_0002;
  real_T Assignment_In1_1;
} TYPE_0000_0002;
...
/* From: Assignment_Assignment
   To: extout */
typedef struct {
  int flag__0002_0100;
  real_T Assignment_Assignment_1[4];
} TYPE_0002_0100;
  ...
  /* initialize task context */
{
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Assignment_In1 */
      if (CH_IO0001_0000.flag__IO0001_0000 == 1) {
	Assignment_In1_1 = CH_IO0001_0000.Assignment_In1_1;
	CH__SYNCM();
    ...
    /* wait output channel */
    while (1) {
      /* output: Assignment_Assignment */
      if (CH_0000_0002.flag__0000_0002 == 0) {
	CH_0000_0002.Assignment_In1_1 = Assignment_In1_1;
	CH__SYNCM();
...
{  /* omit input channel bit vector */
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Assignment_Assignment */
      if (CH_0002_0100.flag__0002_0100 == 1) {
	memcpy(Assignment_Assignment_1,
	  CH_0002_0100.Assignment_Assignment_1,
	  sizeof Assignment_Assignment_1);
	CH__SYNCM();
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0001_0000.Assignment_In1_1 = Assignment_In1_1;
	CH__SYNCM();
...
{  /* omit input channel bit vector */
  ...
  /* omit output channel bit vector */
  /* CH__VEC(OUT_0002,1); */
  real_T Assignment_Constant_1[4];
  real_T Assignment_In1_1;
  real_T Assignment_Assignment_1[4];
...
}
{
  ...
  while (1) {
	...
	Assignment_In1_1 = CH_0000_0002.Assignment_In1_1;
	CH__SYNCM();
        ...
        {
{
  ...
  Assignment_Assignment_1[2] = Assignment_In1_1;
	...
	memcpy(CH_0002_0100.Assignment_Assignment_1,
	  Assignment_Assignment_1,
	  sizeof Assignment_Assignment_1);
	CH__SYNCM();
