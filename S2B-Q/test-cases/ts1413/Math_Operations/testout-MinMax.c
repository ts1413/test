...
#include "testout-MinMax_res.c"
#include "testout-MinMax.h"
...
}
{
  ...
  while (1) {
	...
	MinMax_In1_1 = CH_IO0001_0000.MinMax_In1_1;
	CH__SYNCM();
	...
	MinMax_In2_1 = CH_IO0002_0000.MinMax_In2_1;
	CH__SYNCM();
    ...
    /* wait output channel */
    while (1) {
      /* output: MinMax_MinMax */
      if (CH_0000_0003.flag__0000_0003 == 0) {
	CH_0000_0003.MinMax_In1_1 = MinMax_In1_1;
	CH_0000_0003.MinMax_In2_1 = MinMax_In2_1;
	CH__SYNCM();
...
void mcos_lcore_task_0100(uint32_t stacd, uintptr_t extinfo)
{
  ...
  while (1) {
	...
	MinMax_MinMax_1 = CH_0003_0100.MinMax_MinMax_1;
	CH__SYNCM();
...
void mcos_lcore_task_IO0001(uint32_t stacd, uintptr_t extinfo)
{
  ...
  while (1) {
	...
	CH_IO0001_0000.MinMax_In1_1 = MinMax_In1_1;
	CH__SYNCM();
...
void mcos_lcore_task_IO0002(uint32_t stacd, uintptr_t extinfo)
{
  ...
  while (1) {
	...
	CH_IO0002_0000.MinMax_In2_1 = MinMax_In2_1;
	CH__SYNCM();
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	MinMax_In1_1 = CH_0000_0003.MinMax_In1_1;
	MinMax_In2_1 = CH_0000_0003.MinMax_In2_1;
	CH__SYNCM();
        ...
        {
{
  ...
  /* End of MinMax: '<Root>/MinMax' */
	...
	CH_0003_0100.MinMax_MinMax_1 = MinMax_MinMax_1;
	CH__SYNCM();
