...
#include "testout-Add_res.c"
#include "testout-Add.h"
...
}
{
  ...
  while (1) {
	...
	Add_In1_1 = CH_IO0001_0000.Add_In1_1;
	CH__SYNCM();
	...
	Add_In2_1 = CH_IO0002_0000.Add_In2_1;
	CH__SYNCM();
	...
	CH_0000_0003.Add_In1_1 = Add_In1_1;
	CH_0000_0003.Add_In2_1 = Add_In2_1;
	CH__SYNCM();
...
{  /* omit input channel bit vector */
  ...
  while (1) {
	...
	Add_Add_1 = CH_0003_0100.Add_Add_1;
	CH__SYNCM();
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0001_0000.Add_In1_1 = Add_In1_1;
	CH__SYNCM();
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0002_0000.Add_In2_1 = Add_In2_1;
	CH__SYNCM();
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	Add_In1_1 = CH_0000_0003.Add_In1_1;
	Add_In2_1 = CH_0000_0003.Add_In2_1;
	CH__SYNCM();
        ...
        {
{
  ...
  Add_Add_1 = Add_In1_1 + Add_In2_1;
	...
	CH_0003_0100.Add_Add_1 = Add_Add_1;
	CH__SYNCM();
