...
## 
## Makefile     : Add.mk
## Generated on : Mon Sep 28 19:36:27 2015
## MATLAB Coder version: 2.6 (R2014a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Add
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Add
...
INCLUDES_BUILDINFO = -I$(START_DIR)/Add_ert_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=Add -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DUNIX
...
%.o : $(START_DIR)/Add_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Add_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
