...
#include "testout-Matrix_Concatenate_res.c"
#include "testout-Matrix_Concatenate.h"
...
/* From: t0
   To: Matrix_Concatenate_MatrixConcatenate */
typedef struct {
  int flag__0000_0003;
  real_T Matrix_Concatenate_In1_1[2];
  real_T Matrix_Concatenate_In2_1[2];
} TYPE_0000_0003;
TYPE_0000_0003 CH_0000_0003;

/* From: Matrix_Concatenate_In1
   To: t0 */
typedef struct {
...
/* From: Matrix_Concatenate_MatrixConcatenate
   To: extout */
typedef struct {
  int flag__0003_0100;
  real_T Matrix_Concatenate_MatrixConcatenate_1[4];
} TYPE_0003_0100;
...
{  /* input channel bit vector */
  ...
  /* params */
  struct {
    double PortDimensions;
    double PortDimensions__nouse_0001;
  }  = {
  };
  real_T Matrix_Concatenate_In1_1[2];
  real_T Matrix_Concatenate_In2_1[2];
...
}
{
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Matrix_Concatenate_In1 */
      if (CH__BITCHECK(IN_0000,0) == 0 && CH_IO0001_0000.flag__IO0001_0000 == 1) {
	memcpy(Matrix_Concatenate_In1_1,
	  CH_IO0001_0000.Matrix_Concatenate_In1_1,
	  sizeof Matrix_Concatenate_In1_1);
	CH__SYNCM();
	...
	CH__BITSET(IN_0000,0);
      ...
      /* input: Matrix_Concatenate_In2 */
      if (CH__BITCHECK(IN_0000,1) == 0 && CH_IO0002_0000.flag__IO0002_0000 == 1) {
	memcpy(Matrix_Concatenate_In2_1,
	  CH_IO0002_0000.Matrix_Concatenate_In2_1,
	  sizeof Matrix_Concatenate_In2_1);
	CH__SYNCM();
    ...
    /* wait output channel */
    while (1) {
      /* output: Matrix_Concatenate_MatrixConcatenate */
      if (CH_0000_0003.flag__0000_0003 == 0) {
	memcpy(CH_0000_0003.Matrix_Concatenate_In1_1,
	  Matrix_Concatenate_In1_1,
	  sizeof Matrix_Concatenate_In1_1);
	memcpy(CH_0000_0003.Matrix_Concatenate_In2_1,
	  Matrix_Concatenate_In2_1,
	  sizeof Matrix_Concatenate_In2_1);
	CH__SYNCM();
...
{  /* omit input channel bit vector */
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Matrix_Concatenate_MatrixConcatenate */
      if (CH_0003_0100.flag__0003_0100 == 1) {
	memcpy(Matrix_Concatenate_MatrixConcatenate_1,
	  CH_0003_0100.Matrix_Concatenate_MatrixConcatenate_1,
	  sizeof Matrix_Concatenate_MatrixConcatenate_1);
	CH__SYNCM();
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	memcpy(CH_IO0001_0000.Matrix_Concatenate_In1_1,
	  Matrix_Concatenate_In1_1,
	  sizeof Matrix_Concatenate_In1_1);
	CH__SYNCM();
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	memcpy(CH_IO0002_0000.Matrix_Concatenate_In2_1,
	  Matrix_Concatenate_In2_1,
	  sizeof Matrix_Concatenate_In2_1);
	CH__SYNCM();
...
/* Block: Matrix_Concatenate_MatrixConcatenate */
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	memcpy(Matrix_Concatenate_In1_1,
	  CH_0000_0003.Matrix_Concatenate_In1_1,
	  sizeof Matrix_Concatenate_In1_1);
	memcpy(Matrix_Concatenate_In2_1,
	  CH_0000_0003.Matrix_Concatenate_In2_1,
	  sizeof Matrix_Concatenate_In2_1);
	CH__SYNCM();
...

{
  ...
  Matrix_Concatenate_MatrixConcatenate_1[3] = Matrix_Concatenate_In2_1[1];
	...
	memcpy(CH_0003_0100.Matrix_Concatenate_MatrixConcatenate_1,
	  Matrix_Concatenate_MatrixConcatenate_1,
	  sizeof Matrix_Concatenate_MatrixConcatenate_1);
	CH__SYNCM();
