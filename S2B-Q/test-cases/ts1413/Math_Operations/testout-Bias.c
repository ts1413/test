...
#include "testout-Bias_res.c"
#include "testout-Bias.h"
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	Bias_In1_1 = CH_IO0001_0000.Bias_In1_1;
	CH__SYNCM();
	...
	CH_0000_0002.Bias_In1_1 = Bias_In1_1;
	CH__SYNCM();
...
{  /* omit input channel bit vector */
  ...
  while (1) {
	...
	Bias_Bias_1 = CH_0002_0100.Bias_Bias_1;
	CH__SYNCM();
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0001_0000.Bias_In1_1 = Bias_In1_1;
	CH__SYNCM();
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	Bias_In1_1 = CH_0000_0002.Bias_In1_1;
	CH__SYNCM();
        ...
        {
{
  ...
  Bias_Bias_1 = Bias_In1_1 + 10.0;
	...
	CH_0002_0100.Bias_Bias_1 = Bias_Bias_1;
	CH__SYNCM();
