...
#include "testout-Subtract_res.c"
#include "testout-Subtract.h"
...
/* From: t0
   To: Subtract_Subtract */
typedef struct {
  int flag__0000_0003;
  real_T Subtract_In1_1;
  real_T Subtract_In2_1;
} TYPE_0000_0003;
...
/* From: Subtract_Subtract
   To: extout */
typedef struct {
  int flag__0003_0100;
  real_T Subtract_Subtract_1;
} TYPE_0003_0100;
...
}
{
  ...
  while (1) {
	...
	Subtract_In1_1 = CH_IO0001_0000.Subtract_In1_1;
	CH__SYNCM();
	...
	Subtract_In2_1 = CH_IO0002_0000.Subtract_In2_1;
	CH__SYNCM();
    ...
    /* wait output channel */
    while (1) {
      /* output: Subtract_Subtract */
      if (CH_0000_0003.flag__0000_0003 == 0) {
	CH_0000_0003.Subtract_In1_1 = Subtract_In1_1;
	CH_0000_0003.Subtract_In2_1 = Subtract_In2_1;
	CH__SYNCM();
...
{  /* omit input channel bit vector */
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Subtract_Subtract */
      if (CH_0003_0100.flag__0003_0100 == 1) {
	Subtract_Subtract_1 = CH_0003_0100.Subtract_Subtract_1;
	CH__SYNCM();
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0001_0000.Subtract_In1_1 = Subtract_In1_1;
	CH__SYNCM();
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0002_0000.Subtract_In2_1 = Subtract_In2_1;
	CH__SYNCM();
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	Subtract_In1_1 = CH_0000_0003.Subtract_In1_1;
	Subtract_In2_1 = CH_0000_0003.Subtract_In2_1;
	CH__SYNCM();
        ...
        {
{
  ...
  Subtract_Subtract_1 = Subtract_In1_1 - Subtract_In2_1;
	...
	CH_0003_0100.Subtract_Subtract_1 = Subtract_Subtract_1;
	CH__SYNCM();
