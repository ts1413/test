...
#include "testout-Abs_res.c"
#include "testout-Abs.h"
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	Abs_In1_1 = CH_IO0001_0000.Abs_In1_1;
	CH__SYNCM();
	...
	CH_0000_0002.Abs_In1_1 = Abs_In1_1;
	CH__SYNCM();
...
{  /* omit input channel bit vector */
  ...
  while (1) {
	...
	Abs_Abs_1 = CH_0002_0100.Abs_Abs_1;
	CH__SYNCM();
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0001_0000.Abs_In1_1 = Abs_In1_1;
	CH__SYNCM();
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	Abs_In1_1 = CH_0000_0002.Abs_In1_1;
	CH__SYNCM();
        ...
        {
{
  ...
  Abs_Abs_1 = fabs(Abs_In1_1);
	...
	CH_0002_0100.Abs_Abs_1 = Abs_Abs_1;
	CH__SYNCM();
