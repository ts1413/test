...
#include "testout-Trigonometric_Function_res.c"
#include "testout-Trigonometric_Function.h"
...
/* From: t0
   To: Trigonometric_Function_TrigonometricFunction */
typedef struct {
  int flag__0000_0002;
  real_T Trigonometric_Function_In1_1;
} TYPE_0000_0002;
TYPE_0000_0002 CH_0000_0002;

/* From: Trigonometric_Function_In1
   To: t0 */
typedef struct {
...
/* From: Trigonometric_Function_TrigonometricFunction
   To: extout */
typedef struct {
  int flag__0002_0100;
  real_T Trigonometric_Function_TrigonometricFunction_1;
} TYPE_0002_0100;
  ...
  /* initialize task context */
{
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Trigonometric_Function_In1 */
      if (CH_IO0001_0000.flag__IO0001_0000 == 1) {
	Trigonometric_Function_In1_1 = CH_IO0001_0000.Trigonometric_Function_In1_1;
	CH__SYNCM();
    ...
    /* wait output channel */
    while (1) {
      /* output: Trigonometric_Function_TrigonometricFunction */
      if (CH_0000_0002.flag__0000_0002 == 0) {
	CH_0000_0002.Trigonometric_Function_In1_1 = Trigonometric_Function_In1_1;
	CH__SYNCM();
...
{  /* omit input channel bit vector */
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Trigonometric_Function_TrigonometricFunction */
      if (CH_0002_0100.flag__0002_0100 == 1) {
	Trigonometric_Function_TrigonometricFunction_1 = CH_0002_0100.Trigonometric_Function_TrigonometricFunction_1;
	CH__SYNCM();
...
/* Block: Trigonometric_Function_In1 */
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0001_0000.Trigonometric_Function_In1_1 = Trigonometric_Function_In1_1;
	CH__SYNCM();
...
/* Block: Trigonometric_Function_TrigonometricFunction */
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	Trigonometric_Function_In1_1 = CH_0000_0002.Trigonometric_Function_In1_1;
	CH__SYNCM();
        ...
        {
{
  ...
  Trigonometric_Function_TrigonometricFunction_1 = sin
	...
	CH_0002_0100.Trigonometric_Function_TrigonometricFunction_1 = Trigonometric_Function_TrigonometricFunction_1;
	CH__SYNCM();
