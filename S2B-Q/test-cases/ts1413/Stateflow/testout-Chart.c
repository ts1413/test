...
#include "testout-Chart_res.c"
#include "testout-Chart.h"
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	Chart_In1_1 = CH_IO0001_0000.Chart_In1_1;
	CH__SYNCM();
	...
	CH_0000_0002.Chart_In1_1 = Chart_In1_1;
	CH__SYNCM();
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0001_0000.Chart_In1_1 = Chart_In1_1;
	CH__SYNCM();
...
{  /* omit input channel bit vector */
  ...
  /* states */
  struct {
    uint8_T is_active_c3_Chart;
    uint8_T is_c3_Chart;
  } Chart_DWork;
  real_T Chart_In1_1;

  /* initialize state structure */
  memset(&Chart_DWork, 0, sizeof Chart_DWork);
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	Chart_In1_1 = CH_0000_0002.Chart_In1_1;
	CH__SYNCM();
