...
## 
## Makefile     : Chart.mk
## Generated on : Mon Sep 28 20:21:06 2015
## MATLAB Coder version: 2.6 (R2014a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Chart
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = /home/ts1413/data/test-cases/ts1413/Stateflow
ARCH                      = glnxa64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Chart
...
INCLUDES_BUILDINFO = -I$(START_DIR)/Chart_ert_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
SRCS = $(START_DIR)/Chart_ert_rtw/Chart.c
