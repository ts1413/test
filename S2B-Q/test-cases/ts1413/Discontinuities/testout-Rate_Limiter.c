...
#include "testout-Rate_Limiter_res.c"
#include "testout-Rate_Limiter.h"
...
/* From: t0
   To: Rate_Limiter_RateLimiter */
typedef struct {
  int flag__0000_0002;
  real_T Rate_Limiter_In1_1;
} TYPE_0000_0002;
TYPE_0000_0002 CH_0000_0002;

/* From: Rate_Limiter_In1
   To: t0 */
typedef struct {
...
/* From: Rate_Limiter_RateLimiter
   To: extout */
typedef struct {
  int flag__0002_0100;
  real_T Rate_Limiter_RateLimiter_1;
} TYPE_0002_0100;
  ...
  /* initialize task context */
{
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Rate_Limiter_In1 */
      if (CH_IO0001_0000.flag__IO0001_0000 == 1) {
	Rate_Limiter_In1_1 = CH_IO0001_0000.Rate_Limiter_In1_1;
	CH__SYNCM();
    ...
    /* wait output channel */
    while (1) {
      /* output: Rate_Limiter_RateLimiter */
      if (CH_0000_0002.flag__0000_0002 == 0) {
	CH_0000_0002.Rate_Limiter_In1_1 = Rate_Limiter_In1_1;
	CH__SYNCM();
...
void mcos_lcore_task_0100(uint32_t stacd, uintptr_t extinfo)
{
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Rate_Limiter_RateLimiter */
      if (CH_0002_0100.flag__0002_0100 == 1) {
	Rate_Limiter_RateLimiter_1 = CH_0002_0100.Rate_Limiter_RateLimiter_1;
	CH__SYNCM();
...
void mcos_lcore_task_IO0001(uint32_t stacd, uintptr_t extinfo)
{
  ...
  while (1) {
	...
	CH_IO0001_0000.Rate_Limiter_In1_1 = Rate_Limiter_In1_1;
	CH__SYNCM();
...
/* Block: Rate_Limiter_RateLimiter */
void mcos_lcore_task_0002(uint32_t stacd, uintptr_t extinfo)
{
  ...
  memset(&Rate_Limiter_DWork, 0, sizeof Rate_Limiter_DWork);
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	Rate_Limiter_In1_1 = CH_0000_0002.Rate_Limiter_In1_1;
	CH__SYNCM();
        ...
        {
{
  ...
  /* End of RateLimiter: '<Root>/RateLimiter' */
	...
	CH_0002_0100.Rate_Limiter_RateLimiter_1 = Rate_Limiter_RateLimiter_1;
	CH__SYNCM();
