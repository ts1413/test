...
#include "testout-Hit_Crossing_res.c"
#include "testout-Hit_Crossing.h"
...
/* From: t0
   To: Hit_Crossing_HitCrossing */
typedef struct {
  int flag__0000_0002;
  real_T Hit_Crossing_In1_1;
} TYPE_0000_0002;
TYPE_0000_0002 CH_0000_0002;

/* From: Hit_Crossing_In1
   To: t0 */
typedef struct {
...
/* From: Hit_Crossing_HitCrossing
   To: extout */
typedef struct {
  int flag__0002_0100;
  boolean_T Hit_Crossing_HitCrossing_1;
} TYPE_0002_0100;
  ...
  /* initialize task context */
{
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Hit_Crossing_In1 */
      if (CH_IO0001_0000.flag__IO0001_0000 == 1) {
	Hit_Crossing_In1_1 = CH_IO0001_0000.Hit_Crossing_In1_1;
	CH__SYNCM();
    ...
    /* wait output channel */
    while (1) {
      /* output: Hit_Crossing_HitCrossing */
      if (CH_0000_0002.flag__0000_0002 == 0) {
	CH_0000_0002.Hit_Crossing_In1_1 = Hit_Crossing_In1_1;
	CH__SYNCM();
...
void mcos_lcore_task_0100(uint32_t stacd, uintptr_t extinfo)
{
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Hit_Crossing_HitCrossing */
      if (CH_0002_0100.flag__0002_0100 == 1) {
	Hit_Crossing_HitCrossing_1 = CH_0002_0100.Hit_Crossing_HitCrossing_1;
	CH__SYNCM();
...
void mcos_lcore_task_IO0001(uint32_t stacd, uintptr_t extinfo)
{
  ...
  while (1) {
	...
	CH_IO0001_0000.Hit_Crossing_In1_1 = Hit_Crossing_In1_1;
	CH__SYNCM();
...
/* Block: Hit_Crossing_HitCrossing */
void mcos_lcore_task_0002(uint32_t stacd, uintptr_t extinfo)
{
  ...
  /* states */
  struct {
    int_T HitCrossing_MODE;
  } Hit_Crossing_DWork;

  /* trigger states */
  struct {
    ZCSigState HitCrossing_Input_ZCE;
  } Hit_Crossing_PrevZCSigState;

  /* params */
  struct {
    double HitCrossingOffset;
  }  = {
  };
  real_T Hit_Crossing_In1_1;
  boolean_T Hit_Crossing_HitCrossing_1;
  ...
  memset(&Hit_Crossing_DWork, 0, sizeof Hit_Crossing_DWork);
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	Hit_Crossing_In1_1 = CH_0000_0002.Hit_Crossing_In1_1;
	CH__SYNCM();
        ...
        {
{
  ...
  /* End of HitCross: '<Root>/HitCrossing' */
	...
	CH_0002_0100.Hit_Crossing_HitCrossing_1 = Hit_Crossing_HitCrossing_1;
	CH__SYNCM();
