...
#include "testout-Dead_Zone_res.c"
#include "testout-Dead_Zone.h"
...
/* From: t0
   To: Dead_Zone_DeadZone */
typedef struct {
  int flag__0000_0002;
  real_T Dead_Zone_In1_1;
} TYPE_0000_0002;
...
/* From: Dead_Zone_DeadZone
   To: extout */
typedef struct {
  int flag__0002_0100;
  real_T Dead_Zone_DeadZone_1;
} TYPE_0002_0100;
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	Dead_Zone_In1_1 = CH_IO0001_0000.Dead_Zone_In1_1;
	CH__SYNCM();
    ...
    /* wait output channel */
    while (1) {
      /* output: Dead_Zone_DeadZone */
      if (CH_0000_0002.flag__0000_0002 == 0) {
	CH_0000_0002.Dead_Zone_In1_1 = Dead_Zone_In1_1;
	CH__SYNCM();
...
{  /* omit input channel bit vector */
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Dead_Zone_DeadZone */
      if (CH_0002_0100.flag__0002_0100 == 1) {
	Dead_Zone_DeadZone_1 = CH_0002_0100.Dead_Zone_DeadZone_1;
	CH__SYNCM();
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0001_0000.Dead_Zone_In1_1 = Dead_Zone_In1_1;
	CH__SYNCM();
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	Dead_Zone_In1_1 = CH_0000_0002.Dead_Zone_In1_1;
	CH__SYNCM();
        ...
        {
{
  ...
  /* End of DeadZone: '<Root>/DeadZone' */
	...
	CH_0002_0100.Dead_Zone_DeadZone_1 = Dead_Zone_DeadZone_1;
	CH__SYNCM();
