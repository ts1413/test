...
#include "testout-Backlash_res.c"
#include "testout-Backlash.h"
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	Backlash_In1_1 = CH_IO0001_0000.Backlash_In1_1;
	CH__SYNCM();
	...
	CH_0000_0100.Backlash_In1_1 = Backlash_In1_1;
	CH__SYNCM();
...
void mcos_lcore_task_0100(uint32_t stacd, uintptr_t extinfo)
{
  ...
  /* params */
  struct {
    double BacklashWidth;
    double InitialOutput;
  }  = {
  };
  real_T Backlash_Backlash_1;
  real_T Backlash_In1_1;

  /* initialize state structure */
  memset(&Backlash_DWork, 0, sizeof Backlash_DWork);
        ...
        {
{
  ...
  /* End of Backlash: '<Root>/Backlash' */
	...
	Backlash_In1_1 = CH_0000_0100.Backlash_In1_1;
	CH__SYNCM();
...
void mcos_lcore_task_IO0001(uint32_t stacd, uintptr_t extinfo)
{
  ...
  while (1) {
	...
	CH_IO0001_0000.Backlash_In1_1 = Backlash_In1_1;
	CH__SYNCM();
