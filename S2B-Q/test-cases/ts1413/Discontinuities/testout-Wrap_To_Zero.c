...
#include "testout-Wrap_To_Zero_res.c"
#include "testout-Wrap_To_Zero.h"
...
/* From: t0
   To: Wrap_To_Zero_WrapToZero */
typedef struct {
  int flag__0000_0002;
  real_T Wrap_To_Zero_In1_1;
} TYPE_0000_0002;
TYPE_0000_0002 CH_0000_0002;

/* From: Wrap_To_Zero_In1
   To: t0 */
typedef struct {
  ...
  /* initialize task context */
{
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Wrap_To_Zero_In1 */
      if (CH_IO0001_0000.flag__IO0001_0000 == 1) {
	Wrap_To_Zero_In1_1 = CH_IO0001_0000.Wrap_To_Zero_In1_1;
	CH__SYNCM();
    ...
    /* wait output channel */
    while (1) {
      /* output: Wrap_To_Zero_WrapToZero */
      if (CH_0000_0002.flag__0000_0002 == 0) {
	CH_0000_0002.Wrap_To_Zero_In1_1 = Wrap_To_Zero_In1_1;
	CH__SYNCM();
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0001_0000.Wrap_To_Zero_In1_1 = Wrap_To_Zero_In1_1;
	CH__SYNCM();
...
{  /* omit input channel bit vector */
  ...
  while (1) {
	...
	Wrap_To_Zero_In1_1 = CH_0000_0002.Wrap_To_Zero_In1_1;
	CH__SYNCM();
