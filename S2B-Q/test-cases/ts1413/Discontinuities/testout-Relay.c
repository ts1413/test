...
#include "testout-Relay_res.c"
#include "testout-Relay.h"
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	Relay_In1_1 = CH_IO0001_0000.Relay_In1_1;
	CH__SYNCM();
	...
	CH_0000_0002.Relay_In1_1 = Relay_In1_1;
	CH__SYNCM();
...
{  /* omit input channel bit vector */
  ...
  while (1) {
	...
	Relay_Relay_1 = CH_0002_0100.Relay_Relay_1;
	CH__SYNCM();
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0001_0000.Relay_In1_1 = Relay_In1_1;
	CH__SYNCM();
...
{  /* omit input channel bit vector */
  ...
  /* params */
  struct {
    double OffOutputValue;
    double OnOutputValue;
  }  = {
  };
  real_T Relay_In1_1;
  real_T Relay_Relay_1;
  ...
  memset(&Relay_DWork, 0, sizeof Relay_DWork);
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	Relay_In1_1 = CH_0000_0002.Relay_In1_1;
	CH__SYNCM();
        ...
        {
{
  ...
  /* End of Relay: '<Root>/Relay' */
	...
	CH_0002_0100.Relay_Relay_1 = Relay_Relay_1;
	CH__SYNCM();
