...
#include "testout-Discrete_Derivative_res.c"
#include "testout-Discrete_Derivative.h"
...
/* From: t0
   To: Discrete_Derivative_DiscreteDerivative */
typedef struct {
  int flag__0000_0002;
  real_T Discrete_Derivative_In1_1;
} TYPE_0000_0002;
TYPE_0000_0002 CH_0000_0002;

/* From: Discrete_Derivative_In1
   To: t0 */
typedef struct {
...
/* From: Discrete_Derivative_DiscreteDerivative
   To: extout */
typedef struct {
  int flag__0002_0100;
} TYPE_0002_0100;
  ...
  /* initialize task context */
{
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Discrete_Derivative_In1 */
      if (CH_IO0001_0000.flag__IO0001_0000 == 1) {
	Discrete_Derivative_In1_1 = CH_IO0001_0000.Discrete_Derivative_In1_1;
	CH__SYNCM();
    ...
    /* wait output channel */
    while (1) {
      /* output: Discrete_Derivative_DiscreteDerivative */
      if (CH_0000_0002.flag__0000_0002 == 0) {
	CH_0000_0002.Discrete_Derivative_In1_1 = Discrete_Derivative_In1_1;
	CH__SYNCM();
  ...
  /* initialize task context */
{
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Discrete_Derivative_DiscreteDerivative */
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0001_0000.Discrete_Derivative_In1_1 = Discrete_Derivative_In1_1;
	CH__SYNCM();
...
/* Block: Discrete_Derivative_DiscreteDerivative */
...
{  /* omit input channel bit vector */
  ...
  while (1) {
	...
	Discrete_Derivative_In1_1 = CH_0000_0002.Discrete_Derivative_In1_1;
	CH__SYNCM();
