...
#include "testout-ZeroOrder_Hold_res.c"
#include "testout-ZeroOrder_Hold.h"
...
/* From: t0
   To: ZeroOrder_Hold_Zero_OrderHold */
typedef struct {
  int flag__0000_0002;
  real_T ZeroOrder_Hold_In1_1;
} TYPE_0000_0002;
TYPE_0000_0002 CH_0000_0002;

/* From: ZeroOrder_Hold_In1
   To: t0 */
typedef struct {
...
/* From: ZeroOrder_Hold_Zero_OrderHold
   To: extout */
typedef struct {
  int flag__0002_0100;
  real_T ZeroOrder_Hold_Zero_OrderHold_1;
} TYPE_0002_0100;
  ...
  /* initialize task context */
{
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: ZeroOrder_Hold_In1 */
      if (CH_IO0001_0000.flag__IO0001_0000 == 1) {
	ZeroOrder_Hold_In1_1 = CH_IO0001_0000.ZeroOrder_Hold_In1_1;
	CH__SYNCM();
    ...
    /* wait output channel */
    while (1) {
      /* output: ZeroOrder_Hold_Zero_OrderHold */
      if (CH_0000_0002.flag__0000_0002 == 0) {
	CH_0000_0002.ZeroOrder_Hold_In1_1 = ZeroOrder_Hold_In1_1;
	CH__SYNCM();
...
{  /* omit input channel bit vector */
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: ZeroOrder_Hold_Zero_OrderHold */
      if (CH_0002_0100.flag__0002_0100 == 1) {
	ZeroOrder_Hold_Zero_OrderHold_1 = CH_0002_0100.ZeroOrder_Hold_Zero_OrderHold_1;
	CH__SYNCM();
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0001_0000.ZeroOrder_Hold_In1_1 = ZeroOrder_Hold_In1_1;
	CH__SYNCM();
...
/* Block: ZeroOrder_Hold_Zero_OrderHold */
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	ZeroOrder_Hold_In1_1 = CH_0000_0002.ZeroOrder_Hold_In1_1;
	CH__SYNCM();
        ...
        {
{
  ...
  ZeroOrder_Hold_Zero_OrderHold_1 = ZeroOrder_Hold_In1_1;
	...
	CH_0002_0100.ZeroOrder_Hold_Zero_OrderHold_1 = ZeroOrder_Hold_Zero_OrderHold_1;
	CH__SYNCM();
