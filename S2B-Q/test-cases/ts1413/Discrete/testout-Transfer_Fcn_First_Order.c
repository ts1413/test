...
#include "testout-Transfer_Fcn_First_Order_res.c"
#include "testout-Transfer_Fcn_First_Order.h"
...
/* From: t0
   To: Transfer_Fcn_First_Order_TransferFcnFirstOrder */
typedef struct {
  int flag__0000_0002;
  real_T Transfer_Fcn_First_Order_In1_1;
} TYPE_0000_0002;
TYPE_0000_0002 CH_0000_0002;

/* From: Transfer_Fcn_First_Order_In1
   To: t0 */
typedef struct {
...
/* From: Transfer_Fcn_First_Order_TransferFcnFirstOrder
   To: extout */
typedef struct {
  int flag__0002_0100;
} TYPE_0002_0100;
  ...
  /* initialize task context */
{
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Transfer_Fcn_First_Order_In1 */
      if (CH_IO0001_0000.flag__IO0001_0000 == 1) {
	Transfer_Fcn_First_Order_In1_1 = CH_IO0001_0000.Transfer_Fcn_First_Order_In1_1;
	CH__SYNCM();
    ...
    /* wait output channel */
    while (1) {
      /* output: Transfer_Fcn_First_Order_TransferFcnFirstOrder */
      if (CH_0000_0002.flag__0000_0002 == 0) {
	CH_0000_0002.Transfer_Fcn_First_Order_In1_1 = Transfer_Fcn_First_Order_In1_1;
	CH__SYNCM();
  ...
  /* initialize task context */
{
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Transfer_Fcn_First_Order_TransferFcnFirstOrder */
...
/* Block: Transfer_Fcn_First_Order_In1 */
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0001_0000.Transfer_Fcn_First_Order_In1_1 = Transfer_Fcn_First_Order_In1_1;
	CH__SYNCM();
...
/* Block: Transfer_Fcn_First_Order_TransferFcnFirstOrder */
...
{  /* omit input channel bit vector */
  ...
  while (1) {
	...
	Transfer_Fcn_First_Order_In1_1 = CH_0000_0002.Transfer_Fcn_First_Order_In1_1;
	CH__SYNCM();
