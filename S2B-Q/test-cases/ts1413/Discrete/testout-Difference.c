...
#include "testout-Difference_res.c"
#include "testout-Difference.h"
...
/* From: t0
   To: Difference_Difference */
typedef struct {
  int flag__0000_0002;
  real_T Difference_In1_1;
} TYPE_0000_0002;
  ...
  /* initialize task context */
{
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Difference_In1 */
      if (CH_IO0001_0000.flag__IO0001_0000 == 1) {
	Difference_In1_1 = CH_IO0001_0000.Difference_In1_1;
	CH__SYNCM();
    ...
    /* wait output channel */
    while (1) {
      /* output: Difference_Difference */
      if (CH_0000_0002.flag__0000_0002 == 0) {
	CH_0000_0002.Difference_In1_1 = Difference_In1_1;
	CH__SYNCM();
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0001_0000.Difference_In1_1 = Difference_In1_1;
	CH__SYNCM();
...
{  /* omit input channel bit vector */
  ...
  while (1) {
	...
	Difference_In1_1 = CH_0000_0002.Difference_In1_1;
	CH__SYNCM();
