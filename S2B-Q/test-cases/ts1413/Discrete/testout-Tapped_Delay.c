...
#include "testout-Tapped_Delay_res.c"
#include "testout-Tapped_Delay.h"
...
typedef struct {
  int flag__0000_0100;
  real_T Tapped_Delay_In1_1;
} TYPE_0000_0100;
TYPE_0000_0100 CH_0000_0100;

/* From: Tapped_Delay_In1
   To: t0 */
typedef struct {
  ...
  /* initialize task context */
{
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Tapped_Delay_In1 */
      if (CH_IO0001_0000.flag__IO0001_0000 == 1) {
	Tapped_Delay_In1_1 = CH_IO0001_0000.Tapped_Delay_In1_1;
	CH__SYNCM();
	...
	CH_0000_0100.Tapped_Delay_In1_1 = Tapped_Delay_In1_1;
	CH__SYNCM();
...
{  /* omit input channel bit vector */
  ...
  real_T Tapped_Delay_TappedDelay_1[4];
  real_T Tapped_Delay_In1_1;

  /* initialize state structure */
  memset(&Tapped_Delay_DWork, 0, sizeof Tapped_Delay_DWork);
        ...
        {
{
  ...
  Tapped_Delay_TappedDelay_1[3] = Tapped_Delay_DWork.TappedDelay_X[3];
	...
	Tapped_Delay_In1_1 = CH_0000_0100.Tapped_Delay_In1_1;
	CH__SYNCM();
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0001_0000.Tapped_Delay_In1_1 = Tapped_Delay_In1_1;
	CH__SYNCM();
