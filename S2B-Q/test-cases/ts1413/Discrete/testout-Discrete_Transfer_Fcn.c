...
#include "testout-Discrete_Transfer_Fcn_res.c"
#include "testout-Discrete_Transfer_Fcn.h"
...
typedef struct {
  int flag__0000_0100;
  real_T Discrete_Transfer_Fcn_In1_1;
} TYPE_0000_0100;
TYPE_0000_0100 CH_0000_0100;

/* From: Discrete_Transfer_Fcn_In1
   To: t0 */
typedef struct {
  ...
  /* initialize task context */
{
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Discrete_Transfer_Fcn_In1 */
      if (CH_IO0001_0000.flag__IO0001_0000 == 1) {
	Discrete_Transfer_Fcn_In1_1 = CH_IO0001_0000.Discrete_Transfer_Fcn_In1_1;
	CH__SYNCM();
	...
	CH_0000_0100.Discrete_Transfer_Fcn_In1_1 = Discrete_Transfer_Fcn_In1_1;
	CH__SYNCM();
...
void mcos_lcore_task_0100(uint32_t stacd, uintptr_t extinfo)
{
  ...
  real_T Discrete_Transfer_Fcn_DiscreteTransferFcn_1;
  real_T Discrete_Transfer_Fcn_In1_1;

  /* initialize state structure */
  memset(&Discrete_Transfer_Fcn_DWork, 0, sizeof Discrete_Transfer_Fcn_DWork);
        ...
        {
{
  ...
  Discrete_Transfer_Fcn_DiscreteTransferFcn_1 = denAccum;
	...
	Discrete_Transfer_Fcn_In1_1 = CH_0000_0100.Discrete_Transfer_Fcn_In1_1;
	CH__SYNCM();
...
/* Block: Discrete_Transfer_Fcn_In1 */
void mcos_lcore_task_IO0001(uint32_t stacd, uintptr_t extinfo)
{
  ...
  while (1) {
	...
	CH_IO0001_0000.Discrete_Transfer_Fcn_In1_1 = Discrete_Transfer_Fcn_In1_1;
	CH__SYNCM();
