...
#include "testout-fcn_res.c"
#include "testout-fcn.h"
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	fcn_In1_1 = CH_IO0001_0000.fcn_In1_1;
	CH__SYNCM();
	...
	CH_0000_0002.fcn_In1_1 = fcn_In1_1;
	CH__SYNCM();
...
{  /* omit input channel bit vector */
  ...
  while (1) {
	...
	fcn_Fcn_1 = CH_0002_0100.fcn_Fcn_1;
	CH__SYNCM();
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0001_0000.fcn_In1_1 = fcn_In1_1;
	CH__SYNCM();
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	fcn_In1_1 = CH_0000_0002.fcn_In1_1;
	CH__SYNCM();
        ...
        {
{
  ...
  fcn_Fcn_1 = fcn_In1_1 * 5.0;
	...
	CH_0002_0100.fcn_Fcn_1 = fcn_Fcn_1;
	CH__SYNCM();
