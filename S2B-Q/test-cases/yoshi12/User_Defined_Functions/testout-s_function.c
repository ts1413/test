...
#include "testout-s_function_res.c"
#include "testout-s_function.h"
...
/* From: t0
   To: s_function_S_Function */
typedef struct {
  int flag__0000_0002;
  real_T s_function_In1_1;
} TYPE_0000_0002;
...
/* From: s_function_S_Function
   To: extout */
typedef struct {
  int flag__0002_0100;
  real_T s_function_S_Function_1;
} TYPE_0002_0100;
  ...
  /* initialize task context */
{
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: s_function_In1 */
      if (CH_IO0001_0000.flag__IO0001_0000 == 1) {
	s_function_In1_1 = CH_IO0001_0000.s_function_In1_1;
	CH__SYNCM();
    ...
    /* wait output channel */
    while (1) {
      /* output: s_function_S_Function */
      if (CH_0000_0002.flag__0000_0002 == 0) {
	CH_0000_0002.s_function_In1_1 = s_function_In1_1;
	CH__SYNCM();
...
{  /* omit input channel bit vector */
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: s_function_S_Function */
      if (CH_0002_0100.flag__0002_0100 == 1) {
	s_function_S_Function_1 = CH_0002_0100.s_function_S_Function_1;
	CH__SYNCM();
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0001_0000.s_function_In1_1 = s_function_In1_1;
	CH__SYNCM();
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	s_function_In1_1 = CH_0000_0002.s_function_In1_1;
	CH__SYNCM();
        ...
        {
{
  ...
  testest_Outputs_wrapper(&s_function_In1_1, &s_function_S_Function_1 );
	...
	CH_0002_0100.s_function_S_Function_1 = s_function_S_Function_1;
	CH__SYNCM();
