###########################################################################
## Makefile generated for Simulink model 'Display'. 
## 
## Makefile     : Display.mk
## Generated on : Mon Sep 28 19:42:32 2015
## MATLAB Coder version: 2.6 (R2014a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Display
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = /home/ts1413/data/test-cases/yoshi12/Sinks
ARCH                      = glnxa64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = Display_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Display
...
INCLUDES_BUILDINFO = -I$(START_DIR)/Display_ert_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=Display -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DUNIX
...
SRCS = $(START_DIR)/Display_ert_rtw/Display.c

MAIN_SRC = $(START_DIR)/Display_ert_rtw/ert_main.c
...
%.o : $(START_DIR)/Display_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Display_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
