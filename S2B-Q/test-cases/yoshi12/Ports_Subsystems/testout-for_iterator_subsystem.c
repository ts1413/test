...
#include "testout-for_iterator_subsystem_res.c"
#include "testout-for_iterator_subsystem.h"
...
/* From: t0
   To: for_iterator_subsystem_ForIteratorSubsystem */
typedef struct {
  int flag__0000_0002;
  int8_T for_iterator_subsystem_In1_1;
} TYPE_0000_0002;
TYPE_0000_0002 CH_0000_0002;

/* From: for_iterator_subsystem_In1
   To: t0 */
typedef struct {
...
/* From: for_iterator_subsystem_ForIteratorSubsystem
   To: extout */
typedef struct {
  int flag__0002_0100;
  int16_T for_iterator_subsystem_ForIteratorSubsystem_Product_1;
} TYPE_0002_0100;
  ...
  /* initialize task context */
{
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: for_iterator_subsystem_In1 */
      if (CH_IO0001_0000.flag__IO0001_0000 == 1) {
	for_iterator_subsystem_In1_1 = CH_IO0001_0000.for_iterator_subsystem_In1_1;
	CH__SYNCM();
    ...
    /* wait output channel */
    while (1) {
      /* output: for_iterator_subsystem_ForIteratorSubsystem */
      if (CH_0000_0002.flag__0000_0002 == 0) {
	CH_0000_0002.for_iterator_subsystem_In1_1 = for_iterator_subsystem_In1_1;
	CH__SYNCM();
...
void mcos_lcore_task_0100(uint32_t stacd, uintptr_t extinfo)
{
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: for_iterator_subsystem_ForIteratorSubsystem */
      if (CH_0002_0100.flag__0002_0100 == 1) {
	for_iterator_subsystem_ForIteratorSubsystem_Product_1 = CH_0002_0100.for_iterator_subsystem_ForIteratorSubsystem_Product_1;
	CH__SYNCM();
...
/* Block: for_iterator_subsystem_In1 */
void mcos_lcore_task_IO0001(uint32_t stacd, uintptr_t extinfo)
{
  ...
  while (1) {
	...
	CH_IO0001_0000.for_iterator_subsystem_In1_1 = for_iterator_subsystem_In1_1;
	CH__SYNCM();
...
/* Block: for_iterator_subsystem_ForIteratorSubsystem */
void mcos_lcore_task_0002(uint32_t stacd, uintptr_t extinfo)
{
  ...
  struct {
    ...
    int8_T ForIterator_IterationLimit;
    int16_T Out1_Y0;
  } for_iterator_subsystem_P = {
  };
  int8_T for_iterator_subsystem_ForIteratorSubsystem_ForIterator_1;
  int8_T for_iterator_subsystem_In1_1;
  int16_T for_iterator_subsystem_ForIteratorSubsystem_Product_1;
...
}
{
  ...
  while (1) {
	...
	for_iterator_subsystem_In1_1 = CH_0000_0002.for_iterator_subsystem_In1_1;
	CH__SYNCM();
        ...
        {
{
  ...
  /* End of Outputs for SubSystem: '<Root>/ForIteratorSubsystem' */
	...
	CH_0002_0100.for_iterator_subsystem_ForIteratorSubsystem_Product_1 = for_iterator_subsystem_ForIteratorSubsystem_Product_1;
	CH__SYNCM();
