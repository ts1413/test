...
#include "testout-model_res.c"
#include "testout-model.h"
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	model_Model_1 = CH_IO0001_0000.model_Model_1;
	CH__SYNCM();
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0001_0000.model_Model_1 = model_Model_1;
	CH__SYNCM();
