...
#include "testout-while_iterator_subsystem_res.c"
#include "testout-while_iterator_subsystem.h"
...
/* From: t0
   To: while_iterator_subsystem_WhileIteratorSubsystem */
typedef struct {
  int flag__0000_0003;
  boolean_T while_iterator_subsystem_In1_1;
  boolean_T while_iterator_subsystem_In2_1;
} TYPE_0000_0003;
...
TYPE_0000_0100 CH_0000_0100;

/* From: while_iterator_subsystem_In1
   To: t0 */
typedef struct {
...
/* From: while_iterator_subsystem_In2
   To: t0 */
typedef struct {
...
}
{
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: while_iterator_subsystem_In1 */
      if (CH__BITCHECK(IN_0000,0) == 0 && CH_IO0001_0000.flag__IO0001_0000 == 1) {
	while_iterator_subsystem_In1_1 = CH_IO0001_0000.while_iterator_subsystem_In1_1;
	CH__SYNCM();
	...
	CH__BITSET(IN_0000,0);
      ...
      /* input: while_iterator_subsystem_In2 */
      if (CH__BITCHECK(IN_0000,1) == 0 && CH_IO0002_0000.flag__IO0002_0000 == 1) {
	while_iterator_subsystem_In2_1 = CH_IO0002_0000.while_iterator_subsystem_In2_1;
	CH__SYNCM();
    ...
    CH__VEC_INIT(OUT_0000);

    /* wait output channel */
    while (1) {
      /* output: while_iterator_subsystem_WhileIteratorSubsystem */
      if (CH__BITCHECK(OUT_0000,0) == 0 && CH_0000_0003.flag__0000_0003 == 0) {
	CH_0000_0003.while_iterator_subsystem_In1_1 = while_iterator_subsystem_In1_1;
	CH_0000_0003.while_iterator_subsystem_In2_1 = while_iterator_subsystem_In2_1;
	CH__SYNCM();
	CH_0000_0003.flag__0000_0003 = 1;
	CH__EVENT(TASK_0000,IN_0003);
	CH__BITSET(OUT_0000,0);
      }

      /* output: extout */
      if (CH__BITCHECK(OUT_0000,1) == 0 && CH_0000_0100.flag__0000_0100 == 0) {
	CH_0000_0100.while_iterator_subsystem_In1_1 = while_iterator_subsystem_In1_1;
	CH__SYNCM();
	CH_0000_0100.flag__0000_0100 = 1;
	CH__EVENT(TASK_0000,IN_0100);
	CH__BITSET(OUT_0000,1);
      }

      if (CH__COMPLETED(OUT_0000,2)) {
	CH__END_LOG(OUT_0000);
	break;
      }

      CH__TASK_SCHED(OUT_0000,CH__VEC_NAME(OUT_0000),2);
  ...
  /* initialize task context */
{
  ...
  while (1) {
    ...
    while (1) {
      /* input: t0 */
      if (CH_0000_0100.flag__0000_0100 == 1) {
	while_iterator_subsystem_In1_1 = CH_0000_0100.while_iterator_subsystem_In1_1;
	CH__SYNCM();
	CH_0000_0100.flag__0000_0100 = 0;
	CH__EVENT(TASK_0100, OUT_0000);
	CH__END_LOG(IN_0100);
	break;
      }
...
/* Block: while_iterator_subsystem_In1 */
void mcos_lcore_task_IO0001(uint32_t stacd, uintptr_t extinfo)
{
  ...
  while (1) {
	...
	CH_IO0001_0000.while_iterator_subsystem_In1_1 = while_iterator_subsystem_In1_1;
	CH__SYNCM();
...
/* Block: while_iterator_subsystem_In2 */
void mcos_lcore_task_IO0002(uint32_t stacd, uintptr_t extinfo)
{
  ...
  while (1) {
	...
	CH_IO0002_0000.while_iterator_subsystem_In2_1 = while_iterator_subsystem_In2_1;
	CH__SYNCM();
...
/* Block: while_iterator_subsystem_WhileIteratorSubsystem */
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	while_iterator_subsystem_In1_1 = CH_0000_0003.while_iterator_subsystem_In1_1;
	while_iterator_subsystem_In2_1 = CH_0000_0003.while_iterator_subsystem_In2_1;
	CH__SYNCM();
