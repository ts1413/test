...
#include "testout-func_call_genesub_res.c"
#include "testout-func_call_genesub.h"
...
typedef struct {
  int flag__0000_0100;
  real_T func_call_genesub_In1_1;
} TYPE_0000_0100;
TYPE_0000_0100 CH_0000_0100;

/* From: func_call_genesub_In1
   To: t0 */
typedef struct {
  ...
  /* initialize task context */
{
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: func_call_genesub_In1 */
      if (CH_IO0001_0000.flag__IO0001_0000 == 1) {
	func_call_genesub_In1_1 = CH_IO0001_0000.func_call_genesub_In1_1;
	CH__SYNCM();
	...
	CH_0000_0100.func_call_genesub_In1_1 = func_call_genesub_In1_1;
	CH__SYNCM();
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	func_call_genesub_In1_1 = CH_0000_0100.func_call_genesub_In1_1;
	CH__SYNCM();
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0001_0000.func_call_genesub_In1_1 = func_call_genesub_In1_1;
	CH__SYNCM();
