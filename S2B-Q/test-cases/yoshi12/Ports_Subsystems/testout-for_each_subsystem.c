...
#include "testout-for_each_subsystem_res.c"
#include "testout-for_each_subsystem.h"
...
typedef struct {
  int flag__0000_0100;
  real_T for_each_subsystem_In1_1;
} TYPE_0000_0100;
TYPE_0000_0100 CH_0000_0100;

/* From: for_each_subsystem_In1
   To: t0 */
typedef struct {
  ...
  /* initialize task context */
{
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: for_each_subsystem_In1 */
      if (CH_IO0001_0000.flag__IO0001_0000 == 1) {
	for_each_subsystem_In1_1 = CH_IO0001_0000.for_each_subsystem_In1_1;
	CH__SYNCM();
	...
	CH_0000_0100.for_each_subsystem_In1_1 = for_each_subsystem_In1_1;
	CH__SYNCM();
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	for_each_subsystem_In1_1 = CH_0000_0100.for_each_subsystem_In1_1;
	CH__SYNCM();
...
void mcos_lcore_task_IO0001(uint32_t stacd, uintptr_t extinfo)
{
  ...
  while (1) {
	...
	CH_IO0001_0000.for_each_subsystem_In1_1 = for_each_subsystem_In1_1;
	CH__SYNCM();
