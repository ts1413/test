...
## 
## Makefile     : model.mk
## Generated on : Mon Sep 28 19:42:07 2015
...
INCLUDES_BUILDINFO = -I$(START_DIR)/model_ert_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(START_DIR)/slprj/ert/_sharedutils -I./referenced_model_includes
...
DEFINES_STANDARD = -DMODEL=model -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DUNIX
...
MODELREF_LIBS = ./inport_outport_rtwlib.a
...
$(PRODUCT) : $(OBJS) $(PREBUILT_OBJS) $(MODELREF_LIBS) $(MAIN_OBJ)
	...
	$(LD) $(LDFLAGS) -o $(PRODUCT) $(OBJS) $(MAIN_OBJ) $(MODELREF_LIBS_LINK_GROUP) $(SYSTEM_LIBS) $(TOOLCHAIN_LIBS)
