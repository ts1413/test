...
#include "testout-if_and_if_action_subsys_res.c"
#include "testout-if_and_if_action_subsys.h"
...
/* From: t0
   To: if_and_if_action_subsys_If */
typedef struct {
  int flag__0000_0004;
  real_T if_and_if_action_subsys_In1_1;
} TYPE_0000_0004;
TYPE_0000_0004 CH_0000_0004;

/* From: if_and_if_action_subsys_In1
   To: t0 */
typedef struct {
...
/* From: if_and_if_action_subsys_If
   To: extout */
typedef struct {
  int flag__0004_0100;
  real_T if_and_if_action_subsys_Merge_1;
} TYPE_0004_0100;
  ...
  /* initialize task context */
{
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: if_and_if_action_subsys_In1 */
      if (CH_IO0001_0000.flag__IO0001_0000 == 1) {
	if_and_if_action_subsys_In1_1 = CH_IO0001_0000.if_and_if_action_subsys_In1_1;
	CH__SYNCM();
    ...
    /* wait output channel */
    while (1) {
      /* output: if_and_if_action_subsys_If */
      if (CH_0000_0004.flag__0000_0004 == 0) {
	CH_0000_0004.if_and_if_action_subsys_In1_1 = if_and_if_action_subsys_In1_1;
	CH__SYNCM();
...
{  /* omit input channel bit vector */
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: if_and_if_action_subsys_If */
      if (CH_0004_0100.flag__0004_0100 == 1) {
	if_and_if_action_subsys_Merge_1 = CH_0004_0100.if_and_if_action_subsys_Merge_1;
	CH__SYNCM();
...
/* Block: if_and_if_action_subsys_In1 */
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0001_0000.if_and_if_action_subsys_In1_1 = if_and_if_action_subsys_In1_1;
	CH__SYNCM();
...
/* Block: if_and_if_action_subsys_If */
...
{  /* omit input channel bit vector */
  ...
  struct {
    ...
    real_T Merge_InitialOutput;
    double Value;
    real_T Constant_Value;
    real_T Constant1_Value;
  } if_and_if_action_subsys_P = {
  };
  real_T if_and_if_action_subsys_Constant1_1;
  real_T if_and_if_action_subsys_Constant_1;
  real_T if_and_if_action_subsys_In1_1;
  real_T if_and_if_action_subsys_Merge_1;
...
}
{
  ...
  while (1) {
	...
	if_and_if_action_subsys_In1_1 = CH_0000_0004.if_and_if_action_subsys_In1_1;
	CH__SYNCM();
...

{
  ...
  /* End of If: '<Root>/If' */
	...
	CH_0004_0100.if_and_if_action_subsys_Merge_1 = if_and_if_action_subsys_Merge_1;
	CH__SYNCM();
