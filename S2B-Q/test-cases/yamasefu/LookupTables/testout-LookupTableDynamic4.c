...
#include <stddef.h>
#include "rtwtypes.h"
#include "LookupTableDynamic4_types.h"
#include "LookupTableDynamic4_private.h"

#include "testout-LookupTableDynamic4_res.c"
#include "testout-LookupTableDynamic4.h"
...
struct tag_RTM_LookupTableDynamic4_T {
...
/* From: t0
   To: LookupTableDynamic4_LookupTableDynamic */
typedef struct {
  int flag__0000_0004;
  real_T LookupTableDynamic4_In1_1;
} TYPE_0000_0004;
TYPE_0000_0004 CH_0000_0004;

/* From: LookupTableDynamic4_In1
   To: t0 */
typedef struct {
...
/* From: LookupTableDynamic4_LookupTableDynamic
   To: extout */
typedef struct {
  int flag__0004_0100;
  real_T LookupTableDynamic4_LookupTableDynamic_1;
} TYPE_0004_0100;
  ...
  /* initialize task context */
{
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: LookupTableDynamic4_In1 */
      if (CH_IO0001_0000.flag__IO0001_0000 == 1) {
	LookupTableDynamic4_In1_1 = CH_IO0001_0000.LookupTableDynamic4_In1_1;
	CH__SYNCM();
    ...
    /* wait output channel */
    while (1) {
      /* output: LookupTableDynamic4_LookupTableDynamic */
      if (CH_0000_0004.flag__0000_0004 == 0) {
	CH_0000_0004.LookupTableDynamic4_In1_1 = LookupTableDynamic4_In1_1;
	CH__SYNCM();
...
{  /* omit input channel bit vector */
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: LookupTableDynamic4_LookupTableDynamic */
      if (CH_0004_0100.flag__0004_0100 == 1) {
	LookupTableDynamic4_LookupTableDynamic_1 = CH_0004_0100.LookupTableDynamic4_LookupTableDynamic_1;
	CH__SYNCM();
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0001_0000.LookupTableDynamic4_In1_1 = LookupTableDynamic4_In1_1;
	CH__SYNCM();
...
/* Block: LookupTableDynamic4_LookupTableDynamic */
...
{  /* omit input channel bit vector */
  ...
  } LookupTableDynamic4_P = {
  };
  real_T LookupTableDynamic4_Constant1_1[3];
  real_T LookupTableDynamic4_Constant_1[3];
  real_T LookupTableDynamic4_In1_1;
  real_T LookupTableDynamic4_LookupTableDynamic_1;
...
}
{
  ...
  while (1) {
	...
	LookupTableDynamic4_In1_1 = CH_0000_0004.LookupTableDynamic4_In1_1;
	CH__SYNCM();
...

{
   ...
   */
  {
	...
	CH_0004_0100.LookupTableDynamic4_LookupTableDynamic_1 = LookupTableDynamic4_LookupTableDynamic_1;
	CH__SYNCM();
