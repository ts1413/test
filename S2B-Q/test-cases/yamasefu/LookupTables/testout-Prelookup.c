...
#include "testout-Prelookup_res.c"
#include "testout-Prelookup.h"
...
/* From: t0
   To: Prelookup_Prelookup */
typedef struct {
  int flag__0000_0003;
  real_T Prelookup_In1_1;
} TYPE_0000_0003;
...
/* From: Prelookup_InterpolationUsingPrelookup
   To: extout */
typedef struct {
  int flag__0002_0100;
  real_T Prelookup_InterpolationUsingPrelookup_1;
} TYPE_0002_0100;
TYPE_0002_0100 CH_0002_0100;

/* From: Prelookup_Prelookup
   To: Prelookup_InterpolationUsingPrelookup */
typedef struct {
  int flag__0003_0002;
  uint32_T Prelookup_Prelookup_1;
  real_T Prelookup_Prelookup_2;
} TYPE_0003_0002;
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	Prelookup_In1_1 = CH_IO0001_0000.Prelookup_In1_1;
	CH__SYNCM();
    ...
    /* wait output channel */
    while (1) {
      /* output: Prelookup_Prelookup */
      if (CH_0000_0003.flag__0000_0003 == 0) {
	CH_0000_0003.Prelookup_In1_1 = Prelookup_In1_1;
	CH__SYNCM();
...
void mcos_lcore_task_0100(uint32_t stacd, uintptr_t extinfo)
{
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Prelookup_InterpolationUsingPrelookup */
      if (CH_0002_0100.flag__0002_0100 == 1) {
	Prelookup_InterpolationUsingPrelookup_1 = CH_0002_0100.Prelookup_InterpolationUsingPrelookup_1;
	CH__SYNCM();
...
void mcos_lcore_task_IO0001(uint32_t stacd, uintptr_t extinfo)
{
  ...
  while (1) {
	...
	CH_IO0001_0000.Prelookup_In1_1 = Prelookup_In1_1;
	CH__SYNCM();
...
/* Block: Prelookup_InterpolationUsingPrelookup */
void mcos_lcore_task_0002(uint32_t stacd, uintptr_t extinfo)
{
  ...
  /* params */
  struct {
    real_T InterpolationUsingPrelookup_Tab[11];
  } Prelookup_P = {
  };
  uint32_T Prelookup_Prelookup_1;
  real_T Prelookup_Prelookup_2;
  ...
  /* initialize task context */
{
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Prelookup_Prelookup */
      if (CH_0003_0002.flag__0003_0002 == 1) {
	Prelookup_Prelookup_1 = CH_0003_0002.Prelookup_Prelookup_1;
	Prelookup_Prelookup_2 = CH_0003_0002.Prelookup_Prelookup_2;
	CH__SYNCM();
        ...
        {
{
  ...
  Prelookup_InterpolationUsingPrelookup_1 = intrp1d_l_pw(bpIndex, frac,
	...
	CH_0002_0100.Prelookup_InterpolationUsingPrelookup_1 = Prelookup_InterpolationUsingPrelookup_1;
	CH__SYNCM();
...
void mcos_lcore_task_0003(uint32_t stacd, uintptr_t extinfo)
{
  ...
  /* params */
  struct {
    real_T Prelookup_BreakpointsData[11];
  } Prelookup_P = {
  };
  ...
  struct {
  real_T Prelookup_In1_1;
  } Prelookup_U  uint32_T Prelookup_Prelookup_1;
  real_T Prelookup_Prelookup_2;
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	Prelookup_In1_1 = CH_0000_0003.Prelookup_In1_1;
	CH__SYNCM();
        ...
        {
{
  ...
  Prelookup_Prelookup_1 = plook_binx(Prelookup_U.Prelookup_In1_1,
    ...
    /* wait output channel */
    while (1) {
      /* output: Prelookup_InterpolationUsingPrelookup */
      if (CH_0003_0002.flag__0003_0002 == 0) {
	CH_0003_0002.Prelookup_Prelookup_1 = Prelookup_Prelookup_1;
	CH_0003_0002.Prelookup_Prelookup_2 = Prelookup_Prelookup_2;
	CH__SYNCM();
