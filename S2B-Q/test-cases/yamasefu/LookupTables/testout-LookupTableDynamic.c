...
#include "testout-LookupTableDynamic_res.c"
#include "testout-LookupTableDynamic.h"
...
/* From: t0
   To: LookupTableDynamic_LookupTableDynamic */
typedef struct {
  int flag__0000_0004;
  real_T LookupTableDynamic_In1_1;
} TYPE_0000_0004;
TYPE_0000_0004 CH_0000_0004;

/* From: LookupTableDynamic_In1
   To: t0 */
typedef struct {
...
/* From: LookupTableDynamic_LookupTableDynamic
   To: extout */
typedef struct {
  int flag__0004_0100;
  real_T LookupTableDynamic_LookupTableDynamic_1;
} TYPE_0004_0100;
  ...
  /* initialize task context */
{
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: LookupTableDynamic_In1 */
      if (CH_IO0001_0000.flag__IO0001_0000 == 1) {
	LookupTableDynamic_In1_1 = CH_IO0001_0000.LookupTableDynamic_In1_1;
	CH__SYNCM();
    ...
    /* wait output channel */
    while (1) {
      /* output: LookupTableDynamic_LookupTableDynamic */
      if (CH_0000_0004.flag__0000_0004 == 0) {
	CH_0000_0004.LookupTableDynamic_In1_1 = LookupTableDynamic_In1_1;
	CH__SYNCM();
...
{  /* omit input channel bit vector */
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: LookupTableDynamic_LookupTableDynamic */
      if (CH_0004_0100.flag__0004_0100 == 1) {
	LookupTableDynamic_LookupTableDynamic_1 = CH_0004_0100.LookupTableDynamic_LookupTableDynamic_1;
	CH__SYNCM();
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0001_0000.LookupTableDynamic_In1_1 = LookupTableDynamic_In1_1;
	CH__SYNCM();
...
/* Block: LookupTableDynamic_LookupTableDynamic */
...
{  /* omit input channel bit vector */
  ...
  } LookupTableDynamic_P = {
  };
  real_T LookupTableDynamic_Constant1_1[3];
  real_T LookupTableDynamic_Constant_1[3];
  real_T LookupTableDynamic_In1_1;
  real_T LookupTableDynamic_LookupTableDynamic_1;
...
}
{
  ...
  while (1) {
	...
	LookupTableDynamic_In1_1 = CH_0000_0004.LookupTableDynamic_In1_1;
	CH__SYNCM();
...

{
  ...
  LookUp_real_T_real_T( &(LookupTableDynamic_LookupTableDynamic_1),
	...
	CH_0004_0100.LookupTableDynamic_LookupTableDynamic_1 = LookupTableDynamic_LookupTableDynamic_1;
	CH__SYNCM();
