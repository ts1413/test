...
#include "testout-LookupTablenD_res.c"
#include "testout-LookupTablenD.h"
...
/* From: t0
   To: LookupTablenD_n_DLookupTable */
typedef struct {
  int flag__0000_0003;
  real_T LookupTablenD_In1_1;
  real_T LookupTablenD_In2_1;
} TYPE_0000_0003;
TYPE_0000_0003 CH_0000_0003;

/* From: LookupTablenD_In1
   To: t0 */
typedef struct {
...
/* From: LookupTablenD_n_DLookupTable
   To: extout */
typedef struct {
  int flag__0003_0100;
  real_T LookupTablenD_n_DLookupTable_1;
} TYPE_0003_0100;
...
}
{
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: LookupTablenD_In1 */
      if (CH__BITCHECK(IN_0000,0) == 0 && CH_IO0001_0000.flag__IO0001_0000 == 1) {
	LookupTablenD_In1_1 = CH_IO0001_0000.LookupTablenD_In1_1;
	CH__SYNCM();
	...
	CH__BITSET(IN_0000,0);
      ...
      /* input: LookupTablenD_In2 */
      if (CH__BITCHECK(IN_0000,1) == 0 && CH_IO0002_0000.flag__IO0002_0000 == 1) {
	LookupTablenD_In2_1 = CH_IO0002_0000.LookupTablenD_In2_1;
	CH__SYNCM();
    ...
    /* wait output channel */
    while (1) {
      /* output: LookupTablenD_n_DLookupTable */
      if (CH_0000_0003.flag__0000_0003 == 0) {
	CH_0000_0003.LookupTablenD_In1_1 = LookupTablenD_In1_1;
	CH_0000_0003.LookupTablenD_In2_1 = LookupTablenD_In2_1;
	CH__SYNCM();
...
{  /* omit input channel bit vector */
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: LookupTablenD_n_DLookupTable */
      if (CH_0003_0100.flag__0003_0100 == 1) {
	LookupTablenD_n_DLookupTable_1 = CH_0003_0100.LookupTablenD_n_DLookupTable_1;
	CH__SYNCM();
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0001_0000.LookupTablenD_In1_1 = LookupTablenD_In1_1;
	CH__SYNCM();
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0002_0000.LookupTablenD_In2_1 = LookupTablenD_In2_1;
	CH__SYNCM();
...
/* Block: LookupTablenD_n_DLookupTable */
...
{  /* omit input channel bit vector */
  ...
  /* params */
  struct {
    real_T n_DLookupTable_tableData[9];
    real_T n_DLookupTable_bp01Data[3];
    real_T n_DLookupTable_bp02Data[3];
    uint32_T n_DLookupTable_maxIndex[2];
  } LookupTablenD_P = {
  };
  real_T LookupTablenD_In1_1;
  real_T LookupTablenD_In2_1;
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	LookupTablenD_In1_1 = CH_0000_0003.LookupTablenD_In1_1;
	LookupTablenD_In2_1 = CH_0000_0003.LookupTablenD_In2_1;
	CH__SYNCM();
        ...
        {
{
  ...
  LookupTablenD_n_DLookupTable_1 = look2_binlxpw(LookupTablenD_In1_1,
	...
	CH_0003_0100.LookupTablenD_n_DLookupTable_1 = LookupTablenD_n_DLookupTable_1;
	CH__SYNCM();
