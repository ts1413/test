...
#include "testout-LookupTable1D1_res.c"
#include "testout-LookupTable1D1.h"
...
/* From: t0
   To: LookupTable1D1_1_DLookupTable */
typedef struct {
  int flag__0000_0002;
  real_T LookupTable1D1_In1_1;
} TYPE_0000_0002;
TYPE_0000_0002 CH_0000_0002;

/* From: LookupTable1D1_In1
   To: t0 */
typedef struct {
...
/* From: LookupTable1D1_1_DLookupTable
   To: extout */
typedef struct {
  int flag__0002_0100;
  real_T LookupTable1D1_1_DLookupTable_1;
} TYPE_0002_0100;
  ...
  /* initialize task context */
{
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: LookupTable1D1_In1 */
      if (CH_IO0001_0000.flag__IO0001_0000 == 1) {
	LookupTable1D1_In1_1 = CH_IO0001_0000.LookupTable1D1_In1_1;
	CH__SYNCM();
    ...
    /* wait output channel */
    while (1) {
      /* output: LookupTable1D1_1_DLookupTable */
      if (CH_0000_0002.flag__0000_0002 == 0) {
	CH_0000_0002.LookupTable1D1_In1_1 = LookupTable1D1_In1_1;
	CH__SYNCM();
...
{  /* omit input channel bit vector */
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: LookupTable1D1_1_DLookupTable */
      if (CH_0002_0100.flag__0002_0100 == 1) {
	LookupTable1D1_1_DLookupTable_1 = CH_0002_0100.LookupTable1D1_1_DLookupTable_1;
	CH__SYNCM();
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0001_0000.LookupTable1D1_In1_1 = LookupTable1D1_In1_1;
	CH__SYNCM();
...
/* Block: LookupTable1D1_1_DLookupTable */
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	LookupTable1D1_In1_1 = CH_0000_0002.LookupTable1D1_In1_1;
	CH__SYNCM();
        ...
        {
{
  ...
  LookupTable1D1_1_DLookupTable_1 = look1_binlxpw(LookupTable1D1_In1_1,
	...
	CH_0002_0100.LookupTable1D1_1_DLookupTable_1 = LookupTable1D1_1_DLookupTable_1;
	CH__SYNCM();
