...
#include "testout-Gain1_res.c"
#include "testout-Gain1.h"
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	Gain1_In1_1 = CH_IO0001_0000.Gain1_In1_1;
	CH__SYNCM();
	...
	CH_0000_0002.Gain1_In1_1 = Gain1_In1_1;
	CH__SYNCM();
...
{  /* omit input channel bit vector */
  ...
  while (1) {
	...
	Gain1_Gain_1 = CH_0002_0100.Gain1_Gain_1;
	CH__SYNCM();
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0001_0000.Gain1_In1_1 = Gain1_In1_1;
	CH__SYNCM();
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	Gain1_In1_1 = CH_0000_0002.Gain1_In1_1;
	CH__SYNCM();
        ...
        {
{
  ...
  Gain1_Gain_1 = Gain1_P.Gain_Gain * Gain1_In1_1;
	...
	CH_0002_0100.Gain1_Gain_1 = Gain1_Gain_1;
	CH__SYNCM();
