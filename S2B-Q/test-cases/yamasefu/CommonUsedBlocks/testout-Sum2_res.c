...
/* IN_0005 */
pthread_mutex_t mutex__IN_0005 = PTHREAD_MUTEX_INITIALIZER;
pthread_cond_t cond__IN_0005 = PTHREAD_COND_INITIALIZER;
int flag__IN_0005 = 0;
...
/* OUT_0005 */
pthread_mutex_t mutex__OUT_0005 = PTHREAD_MUTEX_INITIALIZER;
pthread_cond_t cond__OUT_0005 = PTHREAD_COND_INITIALIZER;
int flag__OUT_0005 = 0;
...
/* OUT_IO0003 */
pthread_mutex_t mutex__OUT_IO0003 = PTHREAD_MUTEX_INITIALIZER;
pthread_cond_t cond__OUT_IO0003 = PTHREAD_COND_INITIALIZER;
int flag__OUT_IO0003 = 0;

/* OUT_IO0004 */
pthread_mutex_t mutex__OUT_IO0004 = PTHREAD_MUTEX_INITIALIZER;
pthread_cond_t cond__OUT_IO0004 = PTHREAD_COND_INITIALIZER;
int flag__OUT_IO0004 = 0;

void mcos_lcore_task_0000(uint32_t stacd, uintptr_t exinf);
void mcos_lcore_task_0005(uint32_t stacd, uintptr_t exinf);
...
void mcos_lcore_task_IO0003(uint32_t stacd, uintptr_t exinf);
void mcos_lcore_task_IO0004(uint32_t stacd, uintptr_t exinf);
...
static void *f__mcos_lcore_task_0005 (void *arg)
{
  if (PTHREAD_DEBUG) {
    fputs ("start mcos_lcore_task_0005\n", stdout);
    fflush (stdout);
  }
  mcos_lcore_task_0005 (0, (uintptr_t)arg);
  return NULL;
}
...
static void *f__mcos_lcore_task_IO0003 (void *arg)
{
  if (PTHREAD_DEBUG) {
    fputs ("start mcos_lcore_task_IO0003\n", stdout);
    fflush (stdout);
  }
  mcos_lcore_task_IO0003 (0, (uintptr_t)arg);
  return NULL;
}

static void *f__mcos_lcore_task_IO0004 (void *arg)
{
  if (PTHREAD_DEBUG) {
    fputs ("start mcos_lcore_task_IO0004\n", stdout);
    fflush (stdout);
  }
  mcos_lcore_task_IO0004 (0, (uintptr_t)arg);
  return NULL;
}
