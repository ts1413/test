...
#include "testout-Gain2_res.c"
#include "testout-Gain2.h"
...
/* From: Gain2_VectorConcatenate
   To: Gain2_Gain */
typedef struct {
  int flag__0003_0002;
  real_T Gain2_VectorConcatenate_1[2];
} TYPE_0003_0002;
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	Gain2_In1_1 = CH_IO0001_0000.Gain2_In1_1;
	CH__SYNCM();
    ...
    /* wait output channel */
    while (1) {
      /* output: Gain2_VectorConcatenate */
      if (CH_0000_0003.flag__0000_0003 == 0) {
	CH_0000_0003.Gain2_In1_1 = Gain2_In1_1;
	CH__SYNCM();
...
void mcos_lcore_task_0100(uint32_t stacd, uintptr_t extinfo)
{
  ...
  while (1) {
	...
	Gain2_Gain_1 = CH_0002_0100.Gain2_Gain_1;
	CH__SYNCM();
...
void mcos_lcore_task_IO0001(uint32_t stacd, uintptr_t extinfo)
{
  ...
  while (1) {
	...
	CH_IO0001_0000.Gain2_In1_1 = Gain2_In1_1;
	CH__SYNCM();
  ...
  /* initialize task context */
{
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Gain2_VectorConcatenate */
      if (CH_0003_0002.flag__0003_0002 == 1) {
	memcpy(Gain2_VectorConcatenate_1,
	  CH_0003_0002.Gain2_VectorConcatenate_1,
	  sizeof Gain2_VectorConcatenate_1);
	CH__SYNCM();
        ...
        {
{
  ...
  Gain2_Gain_1 = tmp;
	...
	CH_0002_0100.Gain2_Gain_1 = Gain2_Gain_1;
	CH__SYNCM();
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	Gain2_In1_1 = CH_0000_0003.Gain2_In1_1;
	CH__SYNCM();
...

{
  ...
  Gain2_VectorConcatenate_1[1] = Gain2_In1_1;
	...
	memcpy(CH_0003_0002.Gain2_VectorConcatenate_1,
	  Gain2_VectorConcatenate_1,
	  sizeof Gain2_VectorConcatenate_1);
	CH__SYNCM();
