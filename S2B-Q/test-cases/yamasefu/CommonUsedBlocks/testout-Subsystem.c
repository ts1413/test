...
#include "testout-Subsystem_res.c"
#include "testout-Subsystem.h"
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	Subsystem_In1_1 = CH_IO0001_0000.Subsystem_In1_1;
	CH__SYNCM();
	...
	CH_0000_0100.Subsystem_In1_1 = Subsystem_In1_1;
	CH__SYNCM();
...
{  /* omit input channel bit vector */
  ...
  while (1) {
	...
	Subsystem_In1_1 = CH_0000_0100.Subsystem_In1_1;
	CH__SYNCM();
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0001_0000.Subsystem_In1_1 = Subsystem_In1_1;
	CH__SYNCM();
