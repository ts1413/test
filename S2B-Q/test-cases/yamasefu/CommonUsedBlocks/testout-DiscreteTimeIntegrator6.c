...
#include <string.h>
#include "rtwtypes.h"
#include "DiscreteTimeIntegrator6_types.h"
#include "rtGetInf.h"
#include "rt_nonfinite.h"
#include "DiscreteTimeIntegrator6_private.h"

#include "testout-DiscreteTimeIntegrator6_res.c"
#include "testout-DiscreteTimeIntegrator6.h"
...
/* From: t0
   To: DiscreteTimeIntegrator6_Discrete_TimeIntegrator */
typedef struct {
  int flag__0000_0004;
  real_T DiscreteTimeIntegrator6_In1_1;
  real_T DiscreteTimeIntegrator6_In2_1;
  real_T DiscreteTimeIntegrator6_In3_1;
} TYPE_0000_0004;
TYPE_0000_0004 CH_0000_0004;

/* From: DiscreteTimeIntegrator6_In1
   To: t0 */
typedef struct {
...
/* From: DiscreteTimeIntegrator6_In2
   To: t0 */
typedef struct {
...
/* From: DiscreteTimeIntegrator6_In3
   To: t0 */
typedef struct {
...
/* From: DiscreteTimeIntegrator6_Discrete_TimeIntegrator
   To: extout */
typedef struct {
  int flag__0004_0100;
  real_T DiscreteTimeIntegrator6_Discrete_TimeIntegrator_1;
  real_T DiscreteTimeIntegrator6_Discrete_TimeIntegrator_2;
} TYPE_0004_0100;
...
{
  DiscreteTimeIntegrator6_In1_1 = 0.0;
}
{
  DiscreteTimeIntegrator6_In2_1 = 0.0;
}
{
  DiscreteTimeIntegrator6_In3_1 = 0.0;
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: DiscreteTimeIntegrator6_In1 */
      if (CH__BITCHECK(IN_0000,0) == 0 && CH_IO0001_0000.flag__IO0001_0000 == 1) {
	DiscreteTimeIntegrator6_In1_1 = CH_IO0001_0000.DiscreteTimeIntegrator6_In1_1;
	CH__SYNCM();
	...
	CH__BITSET(IN_0000,0);
      ...
      /* input: DiscreteTimeIntegrator6_In2 */
      if (CH__BITCHECK(IN_0000,1) == 0 && CH_IO0002_0000.flag__IO0002_0000 == 1) {
	DiscreteTimeIntegrator6_In2_1 = CH_IO0002_0000.DiscreteTimeIntegrator6_In2_1;
	CH__SYNCM();
	...
	CH__BITSET(IN_0000,1);
      ...
      /* input: DiscreteTimeIntegrator6_In3 */
      if (CH__BITCHECK(IN_0000,2) == 0 && CH_IO0003_0000.flag__IO0003_0000 == 1) {
	DiscreteTimeIntegrator6_In3_1 = CH_IO0003_0000.DiscreteTimeIntegrator6_In3_1;
	CH__SYNCM();
    ...
    /* wait output channel */
    while (1) {
      /* output: DiscreteTimeIntegrator6_Discrete_TimeIntegrator */
      if (CH_0000_0004.flag__0000_0004 == 0) {
	CH_0000_0004.DiscreteTimeIntegrator6_In1_1 = DiscreteTimeIntegrator6_In1_1;
	CH_0000_0004.DiscreteTimeIntegrator6_In2_1 = DiscreteTimeIntegrator6_In2_1;
	CH_0000_0004.DiscreteTimeIntegrator6_In3_1 = DiscreteTimeIntegrator6_In3_1;
	CH__SYNCM();
...
{  /* omit input channel bit vector */
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: DiscreteTimeIntegrator6_Discrete_TimeIntegrator */
      if (CH_0004_0100.flag__0004_0100 == 1) {
	DiscreteTimeIntegrator6_Discrete_TimeIntegrator_1 = CH_0004_0100.DiscreteTimeIntegrator6_Discrete_TimeIntegrator_1;
	DiscreteTimeIntegrator6_Discrete_TimeIntegrator_2 = CH_0004_0100.DiscreteTimeIntegrator6_Discrete_TimeIntegrator_2;
	CH__SYNCM();
...
/* Block: DiscreteTimeIntegrator6_In1 */
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0001_0000.DiscreteTimeIntegrator6_In1_1 = DiscreteTimeIntegrator6_In1_1;
	CH__SYNCM();
...
/* Block: DiscreteTimeIntegrator6_In2 */
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0002_0000.DiscreteTimeIntegrator6_In2_1 = DiscreteTimeIntegrator6_In2_1;
	CH__SYNCM();
...
/* Block: DiscreteTimeIntegrator6_In3 */
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0003_0000.DiscreteTimeIntegrator6_In3_1 = DiscreteTimeIntegrator6_In3_1;
	CH__SYNCM();
...
/* Block: DiscreteTimeIntegrator6_Discrete_TimeIntegrator */
...
{  /* omit input channel bit vector */
  ...
  RT_MODEL_DiscreteTimeIntegrat_T DiscreteTimeIntegrator6_M_;
  RT_MODEL_DiscreteTimeIntegrat_T * const DiscreteTimeIntegrator6_M = &DiscreteTimeIntegrator6_M_;
  ...
  (void) memset((void *)DiscreteTimeIntegrator6_M, 0,
                sizeof(RT_MODEL_DiscreteTimeIntegrat_T));

  /* initialize state structure */
  memset(&DiscreteTimeIntegrator6_DW, 0, sizeof DiscreteTimeIntegrator6_DW);

  /* initialize states */
{
  /* InitializeConditions for DiscreteIntegrator: '<Root>/Discrete_TimeIntegrator' */
  DiscreteTimeIntegrator6_DW.Discrete_TimeIntegrator_IC_LOAD = 1U;
  DiscreteTimeIntegrator6_DW.Discrete_TimeIntegrator_PrevRes = 2;
}

  /* initialize task context */
{
  DiscreteTimeIntegrator6_P.Discrete_TimeIntegrator_UpperSa = rtInf;
  DiscreteTimeIntegrator6_P.Discrete_TimeIntegrator_LowerSa = rtMinusInf;

  DiscreteTimeIntegrator6_Discrete_TimeIntegrator_1 = 0.0;
  ...
  while (1) {
	...
	DiscreteTimeIntegrator6_In1_1 = CH_0000_0004.DiscreteTimeIntegrator6_In1_1;
	DiscreteTimeIntegrator6_In2_1 = CH_0000_0004.DiscreteTimeIntegrator6_In2_1;
	DiscreteTimeIntegrator6_In3_1 = CH_0000_0004.DiscreteTimeIntegrator6_In3_1;
	CH__SYNCM();
        ...
        {
{
  ...
  if (DiscreteTimeIntegrator6_M->Timing.TaskCounters.TID[1] == 0) {
	...
	CH_0004_0100.DiscreteTimeIntegrator6_Discrete_TimeIntegrator_1 = DiscreteTimeIntegrator6_Discrete_TimeIntegrator_1;
	CH_0004_0100.DiscreteTimeIntegrator6_Discrete_TimeIntegrator_2 = DiscreteTimeIntegrator6_Discrete_TimeIntegrator_2;
	CH__SYNCM();
    ...
    {
{
  ...
  if (DiscreteTimeIntegrator6_M->Timing.TaskCounters.TID[1] == 0) {
     ...
     *  Inport: '<Root>/In2'
     */
    DiscreteTimeIntegrator6_DW.Discrete_TimeIntegrator_IC_LOAD = 0U;
    DiscreteTimeIntegrator6_DW.Discrete_TimeIntegrator_DSTATE =
      DiscreteTimeIntegrator6_P.Discrete_TimeIntegrator_gainval *
      DiscreteTimeIntegrator6_In1_1 +
      DiscreteTimeIntegrator6_Discrete_TimeIntegrator_1;
    ...
    if (DiscreteTimeIntegrator6_In2_1 > 0.0) {
      DiscreteTimeIntegrator6_DW.Discrete_TimeIntegrator_PrevRes = 1;
    } else if (DiscreteTimeIntegrator6_In2_1 < 0.0) {
      DiscreteTimeIntegrator6_DW.Discrete_TimeIntegrator_PrevRes = -1;
    } else if (DiscreteTimeIntegrator6_In2_1 == 0.0) {
      DiscreteTimeIntegrator6_DW.Discrete_TimeIntegrator_PrevRes = 0;
    } else {
