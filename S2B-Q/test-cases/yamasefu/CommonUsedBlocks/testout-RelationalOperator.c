...
#include <stddef.h>
#include "rtwtypes.h"
#include "RelationalOperator_types.h"
#include "RelationalOperator_private.h"

#include "testout-RelationalOperator_res.c"
#include "testout-RelationalOperator.h"
...
/* From: t0
   To: RelationalOperator_RelationalOperator */
typedef struct {
  int flag__0000_0003;
  real_T RelationalOperator_In1_1;
  real_T RelationalOperator_In2_1;
} TYPE_0000_0003;
TYPE_0000_0003 CH_0000_0003;

/* From: RelationalOperator_In1
   To: t0 */
typedef struct {
...
/* From: RelationalOperator_RelationalOperator
   To: extout */
typedef struct {
  int flag__0003_0100;
  boolean_T RelationalOperator_RelationalOperator_1;
} TYPE_0003_0100;
...
}
{
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: RelationalOperator_In1 */
      if (CH__BITCHECK(IN_0000,0) == 0 && CH_IO0001_0000.flag__IO0001_0000 == 1) {
	RelationalOperator_In1_1 = CH_IO0001_0000.RelationalOperator_In1_1;
	CH__SYNCM();
	...
	CH__BITSET(IN_0000,0);
      ...
      /* input: RelationalOperator_In2 */
      if (CH__BITCHECK(IN_0000,1) == 0 && CH_IO0002_0000.flag__IO0002_0000 == 1) {
	RelationalOperator_In2_1 = CH_IO0002_0000.RelationalOperator_In2_1;
	CH__SYNCM();
    ...
    /* wait output channel */
    while (1) {
      /* output: RelationalOperator_RelationalOperator */
      if (CH_0000_0003.flag__0000_0003 == 0) {
	CH_0000_0003.RelationalOperator_In1_1 = RelationalOperator_In1_1;
	CH_0000_0003.RelationalOperator_In2_1 = RelationalOperator_In2_1;
	CH__SYNCM();
...
{  /* omit input channel bit vector */
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: RelationalOperator_RelationalOperator */
      if (CH_0003_0100.flag__0003_0100 == 1) {
	RelationalOperator_RelationalOperator_1 = CH_0003_0100.RelationalOperator_RelationalOperator_1;
	CH__SYNCM();
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0001_0000.RelationalOperator_In1_1 = RelationalOperator_In1_1;
	CH__SYNCM();
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0002_0000.RelationalOperator_In2_1 = RelationalOperator_In2_1;
	CH__SYNCM();
...
/* Block: RelationalOperator_RelationalOperator */
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	RelationalOperator_In1_1 = CH_0000_0003.RelationalOperator_In1_1;
	RelationalOperator_In2_1 = CH_0000_0003.RelationalOperator_In2_1;
	CH__SYNCM();
        ...
        {
{
  ...
  RelationalOperator_RelationalOperator_1 = (RelationalOperator_In1_1 <=
	...
	CH_0003_0100.RelationalOperator_RelationalOperator_1 = RelationalOperator_RelationalOperator_1;
	CH__SYNCM();
