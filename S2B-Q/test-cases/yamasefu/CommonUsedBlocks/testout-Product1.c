...
#include "testout-Product1_res.c"
#include "testout-Product1.h"
...
/* From: Product1_Product
   To: extout */
typedef struct {
  int flag__0002_0100;
  real_T Product1_Product_1;
} TYPE_0002_0100;
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	Product1_In1_1 = CH_IO0001_0000.Product1_In1_1;
	CH__SYNCM();
    ...
    /* wait output channel */
    while (1) {
      /* output: Product1_Product */
      if (CH_0000_0002.flag__0000_0002 == 0) {
	CH_0000_0002.Product1_In1_1 = Product1_In1_1;
	CH__SYNCM();
...
{  /* omit input channel bit vector */
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Product1_Product */
      if (CH_0002_0100.flag__0002_0100 == 1) {
	Product1_Product_1 = CH_0002_0100.Product1_Product_1;
	CH__SYNCM();
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0001_0000.Product1_In1_1 = Product1_In1_1;
	CH__SYNCM();
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	Product1_In1_1 = CH_0000_0002.Product1_In1_1;
	CH__SYNCM();
        ...
        {
{
  ...
  Product1_Product_1 = Product1_In1_1 * Product1_In1_1;
	...
	CH_0002_0100.Product1_Product_1 = Product1_Product_1;
	CH__SYNCM();
