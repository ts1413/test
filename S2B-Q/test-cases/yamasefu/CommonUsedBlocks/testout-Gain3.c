...
#include "testout-Gain3_res.c"
#include "testout-Gain3.h"
...
typedef struct {
  int flag__0002_0100;
  real_T Gain3_Gain_1[4];
} TYPE_0002_0100;
TYPE_0002_0100 CH_0002_0100;

/* From: Gain3_VectorConcatenate
   To: Gain3_Gain */
typedef struct {
  int flag__0003_0002;
  real_T Gain3_VectorConcatenate_1[2];
} TYPE_0003_0002;
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	Gain3_In1_1 = CH_IO0001_0000.Gain3_In1_1;
	CH__SYNCM();
    ...
    /* wait output channel */
    while (1) {
      /* output: Gain3_VectorConcatenate */
      if (CH_0000_0003.flag__0000_0003 == 0) {
	CH_0000_0003.Gain3_In1_1 = Gain3_In1_1;
	CH__SYNCM();
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0001_0000.Gain3_In1_1 = Gain3_In1_1;
	CH__SYNCM();
  ...
  /* initialize task context */
{
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Gain3_VectorConcatenate */
      if (CH_0003_0002.flag__0003_0002 == 1) {
	memcpy(Gain3_VectorConcatenate_1,
	  CH_0003_0002.Gain3_VectorConcatenate_1,
	  sizeof Gain3_VectorConcatenate_1);
	CH__SYNCM();
        ...
        {
{
  ...
  Gain3_Gain_1[3] = Gain3_VectorConcatenate_1[1] * Gain3_P.Gain_Gain[1];
	...
	memcpy(CH_0002_0100.Gain3_Gain_1,
	  Gain3_Gain_1,
	  sizeof Gain3_Gain_1);
	CH__SYNCM();
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	Gain3_In1_1 = CH_0000_0003.Gain3_In1_1;
	CH__SYNCM();
...

{
  ...
  Gain3_VectorConcatenate_1[1] = Gain3_In1_1;
	...
	memcpy(CH_0003_0002.Gain3_VectorConcatenate_1,
	  Gain3_VectorConcatenate_1,
	  sizeof Gain3_VectorConcatenate_1);
	CH__SYNCM();
