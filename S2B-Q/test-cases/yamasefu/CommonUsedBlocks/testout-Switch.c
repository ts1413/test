...
#include "testout-Switch_res.c"
#include "testout-Switch.h"
...
}
{
  ...
  while (1) {
	...
	Switch_In1_1 = CH_IO0001_0000.Switch_In1_1;
	CH__SYNCM();
	...
	Switch_In2_1 = CH_IO0002_0000.Switch_In2_1;
	CH__SYNCM();
	...
	Switch_In3_1 = CH_IO0003_0000.Switch_In3_1;
	CH__SYNCM();
    ...
    /* wait output channel */
    while (1) {
      /* output: Switch_Switch */
      if (CH_0000_0004.flag__0000_0004 == 0) {
	CH_0000_0004.Switch_In1_1 = Switch_In1_1;
	CH_0000_0004.Switch_In2_1 = Switch_In2_1;
	CH_0000_0004.Switch_In3_1 = Switch_In3_1;
	CH__SYNCM();
...
{  /* omit input channel bit vector */
  ...
  while (1) {
	...
	Switch_Switch_1 = CH_0004_0100.Switch_Switch_1;
	CH__SYNCM();
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0001_0000.Switch_In1_1 = Switch_In1_1;
	CH__SYNCM();
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0002_0000.Switch_In2_1 = Switch_In2_1;
	CH__SYNCM();
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0003_0000.Switch_In3_1 = Switch_In3_1;
	CH__SYNCM();
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	Switch_In1_1 = CH_0000_0004.Switch_In1_1;
	Switch_In2_1 = CH_0000_0004.Switch_In2_1;
	Switch_In3_1 = CH_0000_0004.Switch_In3_1;
	CH__SYNCM();
        ...
        {
{
  ...
  /* End of Switch: '<Root>/Switch' */
	...
	CH_0004_0100.Switch_Switch_1 = Switch_Switch_1;
	CH__SYNCM();
