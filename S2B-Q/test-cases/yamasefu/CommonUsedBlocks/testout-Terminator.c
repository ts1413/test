...
#include "testout-Terminator_res.c"
#include "testout-Terminator.h"
  ...
  /* initialize task context */
{
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Terminator_In1 */
      if (CH_IO0001_0000.flag__IO0001_0000 == 1) {
	Terminator_In1_1 = CH_IO0001_0000.Terminator_In1_1;
	CH__SYNCM();
	...
	CH_0000_0100.Terminator_In1_1 = Terminator_In1_1;
	CH__SYNCM();
...
{  /* omit input channel bit vector */
  ...
  while (1) {
	...
	Terminator_In1_1 = CH_0000_0100.Terminator_In1_1;
	CH__SYNCM();
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0001_0000.Terminator_In1_1 = Terminator_In1_1;
	CH__SYNCM();
