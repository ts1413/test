...
#include "testout-DiscreteTimeIntegrator1_res.c"
#include "testout-DiscreteTimeIntegrator1.h"
...
typedef struct {
  int flag__0000_0100;
  real_T DiscreteTimeIntegrator1_In1_1;
  real_T DiscreteTimeIntegrator1_In3_1;
} TYPE_0000_0100;
TYPE_0000_0100 CH_0000_0100;

/* From: DiscreteTimeIntegrator1_In1
   To: t0 */
typedef struct {
...
/* From: DiscreteTimeIntegrator1_In3
   To: t0 */
typedef struct {
...
}
{
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: DiscreteTimeIntegrator1_In1 */
      if (CH__BITCHECK(IN_0000,0) == 0 && CH_IO0001_0000.flag__IO0001_0000 == 1) {
	DiscreteTimeIntegrator1_In1_1 = CH_IO0001_0000.DiscreteTimeIntegrator1_In1_1;
	CH__SYNCM();
	...
	CH__BITSET(IN_0000,0);
      ...
      /* input: DiscreteTimeIntegrator1_In3 */
      if (CH__BITCHECK(IN_0000,1) == 0 && CH_IO0002_0000.flag__IO0002_0000 == 1) {
	DiscreteTimeIntegrator1_In3_1 = CH_IO0002_0000.DiscreteTimeIntegrator1_In3_1;
	CH__SYNCM();
    ...
    while (1) {
      /* output: extout */
      if (CH_0000_0100.flag__0000_0100 == 0) {
	CH_0000_0100.DiscreteTimeIntegrator1_In1_1 = DiscreteTimeIntegrator1_In1_1;
	CH_0000_0100.DiscreteTimeIntegrator1_In3_1 = DiscreteTimeIntegrator1_In3_1;
	CH__SYNCM();
...
{  /* omit input channel bit vector */
  ...
  RT_MODEL_DiscreteTimeIntegrat_T * const DiscreteTimeIntegrator1_M = &DiscreteTimeIntegrator1_M_;

  /* states */
  struct {
    real_T Discrete_TimeIntegrator_DSTATE;
    uint8_T Discrete_TimeIntegrator_IC_LOAD;
  } DiscreteTimeIntegrator1_DW;
  ...
  } DiscreteTimeIntegrator1_P = {
  };
  real_T DiscreteTimeIntegrator1_Discrete_TimeIntegrator_1;
  real_T DiscreteTimeIntegrator1_In1_1;
  real_T DiscreteTimeIntegrator1_In3_1;
  ...
  memset(&DiscreteTimeIntegrator1_DW, 0, sizeof DiscreteTimeIntegrator1_DW);
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	DiscreteTimeIntegrator1_In1_1 = CH_0000_0100.DiscreteTimeIntegrator1_In1_1;
	DiscreteTimeIntegrator1_In3_1 = CH_0000_0100.DiscreteTimeIntegrator1_In3_1;
	CH__SYNCM();
...
#ifdef TASK_UPDATE_IN_0100_COMPLETED
    TASK_UPDATE_IN_0100_COMPLETED();
#endif
...
#ifdef TASK_UPDATE_0100_COMPLETED
    TASK_UPDATE_0100_COMPLETED();
#endif
  }
}
...
/* Block: DiscreteTimeIntegrator1_In1 */
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0001_0000.DiscreteTimeIntegrator1_In1_1 = DiscreteTimeIntegrator1_In1_1;
	CH__SYNCM();
...
/* Block: DiscreteTimeIntegrator1_In3 */
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0002_0000.DiscreteTimeIntegrator1_In3_1 = DiscreteTimeIntegrator1_In3_1;
	CH__SYNCM();
