...
#include "testout-VectorConcatenate_res.c"
#include "testout-VectorConcatenate.h"
...
/* From: t0
   To: VectorConcatenate_VectorConcatenate */
typedef struct {
  int flag__0000_0002;
  real_T VectorConcatenate_In1_1;
} TYPE_0000_0002;
TYPE_0000_0002 CH_0000_0002;

/* From: VectorConcatenate_In1
   To: t0 */
typedef struct {
...
/* From: VectorConcatenate_VectorConcatenate
   To: extout */
typedef struct {
  int flag__0002_0100;
  real_T VectorConcatenate_VectorConcatenate_1[2];
} TYPE_0002_0100;
  ...
  /* initialize task context */
{
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: VectorConcatenate_In1 */
      if (CH_IO0001_0000.flag__IO0001_0000 == 1) {
	VectorConcatenate_In1_1 = CH_IO0001_0000.VectorConcatenate_In1_1;
	CH__SYNCM();
    ...
    /* wait output channel */
    while (1) {
      /* output: VectorConcatenate_VectorConcatenate */
      if (CH_0000_0002.flag__0000_0002 == 0) {
	CH_0000_0002.VectorConcatenate_In1_1 = VectorConcatenate_In1_1;
	CH__SYNCM();
...
{  /* omit input channel bit vector */
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: VectorConcatenate_VectorConcatenate */
      if (CH_0002_0100.flag__0002_0100 == 1) {
	memcpy(VectorConcatenate_VectorConcatenate_1,
	  CH_0002_0100.VectorConcatenate_VectorConcatenate_1,
	  sizeof VectorConcatenate_VectorConcatenate_1);
	CH__SYNCM();
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0001_0000.VectorConcatenate_In1_1 = VectorConcatenate_In1_1;
	CH__SYNCM();
...
/* Block: VectorConcatenate_VectorConcatenate */
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	VectorConcatenate_In1_1 = CH_0000_0002.VectorConcatenate_In1_1;
	CH__SYNCM();
...

{
  ...
  VectorConcatenate_VectorConcatenate_1[1] = VectorConcatenate_In1_1;
	...
	memcpy(CH_0002_0100.VectorConcatenate_VectorConcatenate_1,
	  VectorConcatenate_VectorConcatenate_1,
	  sizeof VectorConcatenate_VectorConcatenate_1);
	CH__SYNCM();
