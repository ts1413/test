...
#include <string.h>
#include "rtwtypes.h"
#include "DiscreteTimeIntegrator2_types.h"
#include "rtGetInf.h"
#include "rt_nonfinite.h"
#include "DiscreteTimeIntegrator2_private.h"

#include "testout-DiscreteTimeIntegrator2_res.c"
#include "testout-DiscreteTimeIntegrator2.h"
...
/* From: t0
   To: DiscreteTimeIntegrator2_Discrete_TimeIntegrator */
typedef struct {
  int flag__0000_0004;
  real_T DiscreteTimeIntegrator2_In1_1;
  real_T DiscreteTimeIntegrator2_In2_1;
  real_T DiscreteTimeIntegrator2_In3_1;
} TYPE_0000_0004;
TYPE_0000_0004 CH_0000_0004;

/* From: DiscreteTimeIntegrator2_In1
   To: t0 */
typedef struct {
...
/* From: DiscreteTimeIntegrator2_In2
   To: t0 */
typedef struct {
...
/* From: DiscreteTimeIntegrator2_In3
   To: t0 */
typedef struct {
...
/* From: DiscreteTimeIntegrator2_Discrete_TimeIntegrator
   To: extout */
typedef struct {
  int flag__0004_0100;
...
{
  DiscreteTimeIntegrator2_In1_1 = 0.0;
}
{
  DiscreteTimeIntegrator2_In2_1 = 0.0;
}
{
  DiscreteTimeIntegrator2_In3_1 = 0.0;
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: DiscreteTimeIntegrator2_In1 */
      if (CH__BITCHECK(IN_0000,0) == 0 && CH_IO0001_0000.flag__IO0001_0000 == 1) {
	DiscreteTimeIntegrator2_In1_1 = CH_IO0001_0000.DiscreteTimeIntegrator2_In1_1;
	CH__SYNCM();
	...
	CH__BITSET(IN_0000,0);
      ...
      /* input: DiscreteTimeIntegrator2_In2 */
      if (CH__BITCHECK(IN_0000,1) == 0 && CH_IO0002_0000.flag__IO0002_0000 == 1) {
	DiscreteTimeIntegrator2_In2_1 = CH_IO0002_0000.DiscreteTimeIntegrator2_In2_1;
	CH__SYNCM();
	...
	CH__BITSET(IN_0000,1);
      ...
      /* input: DiscreteTimeIntegrator2_In3 */
      if (CH__BITCHECK(IN_0000,2) == 0 && CH_IO0003_0000.flag__IO0003_0000 == 1) {
	DiscreteTimeIntegrator2_In3_1 = CH_IO0003_0000.DiscreteTimeIntegrator2_In3_1;
	CH__SYNCM();
    ...
    /* wait output channel */
    while (1) {
      /* output: DiscreteTimeIntegrator2_Discrete_TimeIntegrator */
      if (CH_0000_0004.flag__0000_0004 == 0) {
	CH_0000_0004.DiscreteTimeIntegrator2_In1_1 = DiscreteTimeIntegrator2_In1_1;
	CH_0000_0004.DiscreteTimeIntegrator2_In2_1 = DiscreteTimeIntegrator2_In2_1;
	CH_0000_0004.DiscreteTimeIntegrator2_In3_1 = DiscreteTimeIntegrator2_In3_1;
	CH__SYNCM();
...
/* Block: DiscreteTimeIntegrator2_In1 */
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0001_0000.DiscreteTimeIntegrator2_In1_1 = DiscreteTimeIntegrator2_In1_1;
	CH__SYNCM();
...
/* Block: DiscreteTimeIntegrator2_In2 */
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0002_0000.DiscreteTimeIntegrator2_In2_1 = DiscreteTimeIntegrator2_In2_1;
	CH__SYNCM();
...
/* Block: DiscreteTimeIntegrator2_Discrete_TimeIntegrator */
...
{  /* omit input channel bit vector */
  ...
  RT_MODEL_DiscreteTimeIntegrat_T DiscreteTimeIntegrator2_M_;
  RT_MODEL_DiscreteTimeIntegrat_T * const DiscreteTimeIntegrator2_M = &DiscreteTimeIntegrator2_M_;
  ...
  (void) memset((void *)DiscreteTimeIntegrator2_M, 0,
                sizeof(RT_MODEL_DiscreteTimeIntegrat_T));

  /* initialize state structure */
  memset(&DiscreteTimeIntegrator2_DW, 0, sizeof DiscreteTimeIntegrator2_DW);

  /* initialize states */
{
  /* InitializeConditions for DiscreteIntegrator: '<Root>/Discrete_TimeIntegrator' */
  DiscreteTimeIntegrator2_DW.Discrete_TimeIntegrator_IC_LOAD = 1U;
  DiscreteTimeIntegrator2_DW.Discrete_TimeIntegrator_PrevRes = 2;
}

  /* initialize task context */
{
  DiscreteTimeIntegrator2_P.Discrete_TimeIntegrator_UpperSa = rtInf;
  DiscreteTimeIntegrator2_P.Discrete_TimeIntegrator_LowerSa = rtMinusInf;

  DiscreteTimeIntegrator2_Discrete_TimeIntegrator_1 = 0.0;
  ...
  while (1) {
	...
	DiscreteTimeIntegrator2_In1_1 = CH_0000_0004.DiscreteTimeIntegrator2_In1_1;
	DiscreteTimeIntegrator2_In2_1 = CH_0000_0004.DiscreteTimeIntegrator2_In2_1;
	DiscreteTimeIntegrator2_In3_1 = CH_0000_0004.DiscreteTimeIntegrator2_In3_1;
	CH__SYNCM();
        ...
        {
{
  ...
  if (DiscreteTimeIntegrator2_M->Timing.TaskCounters.TID[1] == 0) {
	...
	CH_0004_0100.DiscreteTimeIntegrator2_Discrete_TimeIntegrator_1 = DiscreteTimeIntegrator2_Discrete_TimeIntegrator_1;
	CH_0004_0100.DiscreteTimeIntegrator2_Discrete_TimeIntegrator_2 = DiscreteTimeIntegrator2_Discrete_TimeIntegrator_2;
	CH__SYNCM();
    ...
    {
{
  ...
  if (DiscreteTimeIntegrator2_M->Timing.TaskCounters.TID[1] == 0) {
     ...
     *  Inport: '<Root>/In2'
     */
    DiscreteTimeIntegrator2_DW.Discrete_TimeIntegrator_IC_LOAD = 0U;
    DiscreteTimeIntegrator2_DW.Discrete_TimeIntegrator_DSTATE =
      DiscreteTimeIntegrator2_Discrete_TimeIntegrator_1;
    if (DiscreteTimeIntegrator2_In2_1 > 0.0) {
      DiscreteTimeIntegrator2_DW.Discrete_TimeIntegrator_PrevRes = 1;
    } else if (DiscreteTimeIntegrator2_In2_1 < 0.0) {
      DiscreteTimeIntegrator2_DW.Discrete_TimeIntegrator_PrevRes = -1;
    } else if (DiscreteTimeIntegrator2_In2_1 == 0.0) {
      DiscreteTimeIntegrator2_DW.Discrete_TimeIntegrator_PrevRes = 0;
    } else {
