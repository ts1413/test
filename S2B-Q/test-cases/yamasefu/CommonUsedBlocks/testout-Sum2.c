...
#include "testout-Sum2_res.c"
#include "testout-Sum2.h"
...
}
{
  ...
  while (1) {
	...
	Sum2_In1_1 = CH_IO0001_0000.Sum2_In1_1;
	CH__SYNCM();
	...
	Sum2_In2_1 = CH_IO0002_0000.Sum2_In2_1;
	CH__SYNCM();
	...
	Sum2_In3_1 = CH_IO0003_0000.Sum2_In3_1;
	CH__SYNCM();
	...
	Sum2_In4_1 = CH_IO0004_0000.Sum2_In4_1;
	CH__SYNCM();
	...
	CH_0000_0005.Sum2_In1_1 = Sum2_In1_1;
	CH_0000_0005.Sum2_In2_1 = Sum2_In2_1;
	CH_0000_0005.Sum2_In3_1 = Sum2_In3_1;
	CH_0000_0005.Sum2_In4_1 = Sum2_In4_1;
	CH__SYNCM();
...
{  /* omit input channel bit vector */
  ...
  while (1) {
	...
	Sum2_Sum_1 = CH_0005_0100.Sum2_Sum_1;
	CH__SYNCM();
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0001_0000.Sum2_In1_1 = Sum2_In1_1;
	CH__SYNCM();
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0002_0000.Sum2_In2_1 = Sum2_In2_1;
	CH__SYNCM();
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0003_0000.Sum2_In3_1 = Sum2_In3_1;
	CH__SYNCM();
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0004_0000.Sum2_In4_1 = Sum2_In4_1;
	CH__SYNCM();
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	Sum2_In1_1 = CH_0000_0005.Sum2_In1_1;
	Sum2_In2_1 = CH_0000_0005.Sum2_In2_1;
	Sum2_In3_1 = CH_0000_0005.Sum2_In3_1;
	Sum2_In4_1 = CH_0000_0005.Sum2_In4_1;
	CH__SYNCM();
        ...
        {
{
  ...
  Sum2_Sum_1 = ((Sum2_In1_1 + Sum2_In2_1) - Sum2_In3_1) - Sum2_In4_1;
	...
	CH_0005_0100.Sum2_Sum_1 = Sum2_Sum_1;
	CH__SYNCM();
