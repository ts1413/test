...
#include "testout-LogicalOperator_res.c"
#include "testout-LogicalOperator.h"
...
/* From: t0
   To: LogicalOperator_LogicalOperator */
typedef struct {
  int flag__0000_0003;
  boolean_T LogicalOperator_In1_1;
  boolean_T LogicalOperator_In2_1;
} TYPE_0000_0003;
TYPE_0000_0003 CH_0000_0003;

/* From: LogicalOperator_In1
   To: t0 */
typedef struct {
...
/* From: LogicalOperator_LogicalOperator
   To: extout */
typedef struct {
  int flag__0003_0100;
  boolean_T LogicalOperator_LogicalOperator_1;
} TYPE_0003_0100;
...
}
{
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: LogicalOperator_In1 */
      if (CH__BITCHECK(IN_0000,0) == 0 && CH_IO0001_0000.flag__IO0001_0000 == 1) {
	LogicalOperator_In1_1 = CH_IO0001_0000.LogicalOperator_In1_1;
	CH__SYNCM();
	...
	CH__BITSET(IN_0000,0);
      ...
      /* input: LogicalOperator_In2 */
      if (CH__BITCHECK(IN_0000,1) == 0 && CH_IO0002_0000.flag__IO0002_0000 == 1) {
	LogicalOperator_In2_1 = CH_IO0002_0000.LogicalOperator_In2_1;
	CH__SYNCM();
    ...
    /* wait output channel */
    while (1) {
      /* output: LogicalOperator_LogicalOperator */
      if (CH_0000_0003.flag__0000_0003 == 0) {
	CH_0000_0003.LogicalOperator_In1_1 = LogicalOperator_In1_1;
	CH_0000_0003.LogicalOperator_In2_1 = LogicalOperator_In2_1;
	CH__SYNCM();
...
{  /* omit input channel bit vector */
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: LogicalOperator_LogicalOperator */
      if (CH_0003_0100.flag__0003_0100 == 1) {
	LogicalOperator_LogicalOperator_1 = CH_0003_0100.LogicalOperator_LogicalOperator_1;
	CH__SYNCM();
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0001_0000.LogicalOperator_In1_1 = LogicalOperator_In1_1;
	CH__SYNCM();
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0002_0000.LogicalOperator_In2_1 = LogicalOperator_In2_1;
	CH__SYNCM();
...
/* Block: LogicalOperator_LogicalOperator */
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	LogicalOperator_In1_1 = CH_0000_0003.LogicalOperator_In1_1;
	LogicalOperator_In2_1 = CH_0000_0003.LogicalOperator_In2_1;
	CH__SYNCM();
        ...
        {
{
  ...
  LogicalOperator_LogicalOperator_1 = (LogicalOperator_In1_1 &&
	...
	CH_0003_0100.LogicalOperator_LogicalOperator_1 = LogicalOperator_LogicalOperator_1;
	CH__SYNCM();
