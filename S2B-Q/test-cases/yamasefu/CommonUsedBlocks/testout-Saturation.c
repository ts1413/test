...
#include "testout-Saturation_res.c"
#include "testout-Saturation.h"
...
/* From: t0
   To: Saturation_Saturation */
typedef struct {
  int flag__0000_0002;
  real_T Saturation_In1_1;
} TYPE_0000_0002;
...
/* From: Saturation_Saturation
   To: extout */
typedef struct {
  int flag__0002_0100;
  real_T Saturation_Saturation_1;
} TYPE_0002_0100;
  ...
  /* initialize task context */
{
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Saturation_In1 */
      if (CH_IO0001_0000.flag__IO0001_0000 == 1) {
	Saturation_In1_1 = CH_IO0001_0000.Saturation_In1_1;
	CH__SYNCM();
    ...
    /* wait output channel */
    while (1) {
      /* output: Saturation_Saturation */
      if (CH_0000_0002.flag__0000_0002 == 0) {
	CH_0000_0002.Saturation_In1_1 = Saturation_In1_1;
	CH__SYNCM();
...
void mcos_lcore_task_0100(uint32_t stacd, uintptr_t extinfo)
{
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Saturation_Saturation */
      if (CH_0002_0100.flag__0002_0100 == 1) {
	Saturation_Saturation_1 = CH_0002_0100.Saturation_Saturation_1;
	CH__SYNCM();
...
void mcos_lcore_task_IO0001(uint32_t stacd, uintptr_t extinfo)
{
  ...
  while (1) {
	...
	CH_IO0001_0000.Saturation_In1_1 = Saturation_In1_1;
	CH__SYNCM();
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	Saturation_In1_1 = CH_0000_0002.Saturation_In1_1;
	CH__SYNCM();
        ...
        {
{
  ...
  /* End of Saturate: '<Root>/Saturation' */
	...
	CH_0002_0100.Saturation_Saturation_1 = Saturation_Saturation_1;
	CH__SYNCM();
