...
#include "testout-Unit_Delay_res.c"
#include "testout-Unit_Delay.h"
  ...
  /* initialize task context */
{
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Unit_Delay_In1 */
      if (CH_IO0001_0000.flag__IO0001_0000 == 1) {
	Unit_Delay_In1_1 = CH_IO0001_0000.Unit_Delay_In1_1;
	CH__SYNCM();
	...
	CH_0000_0100.Unit_Delay_In1_1 = Unit_Delay_In1_1;
	CH__SYNCM();
...
{  /* omit input channel bit vector */
  ...
  real_T Unit_Delay_UnitDelay_1;
  real_T Unit_Delay_In1_1;

  /* initialize state structure */
  memset(&Unit_Delay_DW, 0, sizeof Unit_Delay_DW);
        ...
        {
{
  ...
  Unit_Delay_UnitDelay_1 = Unit_Delay_DW.UnitDelay_DSTATE;
	...
	Unit_Delay_In1_1 = CH_0000_0100.Unit_Delay_In1_1;
	CH__SYNCM();
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0001_0000.Unit_Delay_In1_1 = Unit_Delay_In1_1;
	CH__SYNCM();
