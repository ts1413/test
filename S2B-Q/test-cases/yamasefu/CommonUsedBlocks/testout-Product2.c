...
#include "testout-Product2_res.c"
#include "testout-Product2.h"
...
typedef struct {
  int flag__0000_0004;
  real_T Product2_In1_1;
  real_T Product2_In2_1;
  real_T Product2_In3_1;
} TYPE_0000_0004;
...
/* From: Product2_Product
   To: extout */
typedef struct {
  int flag__0004_0100;
  real_T Product2_Product_1;
} TYPE_0004_0100;
...
}
{
  ...
  while (1) {
	...
	Product2_In1_1 = CH_IO0001_0000.Product2_In1_1;
	CH__SYNCM();
	...
	Product2_In2_1 = CH_IO0002_0000.Product2_In2_1;
	CH__SYNCM();
	...
	Product2_In3_1 = CH_IO0003_0000.Product2_In3_1;
	CH__SYNCM();
    ...
    /* wait output channel */
    while (1) {
      /* output: Product2_Product */
      if (CH_0000_0004.flag__0000_0004 == 0) {
	CH_0000_0004.Product2_In1_1 = Product2_In1_1;
	CH_0000_0004.Product2_In2_1 = Product2_In2_1;
	CH_0000_0004.Product2_In3_1 = Product2_In3_1;
	CH__SYNCM();
...
{  /* omit input channel bit vector */
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: Product2_Product */
      if (CH_0004_0100.flag__0004_0100 == 1) {
	Product2_Product_1 = CH_0004_0100.Product2_Product_1;
	CH__SYNCM();
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0001_0000.Product2_In1_1 = Product2_In1_1;
	CH__SYNCM();
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0002_0000.Product2_In2_1 = Product2_In2_1;
	CH__SYNCM();
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0003_0000.Product2_In3_1 = Product2_In3_1;
	CH__SYNCM();
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	Product2_In1_1 = CH_0000_0004.Product2_In1_1;
	Product2_In2_1 = CH_0000_0004.Product2_In2_1;
	Product2_In3_1 = CH_0000_0004.Product2_In3_1;
	CH__SYNCM();
        ...
        {
{
  ...
  Product2_Product_1 = Product2_In1_1 / Product2_In2_1 * Product2_In3_1;
	...
	CH_0004_0100.Product2_Product_1 = Product2_Product_1;
	CH__SYNCM();
