...
#include <stddef.h>
#include "rtwtypes.h"
#include "BuscreaterBusselector_types.h"
#include "BuscreaterBusselector_private.h"

#include "testout-BuscreaterBusselector_res.c"
#include "testout-BuscreaterBusselector.h"
...
/* From: t0
   To: BuscreaterBusselector_BusCreator */
typedef struct {
  int flag__0000_0002;
  real_T BuscreaterBusselector_In1_1;
} TYPE_0000_0002;
TYPE_0000_0002 CH_0000_0002;

/* From: BuscreaterBusselector_In1
   To: t0 */
typedef struct {
...
/* From: BuscreaterBusselector_BusCreator
   To: BuscreaterBusselector_BusSelector */
typedef struct {
  int flag__0002_0003;
} TYPE_0002_0003;
TYPE_0002_0003 CH_0002_0003;

/* From: BuscreaterBusselector_BusSelector
   To: extout */
typedef struct {
  int flag__0003_0100;
} TYPE_0003_0100;
  ...
  /* initialize task context */
{
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: BuscreaterBusselector_In1 */
      if (CH_IO0001_0000.flag__IO0001_0000 == 1) {
	BuscreaterBusselector_In1_1 = CH_IO0001_0000.BuscreaterBusselector_In1_1;
	CH__SYNCM();
    ...
    /* wait output channel */
    while (1) {
      /* output: BuscreaterBusselector_BusCreator */
      if (CH_0000_0002.flag__0000_0002 == 0) {
	CH_0000_0002.BuscreaterBusselector_In1_1 = BuscreaterBusselector_In1_1;
	CH__SYNCM();
...
{  /* omit input channel bit vector */
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: BuscreaterBusselector_BusSelector */
...
/* Block: BuscreaterBusselector_In1 */
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0001_0000.BuscreaterBusselector_In1_1 = BuscreaterBusselector_In1_1;
	CH__SYNCM();
...
/* Block: BuscreaterBusselector_BusCreator */
...
{  /* omit input channel bit vector */
  ...
  while (1) {
	...
	BuscreaterBusselector_In1_1 = CH_0000_0002.BuscreaterBusselector_In1_1;
	CH__SYNCM();
    ...
    /* wait output channel */
    while (1) {
      /* output: BuscreaterBusselector_BusSelector */
...
/* Block: BuscreaterBusselector_BusSelector */
...
{  /* omit input channel bit vector */
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: BuscreaterBusselector_BusCreator */
