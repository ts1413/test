...
/* IN_0002 */
pthread_mutex_t mutex__IN_0002 = PTHREAD_MUTEX_INITIALIZER;
pthread_cond_t cond__IN_0002 = PTHREAD_COND_INITIALIZER;
int flag__IN_0002 = 0;
...
/* OUT_0002 */
pthread_mutex_t mutex__OUT_0002 = PTHREAD_MUTEX_INITIALIZER;
pthread_cond_t cond__OUT_0002 = PTHREAD_COND_INITIALIZER;
int flag__OUT_0002 = 0;
...
void mcos_lcore_task_0002(uint32_t stacd, uintptr_t exinf);
...
static void *f__mcos_lcore_task_0002 (void *arg)
{
  if (PTHREAD_DEBUG) {
    fputs ("start mcos_lcore_task_0002\n", stdout);
    fflush (stdout);
  }
  mcos_lcore_task_0002 (0, (uintptr_t)arg);
  return NULL;
}
