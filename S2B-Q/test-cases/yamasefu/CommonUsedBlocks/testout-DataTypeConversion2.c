...
#include "testout-DataTypeConversion2_res.c"
#include "testout-DataTypeConversion2.h"
...
/* From: t0
   To: DataTypeConversion2_DataTypeConversion */
typedef struct {
  int flag__0000_0002;
  real_T DataTypeConversion2_In1_1;
} TYPE_0000_0002;
TYPE_0000_0002 CH_0000_0002;

/* From: DataTypeConversion2_In1
   To: t0 */
typedef struct {
...
/* From: DataTypeConversion2_DataTypeConversion
   To: extout */
typedef struct {
  int flag__0002_0100;
  real_T DataTypeConversion2_DataTypeConversion_1;
} TYPE_0002_0100;
  ...
  /* initialize task context */
{
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: DataTypeConversion2_In1 */
      if (CH_IO0001_0000.flag__IO0001_0000 == 1) {
	DataTypeConversion2_In1_1 = CH_IO0001_0000.DataTypeConversion2_In1_1;
	CH__SYNCM();
    ...
    /* wait output channel */
    while (1) {
      /* output: DataTypeConversion2_DataTypeConversion */
      if (CH_0000_0002.flag__0000_0002 == 0) {
	CH_0000_0002.DataTypeConversion2_In1_1 = DataTypeConversion2_In1_1;
	CH__SYNCM();
...
{  /* omit input channel bit vector */
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: DataTypeConversion2_DataTypeConversion */
      if (CH_0002_0100.flag__0002_0100 == 1) {
	DataTypeConversion2_DataTypeConversion_1 = CH_0002_0100.DataTypeConversion2_DataTypeConversion_1;
	CH__SYNCM();
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0001_0000.DataTypeConversion2_In1_1 = DataTypeConversion2_In1_1;
	CH__SYNCM();
...
/* Block: DataTypeConversion2_DataTypeConversion */
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	DataTypeConversion2_In1_1 = CH_0000_0002.DataTypeConversion2_In1_1;
	CH__SYNCM();
        ...
        {
{
  ...
  DataTypeConversion2_DataTypeConversion_1 = DataTypeConversion2_In1_1;
	...
	CH_0002_0100.DataTypeConversion2_DataTypeConversion_1 = DataTypeConversion2_DataTypeConversion_1;
	CH__SYNCM();
