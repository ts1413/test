...
#include "testout-DataTypeConversion1_res.c"
#include "testout-DataTypeConversion1.h"
...
/* From: t0
   To: DataTypeConversion1_DataTypeConversion */
typedef struct {
  int flag__0000_0002;
  real_T DataTypeConversion1_In1_1;
} TYPE_0000_0002;
TYPE_0000_0002 CH_0000_0002;

/* From: DataTypeConversion1_In1
   To: t0 */
typedef struct {
...
/* From: DataTypeConversion1_DataTypeConversion
   To: extout */
typedef struct {
  int flag__0002_0100;
  real_T DataTypeConversion1_DataTypeConversion_1;
} TYPE_0002_0100;
  ...
  /* initialize task context */
{
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: DataTypeConversion1_In1 */
      if (CH_IO0001_0000.flag__IO0001_0000 == 1) {
	DataTypeConversion1_In1_1 = CH_IO0001_0000.DataTypeConversion1_In1_1;
	CH__SYNCM();
    ...
    /* wait output channel */
    while (1) {
      /* output: DataTypeConversion1_DataTypeConversion */
      if (CH_0000_0002.flag__0000_0002 == 0) {
	CH_0000_0002.DataTypeConversion1_In1_1 = DataTypeConversion1_In1_1;
	CH__SYNCM();
...
{  /* omit input channel bit vector */
  ...
  while (1) {
    ...
    /* wait input channel */
    while (1) {
      /* input: DataTypeConversion1_DataTypeConversion */
      if (CH_0002_0100.flag__0002_0100 == 1) {
	DataTypeConversion1_DataTypeConversion_1 = CH_0002_0100.DataTypeConversion1_DataTypeConversion_1;
	CH__SYNCM();
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0001_0000.DataTypeConversion1_In1_1 = DataTypeConversion1_In1_1;
	CH__SYNCM();
...
/* Block: DataTypeConversion1_DataTypeConversion */
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	DataTypeConversion1_In1_1 = CH_0000_0002.DataTypeConversion1_In1_1;
	CH__SYNCM();
        ...
        {
{
  ...
  DataTypeConversion1_DataTypeConversion_1 = DataTypeConversion1_In1_1;
	...
	CH_0002_0100.DataTypeConversion1_DataTypeConversion_1 = DataTypeConversion1_DataTypeConversion_1;
	CH__SYNCM();
