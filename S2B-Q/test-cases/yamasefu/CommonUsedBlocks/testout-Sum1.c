...
#include "testout-Sum1_res.c"
#include "testout-Sum1.h"
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	Sum1_In1_1 = CH_IO0001_0000.Sum1_In1_1;
	CH__SYNCM();
	...
	CH_0000_0002.Sum1_In1_1 = Sum1_In1_1;
	CH__SYNCM();
...
{  /* omit input channel bit vector */
  ...
  while (1) {
	...
	Sum1_Sum_1 = CH_0002_0100.Sum1_Sum_1;
	CH__SYNCM();
...
{  /* omit output channel bit vector */
  ...
  while (1) {
	...
	CH_IO0001_0000.Sum1_In1_1 = Sum1_In1_1;
	CH__SYNCM();
  ...
  /* initialize task context */
{
  ...
  while (1) {
	...
	Sum1_In1_1 = CH_0000_0002.Sum1_In1_1;
	CH__SYNCM();
        ...
        {
{
  ...
  Sum1_Sum_1 = Sum1_In1_1 + Sum1_In1_1;
	...
	CH_0002_0100.Sum1_Sum_1 = Sum1_Sum_1;
	CH__SYNCM();
