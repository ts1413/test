###########################################################################
## Makefile generated for Simulink model 'Sum2'. 
## 
## Makefile     : Sum2.mk
## Generated on : Mon Sep 28 19:45:25 2015
## MATLAB Coder version: 2.6 (R2014a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Sum2
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = Sum2_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Sum2
...
INCLUDES_BUILDINFO = -I$(START_DIR)/Sum2_ert_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=Sum2 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DUNIX
...
SRCS = $(START_DIR)/Sum2_ert_rtw/Sum2.c

MAIN_SRC = $(START_DIR)/Sum2_ert_rtw/ert_main.c
...
%.o : $(START_DIR)/Sum2_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Sum2_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
